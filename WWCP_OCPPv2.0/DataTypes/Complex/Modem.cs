...
namespace cloud.charging.adapters.OCPPv2_0
{
    ...
    public class Modem
    {
        ...
        /// <summary>
        /// The communication module to allow to store any kind of customer specific data.
        /// </summary>
        ...
        /// </summary>
        /// <param name="CustomData">The communication module to allow to store any kind of customer specific data.</param>
        ...
        public Modem(CustomData  CustomData,
                     String      ICCID,
                     String      IMSI)
        {
        ...
        #region ToJSON(CustomModemResponseSerializer = null)
        ...
        public override String ToString()
            ...
            => String.Concat(ICCID != null ? "ICCID: " + ICCID : "",
                             IMSI  != null ? "IMSI: "  + IMSI  : "");

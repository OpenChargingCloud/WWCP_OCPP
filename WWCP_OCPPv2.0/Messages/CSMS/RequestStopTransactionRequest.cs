...
namespace cloud.charging.open.protocols.OCPPv2_0.CSMS
{
    ...
    public class RequestStopTransactionRequest : ARequest<RequestStopTransactionRequest>
    {
        ...
        #region (static) Parse   (JSON, RequestId, ChargeBoxId, CustomRequestStopTransactionRequestParser = null)
        ...
        #region (static) TryParse(JSON, RequestId, ChargeBoxId, out RequestStopTransactionRequest, out ErrorResponse, CustomRequestStopTransactionRequestParser = null)
                                       ...
                                       CustomJObjectParserDelegate<RequestStopTransactionRequest>?  CustomRequestStopTransactionRequestParser)
        {
            ...
            try
            {
                ...
                RequestStopTransactionRequest = new RequestStopTransactionRequest(ChargeBoxId,
                                                                                  TransactionId,
                                                                                  CustomData,
                                                                                  RequestId);

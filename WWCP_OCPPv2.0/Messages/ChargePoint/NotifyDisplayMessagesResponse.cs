...
namespace cloud.charging.open.protocols.OCPPv2_0.CS
{
    ...
    /// </summary>
    public class NotifyDisplayMessagesResponse : AResponse<CP.NotifyDisplayMessagesRequest,
                                                              NotifyDisplayMessagesResponse>
    {
        ...
        public NotifyDisplayMessagesResponse(CP.NotifyDisplayMessagesRequest  Request,
        ...
        public static NotifyDisplayMessagesResponse Parse(CP.NotifyDisplayMessagesRequest                              Request,
                                                          JObject                                                      JSON,
        ...
        /// <param name="CustomNotifyDisplayMessagesResponseParser">A delegate to parse custom notify display messages responses.</param>
        public static Boolean TryParse(CP.NotifyDisplayMessagesRequest                              Request,
                                       JObject                                                      JSON,
        ...
        #region ToJSON(CustomNotifyDisplayMessagesResponseSerializer = null, CustomCustomDataResponseSerializer = null)
        ...
        /// </summary>
        public static NotifyDisplayMessagesResponse Failed(CP.NotifyDisplayMessagesRequest Request)

...
namespace cloud.charging.open.protocols.OCPPv2_0.CS
{
    ...
    /// </summary>
    public class ReservationStatusUpdateResponse : AResponse<CP.ReservationStatusUpdateRequest,
                                                                ReservationStatusUpdateResponse>
    {
        ...
        public ReservationStatusUpdateResponse(CP.ReservationStatusUpdateRequest  Request,
        ...
        public static ReservationStatusUpdateResponse Parse(CP.ReservationStatusUpdateRequest                              Request,
                                                            JObject                                                        JSON,
        ...
        /// <param name="CustomReservationStatusUpdateResponseParser">A delegate to parse custom reservation status update responses.</param>
        public static Boolean TryParse(CP.ReservationStatusUpdateRequest                              Request,
                                       JObject                                                        JSON,
        ...
        #region ToJSON(CustomReservationStatusUpdateResponseSerializer = null, CustomCustomDataResponseSerializer = null)
        ...
        /// </summary>
        public static ReservationStatusUpdateResponse Failed(CP.ReservationStatusUpdateRequest Request)

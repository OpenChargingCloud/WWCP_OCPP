...
namespace cloud.charging.open.protocols.OCPPv2_0.CS
{
    ...
    /// </summary>
    public class PublishFirmwareStatusNotificationResponse : AResponse<CP.PublishFirmwareStatusNotificationRequest,
                                                                          PublishFirmwareStatusNotificationResponse>
    {
        ...
        public PublishFirmwareStatusNotificationResponse(CP.PublishFirmwareStatusNotificationRequest  Request,
        ...
        public static PublishFirmwareStatusNotificationResponse Parse(CP.PublishFirmwareStatusNotificationRequest                              Request,
                                                                      JObject                                                                  JSON,
        ...
        /// <param name="CustomPublishFirmwareStatusNotificationResponseParser">A delegate to parse custom publish firmware status notification responses.</param>
        public static Boolean TryParse(CP.PublishFirmwareStatusNotificationRequest                              Request,
                                       JObject                                                                  JSON,
        ...
        #region ToJSON(CustomPublishFirmwareStatusNotificationResponseSerializer = null, CustomCustomDataResponseSerializer = null)
        ...
        /// </summary>
        public static PublishFirmwareStatusNotificationResponse Failed(CP.PublishFirmwareStatusNotificationRequest Request)

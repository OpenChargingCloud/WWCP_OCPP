...
namespace cloud.charging.open.protocols.OCPPv2_0.CS
{
    ...
    /// </summary>
    public class GetCertificateStatusResponse : AResponse<CP.GetCertificateStatusRequest,
                                                             GetCertificateStatusResponse>
    {
        ...
        public GetCertificateStatusResponse(CP.GetCertificateStatusRequest  Request,
        ...
        public static GetCertificateStatusResponse Parse(CP.GetCertificateStatusRequest                              Request,
                                                         JObject                                                     JSON,
        ...
        /// <param name="CustomGetCertificateStatusResponseParser">A delegate to parse custom get certificate status responses.</param>
        public static Boolean TryParse(CP.GetCertificateStatusRequest                              Request,
                                       JObject                                                     JSON,
        ...
        #region ToJSON(CustomGetCertificateStatusResponseSerializer = null, CustomStatusInfoResponseSerializer = null)
        ...
        /// </summary>
        /// <param name="Request">The get certificate status request leading to this response.</param>
        public static GetCertificateStatusResponse Failed(CP.GetCertificateStatusRequest Request)

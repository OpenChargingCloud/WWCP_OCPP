...
namespace cloud.charging.open.protocols.OCPPv2_0.CS
{
    ...
    /// </summary>
    public class ClearedChargingLimitResponse : AResponse<CP.ClearedChargingLimitRequest,
                                                             ClearedChargingLimitResponse>
    {
        ...
        public ClearedChargingLimitResponse(CP.ClearedChargingLimitRequest  Request,
        ...
        public static ClearedChargingLimitResponse Parse(CP.ClearedChargingLimitRequest                              Request,
                                                         JObject                                                     JSON,
        ...
        /// <param name="CustomClearedChargingLimitResponseParser">A delegate to parse custom cleared charging limit responses.</param>
        public static Boolean TryParse(CP.ClearedChargingLimitRequest                              Request,
                                       JObject                                                     JSON,
        ...
        #region ToJSON(CustomClearedChargingLimitResponseSerializer = null, ...)

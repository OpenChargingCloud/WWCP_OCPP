...
namespace cloud.charging.open.protocols.OCPPv2_0.CS
{
    ...
    /// </summary>
    public class NotifyChargingLimitResponse : AResponse<CP.NotifyChargingLimitRequest,
                                                            NotifyChargingLimitResponse>
    {
        ...
        public NotifyChargingLimitResponse(CP.NotifyChargingLimitRequest  Request,
        ...
        public static NotifyChargingLimitResponse Parse(CP.NotifyChargingLimitRequest                              Request,
                                                        JObject                                                    JSON,
        ...
        /// <param name="CustomNotifyChargingLimitResponseParser">A delegate to parse custom notify charging limit responses.</param>
        public static Boolean TryParse(CP.NotifyChargingLimitRequest                              Request,
                                       JObject                                                    JSON,
        ...
        #region ToJSON(CustomNotifyChargingLimitResponseSerializer = null, CustomCustomDataResponseSerializer = null)
        ...
        /// </summary>
        public static NotifyChargingLimitResponse Failed(CP.NotifyChargingLimitRequest Request)

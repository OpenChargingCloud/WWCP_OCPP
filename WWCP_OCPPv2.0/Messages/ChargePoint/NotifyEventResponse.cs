...
namespace cloud.charging.open.protocols.OCPPv2_0.CS
{
    ...
    /// </summary>
    public class NotifyEventResponse : AResponse<CP.NotifyEventRequest,
                                                    NotifyEventResponse>
    {
        ...
        public NotifyEventResponse(CP.NotifyEventRequest  Request,
        ...
        public static NotifyEventResponse Parse(CP.NotifyEventRequest                              Request,
                                                JObject                                            JSON,
        ...
        /// <param name="CustomNotifyEventResponseParser">A delegate to parse custom notify event responses.</param>
        public static Boolean TryParse(CP.NotifyEventRequest                              Request,
                                       JObject                                            JSON,
        ...
        #region ToJSON(CustomNotifyEventResponseSerializer = null, CustomCustomDataResponseSerializer = null)
        ...
        /// </summary>
        public static NotifyEventResponse Failed(CP.NotifyEventRequest Request)

...
namespace cloud.charging.open.protocols.OCPPv2_0.CS
{
    ...
    /// </summary>
    public class NotifyReportResponse : AResponse<CP.NotifyReportRequest,
                                                     NotifyReportResponse>
    {
        ...
        public NotifyReportResponse(CP.NotifyReportRequest  Request,
        ...
        public static NotifyReportResponse Parse(CP.NotifyReportRequest                              Request,
                                                 JObject                                             JSON,
        ...
        /// <param name="CustomNotifyReportResponseParser">A delegate to parse custom notify report responses.</param>
        public static Boolean TryParse(CP.NotifyReportRequest                              Request,
                                       JObject                                             JSON,
        ...
        #region ToJSON(CustomNotifyReportResponseSerializer = null, CustomCustomDataResponseSerializer = null)
        ...
        /// </summary>
        public static NotifyReportResponse Failed(CP.NotifyReportRequest Request)

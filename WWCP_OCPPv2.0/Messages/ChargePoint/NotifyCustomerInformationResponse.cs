...
namespace cloud.charging.open.protocols.OCPPv2_0.CS
{
    ...
    /// </summary>
    public class NotifyCustomerInformationResponse : AResponse<CP.NotifyCustomerInformationRequest,
                                                                  NotifyCustomerInformationResponse>
    {
        ...
        public NotifyCustomerInformationResponse(CP.NotifyCustomerInformationRequest  Request,
        ...
        public static NotifyCustomerInformationResponse Parse(CP.NotifyCustomerInformationRequest                              Request,
                                                              JObject                                                          JSON,
        ...
        /// <param name="CustomNotifyCustomerInformationResponseParser">A delegate to parse custom notify customer information responses.</param>
        public static Boolean TryParse(CP.NotifyCustomerInformationRequest                              Request,
                                       JObject                                                          JSON,
        ...
        #region ToJSON(CustomNotifyCustomerInformationResponseSerializer = null, CustomCustomDataResponseSerializer = null)
        ...
        /// </summary>
        public static NotifyCustomerInformationResponse Failed(CP.NotifyCustomerInformationRequest Request)

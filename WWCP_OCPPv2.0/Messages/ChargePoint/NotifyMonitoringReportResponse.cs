...
namespace cloud.charging.open.protocols.OCPPv2_0.CS
{
    ...
    /// </summary>
    public class NotifyMonitoringReportResponse : AResponse<CP.NotifyMonitoringReportRequest,
                                                               NotifyMonitoringReportResponse>
    {
        ...
        public NotifyMonitoringReportResponse(CP.NotifyMonitoringReportRequest  Request,
        ...
        public static NotifyMonitoringReportResponse Parse(CP.NotifyMonitoringReportRequest                              Request,
                                                           JObject                                                       JSON,
        ...
        /// <param name="CustomNotifyMonitoringReportResponseParser">A delegate to parse custom notify monitoring report responses.</param>
        public static Boolean TryParse(CP.NotifyMonitoringReportRequest                              Request,
                                       JObject                                                       JSON,
        ...
        #region ToJSON(CustomNotifyMonitoringReportResponseSerializer = null, CustomCustomDataResponseSerializer = null)
        ...
        /// </summary>
        public static NotifyMonitoringReportResponse Failed(CP.NotifyMonitoringReportRequest Request)

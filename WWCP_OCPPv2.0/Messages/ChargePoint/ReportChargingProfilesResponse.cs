...
namespace cloud.charging.open.protocols.OCPPv2_0.CS
{
    ...
    /// </summary>
    public class ReportChargingProfilesResponse : AResponse<CP.ReportChargingProfilesRequest,
                                                               ReportChargingProfilesResponse>
    {
        ...
        public ReportChargingProfilesResponse(CP.ReportChargingProfilesRequest  Request,
        ...
        public static ReportChargingProfilesResponse Parse(CP.ReportChargingProfilesRequest                              Request,
                                                           JObject                                                       JSON,
        ...
        /// <param name="CustomReportChargingProfilesResponseParser">A delegate to parse custom report charging profiles responses.</param>
        public static Boolean TryParse(CP.ReportChargingProfilesRequest                              Request,
                                       JObject                                                       JSON,
        ...
        #region ToJSON(CustomReportChargingProfilesResponseSerializer = null, CustomCustomDataResponseSerializer = null)
        ...
        /// </summary>
        public static ReportChargingProfilesResponse Failed(CP.ReportChargingProfilesRequest Request)

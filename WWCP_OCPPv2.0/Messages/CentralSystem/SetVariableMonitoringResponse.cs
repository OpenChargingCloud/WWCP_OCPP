...
namespace cloud.charging.open.protocols.OCPPv2_0.CP
{
    ...
    /// </summary>
    public class SetVariableMonitoringResponse : AResponse<CS.SetVariableMonitoringRequest,
                                                              SetVariableMonitoringResponse>
    {
        ...
        #region SetVariableMonitoringResponse(Request, Status, SetMonitoringResults)
        ...
        public SetVariableMonitoringResponse(CS.SetVariableMonitoringRequest   Request,
        ...
        public static SetVariableMonitoringResponse Parse(CS.SetVariableMonitoringRequest                              Request,
                                                          JObject                                                      JSON,
        ...
        /// <param name="CustomSetVariableMonitoringResponseParser">A delegate to parse custom set variable monitoring responses.</param>
        public static Boolean TryParse(CS.SetVariableMonitoringRequest                              Request,
                                       JObject                                                      JSON,
        ...
        /// </summary>
        /// <param name="Request">The set variable monitoring request leading to this response.</param>
        public static SetVariableMonitoringResponse Failed(CS.SetVariableMonitoringRequest Request)
        ...
        public override Int32 GetHashCode()
{
            unchecked
            {
                ...
                return //ToDo: Add SetMonitoringResult!
                       base.       GetHashCode();

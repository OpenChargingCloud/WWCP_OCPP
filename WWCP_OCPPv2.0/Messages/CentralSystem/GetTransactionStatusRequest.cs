...
namespace cloud.charging.open.protocols.OCPPv2_0.CS
{
    ...
    public class GetTransactionStatusRequest : ARequest<GetTransactionStatusRequest>
    {
        ...
        #region ToJSON(CustomGetTransactionStatusRequestSerializer = null, CustomCustomDataResponseSerializer = null)

        /// <summary>
        /// Return a JSON representation of this object.
        /// </summary>
        /// <param name="CustomGetTransactionStatusRequestSerializer">A delegate to serialize custom start transaction requests.</param>

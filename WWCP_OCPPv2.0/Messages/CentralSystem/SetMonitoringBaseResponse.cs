...
namespace cloud.charging.open.protocols.OCPPv2_0.CP
{
    ...
    /// </summary>
    public class SetMonitoringBaseResponse : AResponse<CS.SetMonitoringBaseRequest,
                                                          SetMonitoringBaseResponse>
    {
        ...
        public SetMonitoringBaseResponse(CS.SetMonitoringBaseRequest  Request,
        ...
        public static SetMonitoringBaseResponse Parse(CS.SetMonitoringBaseRequest                              Request,
                                                      JObject                                                  JSON,
        ...
        /// <param name="CustomSetMonitoringBaseResponseParser">A delegate to parse custom set monitoring base responses.</param>
        public static Boolean TryParse(CS.SetMonitoringBaseRequest                              Request,
                                       JObject                                                  JSON,
        ...
        /// </summary>
        /// <param name="Request">The set monitoring base request leading to this response.</param>
        public static SetMonitoringBaseResponse Failed(CS.SetMonitoringBaseRequest Request)

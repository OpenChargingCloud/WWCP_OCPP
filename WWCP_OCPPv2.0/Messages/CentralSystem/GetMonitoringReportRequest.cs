...
namespace cloud.charging.open.protocols.OCPPv2_0.CS
{
    ...
    public class GetMonitoringReportRequest : ARequest<GetMonitoringReportRequest>
    {
                                       ...
                                       CustomJObjectParserDelegate<GetMonitoringReportRequest>?  CustomGetMonitoringReportRequestParser)
        {
            ...
            try
            {
                ...
                if (!JSON.ParseMandatoryHashSet("monitoringCriteria",
                                                "monitoring criteria",
                                                MonitoringCriteriaExtentions.TryParse,
        ...
        #region ToJSON(CustomGetMonitoringReportRequestSerializer = null, CustomComponentVariableResponseSerializer = null, ...)

        /// <summary>
        /// Return a JSON representation of this object.
        /// </summary>
        /// <param name="CustomGetMonitoringReportRequestSerializer">A delegate to serialize custom start transaction requests.</param>

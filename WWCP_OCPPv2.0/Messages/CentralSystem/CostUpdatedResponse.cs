...
namespace cloud.charging.open.protocols.OCPPv2_0.CP
{
    ...
    /// </summary>
    public class CostUpdatedResponse : AResponse<CS.CostUpdatedRequest,
                                                    CostUpdatedResponse>
    {
        ...
        public CostUpdatedResponse(CS.CostUpdatedRequest  Request,
        ...
        public static CostUpdatedResponse Parse(CS.CostUpdatedRequest                              Request,
                                                JObject                                            JSON,
        ...
        /// <param name="CustomCostUpdatedResponseParser">A delegate to parse custom cost updated responses.</param>
        public static Boolean TryParse(CS.CostUpdatedRequest                              Request,
                                       JObject                                            JSON,
        ...
        /// </summary>
        /// <param name="Request">The cost updated request leading to this response.</param>
        public static CostUpdatedResponse Failed(CS.CostUpdatedRequest Request)

...
namespace cloud.charging.open.protocols.OCPPv2_0.CP
{
    ...
    /// </summary>
    public class ClearDisplayMessageResponse : AResponse<CS.ClearDisplayMessageRequest,
                                                            ClearDisplayMessageResponse>
    {
        ...
        #region ClearDisplayMessageResponse(Request, Status)
        ...
        public static ClearDisplayMessageResponse Parse(CS.ClearDisplayMessageRequest                              Request,
                                                        JObject                                                    JSON,
        ...
        /// <param name="CustomClearDisplayMessageResponseParser">A delegate to parse custom clear display message responses.</param>
        public static Boolean TryParse(CS.ClearDisplayMessageRequest                              Request,
                                       JObject                                                    JSON,
                                       ...
                                       CustomJObjectParserDelegate<ClearDisplayMessageResponse>?  CustomClearDisplayMessageResponseParser   = null)
        {
            ...
            try
            {
                ...
                if (!JSON.MapMandatory("status",
                                       ...
                                       ClearMessageStatusExtentions.Parse,
                ...
                ClearDisplayMessageResponse = new ClearDisplayMessageResponse(Request,
                                                                              Status,
                                                                              StatusInfo,
                                                                              CustomData);
        ...
        #region ToJSON(CustomClearDisplayMessageResponseSerializer = null, CustomStatusInfoResponseSerializer = null, ...)
        ...
        /// </summary>
        /// <param name="Request">The clear display message request leading to this response.</param>
        public static ClearDisplayMessageResponse Failed(CS.ClearDisplayMessageRequest Request)

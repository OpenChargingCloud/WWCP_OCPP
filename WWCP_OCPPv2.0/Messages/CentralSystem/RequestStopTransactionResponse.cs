...
namespace cloud.charging.open.protocols.OCPPv2_0.CP
{
    ...
    /// </summary>
    public class RequestStopTransactionResponse : AResponse<CS.RequestStopTransactionRequest,
                                                               RequestStopTransactionResponse>
    {
        ...
        #region RequestStopTransactionResponse(Request, Status)
        ...
        public RequestStopTransactionResponse(CS.RequestStopTransactionRequest  Request,
        ...
        public static RequestStopTransactionResponse Parse(CS.RequestStopTransactionRequest                              Request,
                                                           JObject                                                       JSON,
        ...
        /// <param name="CustomRequestStopTransactionResponseParser">A delegate to parse custom request stop transaction responses.</param>
        public static Boolean TryParse(CS.RequestStopTransactionRequest                              Request,
                                       JObject                                                       JSON,
        ...
        /// </summary>
        /// <param name="Request">The request stop transaction request leading to this response.</param>
        public static RequestStopTransactionResponse Failed(CS.RequestStopTransactionRequest  Request)

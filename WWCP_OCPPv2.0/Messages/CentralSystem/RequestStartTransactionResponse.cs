...
namespace cloud.charging.open.protocols.OCPPv2_0.CP
{
    ...
    /// </summary>
    public class RequestStartTransactionResponse : AResponse<CS.RequestStartTransactionRequest,
                                                                RequestStartTransactionResponse>
    {
        ...
        public static RequestStartTransactionResponse Parse(CS.RequestStartTransactionRequest                              Request,
                                                            JObject                                                        JSON,
        ...
        /// <param name="CustomRequestStartTransactionResponseParser">A delegate to parse custom request start transaction responses.</param>
        public static Boolean TryParse(CS.RequestStartTransactionRequest                              Request,
                                       JObject                                                        JSON,
        ...
        /// </summary>
        /// <param name="Request">The request start transaction request leading to this response.</param>
        public static RequestStartTransactionResponse Failed(CS.RequestStartTransactionRequest  Request)

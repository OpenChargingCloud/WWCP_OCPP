...
namespace cloud.charging.open.protocols.OCPPv2_0.CP
{
    ...
    /// </summary>
    public class UnpublishFirmwareResponse : AResponse<CS.UnpublishFirmwareRequest,
                                                          UnpublishFirmwareResponse>
    {
        ...
        public UnpublishFirmwareResponse(CS.UnpublishFirmwareRequest  Request,
        ...
        public static UnpublishFirmwareResponse Parse(CS.UnpublishFirmwareRequest                              Request,
                                                      JObject                                                  JSON,
        ...
        /// <param name="CustomUnpublishFirmwareResponseParser">A delegate to parse custom unpublish firmware responses.</param>
        public static Boolean TryParse(CS.UnpublishFirmwareRequest                              Request,
                                       JObject                                                  JSON,
                                       ...
                                       CustomJObjectParserDelegate<UnpublishFirmwareResponse>?  CustomUnpublishFirmwareResponseParser   = null)
        {
            ...
            try
            {
                ...
                if (!JSON.ParseMandatory("status",
                                         ...
                                         UnpublishFirmwareStatusExtentions.TryParse,
        ...
        /// </summary>
        /// <param name="Request">The unpublish firmware request leading to this response.</param>
        public static UnpublishFirmwareResponse Failed(CS.UnpublishFirmwareRequest Request)

...
namespace cloud.charging.open.protocols.OCPPv2_0.CSMS
{
    ...
    public static class ICSMSClientExtensions
    {
        ...
        /// <param name="RequestTimestamp">An optional request timestamp.</param>
        /// <param name="RequestTimeout">An optional request timeout.</param>
        public static Task<CS.DataTransferResponse> DataTransfer(this ICSMSClient  ICSMSClient,
                                                                 ChargeBox_Id               ChargeBoxId,
                                                                 String                     VendorId,
                                                                 String                     MessageId,
                                                                 String                     Data,
   ...
   //     CSMSSOAPClient.CSClientLogger  Logger               { get; }
        ...
        Task<CS.DataTransferResponse> DataTransfer(DataTransferRequest Request);

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                  ...
                                                  INetworkingNodeOutgoingMessageEvents
    {
        ...
        /// An event fired whenever a response to a sign certificate request was received.
        /// </summary>
        public event OCPPv2_1.CS.OnSignCertificateResponseReceivedDelegate?    OnSignCertificateResponse;
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnSignCertificateRequestSent));
            }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnSignCertificateResponse));
            }

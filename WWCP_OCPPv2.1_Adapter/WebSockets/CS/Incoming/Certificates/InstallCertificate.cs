...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                  ...
                                                  INetworkingNodeOutgoingMessageEvents
    {
        ...
        /// </summary>
        public event OCPPv2_1.CS.OnInstallCertificateRequestReceivedDelegate?     OnInstallCertificateRequest;
...

        {
            ...
            try
            {
                ...
                if (InstallCertificateRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnInstallCertificateResponseSent));
                    }

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                  ...
                                                  INetworkingNodeOutgoingMessageEvents
    {
        ...
        /// </summary>
        public event OCPPv2_1.CS.OnTriggerMessageRequestReceivedDelegate?     OnTriggerMessageRequest;
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnTriggerMessageWSRequest));
            }
            ...
            try
            {
                ...
                if (TriggerMessageRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnTriggerMessageRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnTriggerMessageResponseSent));
                    }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnTriggerMessageWSResponse));
            }

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                  ...
                                                  INetworkingNodeOutgoingMessageEvents
    {
        ...
        /// </summary>
        public event OCPPv2_1.CS.OnSetMonitoringBaseRequestReceivedDelegate?     OnSetMonitoringBaseRequest;
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnSetMonitoringBaseWSRequest));
            }
            ...
            try
            {
                ...
                if (SetMonitoringBaseRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnSetMonitoringBaseRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnSetMonitoringBaseResponseSent));
                    }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnSetMonitoringBaseWSResponse));
            }

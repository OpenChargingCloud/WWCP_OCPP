...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                  ...
                                                  INetworkingNodeOutgoingMessageEvents
    {
        ...
        /// </summary>
        public event OCPPv2_1.CS.OnChangeAvailabilityRequestReceivedDelegate?     OnChangeAvailabilityRequest;
...

        {
            ...
            try
            {
                ...
                if (ChangeAvailabilityRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnChangeAvailabilityResponseSent));
                    }

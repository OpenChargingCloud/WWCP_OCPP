...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                  ...
                                                  INetworkingNodeOutgoingMessageEvents
    {
        ...
        /// </summary>
        public event OCPPv2_1.CS.OnGetBaseReportRequestReceivedDelegate?     OnGetBaseReportRequest;
...

        {
            ...
            try
            {
                ...
                if (GetBaseReportRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnGetBaseReportResponseSent));
                    }

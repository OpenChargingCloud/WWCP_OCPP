...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                  ...
                                                  INetworkingNodeOutgoingMessageEvents
    {
        ...
        /// </summary>
        public event OCPPv2_1.CS.OnGetChargingProfilesRequestReceivedDelegate?     OnGetChargingProfilesRequest;
...

        {
            ...
            try
            {
                ...
                if (GetChargingProfilesRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnGetChargingProfilesResponseSent));
                    }

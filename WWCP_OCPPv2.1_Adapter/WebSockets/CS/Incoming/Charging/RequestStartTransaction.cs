...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                  ...
                                                  INetworkingNodeOutgoingMessageEvents
    {
        ...
        /// </summary>
        public event OCPPv2_1.CS.OnRequestStartTransactionRequestReceivedDelegate?     OnRequestStartTransactionRequest;
...

        {
            ...
            try
            {
                ...
                if (RequestStartTransactionRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnRequestStartTransactionResponseSent));
                    }

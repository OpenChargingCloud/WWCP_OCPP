...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                  ...
                                                  INetworkingNodeOutgoingMessageEvents
    {
        ...
        /// </summary>
        public event OCPPv2_1.CS.OnCustomerInformationRequestReceivedDelegate?     OnCustomerInformationRequest;
...

        {
            ...
            try
            {
                ...
                if (CustomerInformationRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnCustomerInformationResponseSent));
                    }

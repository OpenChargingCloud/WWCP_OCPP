...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CSMS
{
                                                  ...
                                                  INetworkingNodeChannel
    {
        ...
        /// </summary>
        public event OCPPv2_1.CSMS.OnReserveNowResponseReceivedDelegate?    OnReserveNowResponse;
        ...
        public async Task<ReserveNowResponse> ReserveNow(ReserveNowRequest Request)
        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnReserveNowRequestSent));
            }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnReserveNowResponse));
            }

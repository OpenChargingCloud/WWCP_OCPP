...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CSMS
{
                                                  ...
                                                  INetworkingNodeChannel
    {
        ...
        /// </summary>
        public event OCPPv2_1.CSMS.OnSetChargingProfileResponseReceivedDelegate?    OnSetChargingProfileResponse;
        ...
        public async Task<SetChargingProfileResponse> SetChargingProfile(SetChargingProfileRequest Request)
        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnSetChargingProfileRequestSent));
            }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnSetChargingProfileResponse));
            }

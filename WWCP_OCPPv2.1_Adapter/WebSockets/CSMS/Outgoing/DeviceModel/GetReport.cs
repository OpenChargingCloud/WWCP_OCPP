...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CSMS
{
                                                  ...
                                                  INetworkingNodeChannel
    {
        ...
        /// </summary>
        public event OCPPv2_1.CSMS.OnGetReportResponseReceivedDelegate?    OnGetReportResponse;
        ...
        public async Task<GetReportResponse> GetReport(GetReportRequest Request)
        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnGetReportRequestSent));
            }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnGetReportResponse));
            }

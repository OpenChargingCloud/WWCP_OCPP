...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CSMS
{
                                                  ...
                                                  INetworkingNodeChannel
    {
        ...
        /// </summary>
        public event OCPPv2_1.CSMS.OnSendLocalListResponseReceivedDelegate?    OnSendLocalListResponse;
        ...
        public async Task<SendLocalListResponse> SendLocalList(SendLocalListRequest Request)
        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnSendLocalListRequestSent));
            }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnSendLocalListResponse));
            }

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CSMS
{
                                                  ...
                                                  INetworkingNodeChannel
    {
        ...
        /// </summary>
        public event OCPPv2_1.CSMS.OnSetDisplayMessageResponseReceivedDelegate?    OnSetDisplayMessageResponse;
        ...
        public async Task<SetDisplayMessageResponse> SetDisplayMessage(SetDisplayMessageRequest Request)
        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnSetDisplayMessageRequestSent));
            }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnSetDisplayMessageResponse));
            }

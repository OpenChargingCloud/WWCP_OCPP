...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CSMS
{
                                                  ...
                                                  INetworkingNodeChannel
    {
        ...
        /// </summary>
        public event OCPPv2_1.CSMS.OnFirmwareStatusNotificationRequestReceivedDelegate?     OnFirmwareStatusNotificationRequest;
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnFirmwareStatusNotificationWSRequest));
            }
            ...
            try
            {
                ...
                if (FirmwareStatusNotificationRequest.TryParse(JSONRequest,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnFirmwareStatusNotificationRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnFirmwareStatusNotificationResponseSent));
                    }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnFirmwareStatusNotificationWSResponse));
            }

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CSMS
{
                                                  ...
                                                  INetworkingNodeChannel
    {
        ...
        /// </summary>
        public event OCPPv2_1.CSMS.OnPullDynamicScheduleUpdateRequestReceivedDelegate?     OnPullDynamicScheduleUpdateRequest;
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnPullDynamicScheduleUpdateWSRequest));
            }
            ...
            try
            {
                ...
                if (PullDynamicScheduleUpdateRequest.TryParse(JSONRequest,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnPullDynamicScheduleUpdateRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnPullDynamicScheduleUpdateResponseSent));
                    }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnPullDynamicScheduleUpdateWSResponse));
            }

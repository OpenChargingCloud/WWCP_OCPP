...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CSMS
{
                                                  ...
                                                  INetworkingNodeChannel
    {
        ...
        /// </summary>
        public event OCPPv2_1.CSMS.OnReservationStatusUpdateRequestReceivedDelegate?     OnReservationStatusUpdateRequest;
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnReservationStatusUpdateWSRequest));
            }
            ...
            try
            {
                ...
                if (ReservationStatusUpdateRequest.TryParse(JSONRequest,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnReservationStatusUpdateRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnReservationStatusUpdateResponseSent));
                    }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnReservationStatusUpdateWSResponse));
            }

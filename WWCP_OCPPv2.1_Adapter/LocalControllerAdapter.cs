...
namespace cloud.charging.open.protocols.OCPPv2_1
{
    ...
    public class LocalControllerAdapter : IRemoteChargingPool
    {
        ...
        public IVotingSender<DateTime, EventTracking_Id, User_Id, IChargingPool, IChargingStation, bool> OnChargingStationAddition => throw new NotImplementedException();

        public IVotingSender<DateTime, EventTracking_Id, User_Id, IChargingPool, IChargingStation, IChargingStation, bool> OnChargingStationUpdate => throw new NotImplementedException();

        public IVotingSender<DateTime, EventTracking_Id, User_Id, IChargingPool, IChargingStation, bool> OnChargingStationRemoval => throw new NotImplementedException();

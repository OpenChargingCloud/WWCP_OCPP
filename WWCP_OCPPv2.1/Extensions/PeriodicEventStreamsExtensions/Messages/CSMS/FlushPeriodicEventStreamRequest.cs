...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS
{
                                                   ...
                                                   IRequest
    {
        ...
        public FlushPeriodicEventStreamRequest(ChargingStation_Id       ChargingStationId,
        ...
        #region (static) Parse   (JSON, RequestId, ChargingStationId, CustomFlushPeriodicEventStreamRequestParser = null)
        ...
        #region (static) TryParse(JSON, RequestId, ChargingStationId, out FlushPeriodicEventStreamRequest, out ErrorResponse, CustomAuthorizeRequestParser = null)

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        #region Receive NotifyCRLRequest (wired via reflection!)
...

        {
            ...
            try
            {
                ...
                if (NotifyCRLRequest.TryParse(JSONRequest,
                    ...
                    await parentNetworkingNode.OCPP.OUT.SendOnNotifyCRLResponseSent(
                              Timestamp.Now,
                              parentNetworkingNode,
                              WebSocketConnection,
                              request,
        ...
        #region Receive NotifyCRLRequestError
...

        {
            ...
            var logger = OnNotifyCRLResponseReceived;
            if (logger is not null)
            {
                try
                {
                    ...
                    await Task.WhenAll(logger.GetInvocationList().
                                                OfType<OnNotifyCRLResponseReceivedDelegate>().
                                                Select(loggingDelegate => loggingDelegate.Invoke(
                                                                               Timestamp.Now,
                                                                               parentNetworkingNode,
                                                                               //    WebSocketConnection,
                ...
                {
                    DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnNotifyCRLResponseReceived));
                }
            }

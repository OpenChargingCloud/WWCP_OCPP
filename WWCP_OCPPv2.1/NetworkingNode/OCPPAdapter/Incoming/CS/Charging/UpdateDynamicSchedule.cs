...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN : IOCPPWebSocketAdapterIN
    {
        ...
        #region Receive UpdateDynamicScheduleRequest (wired via reflection!)
...

        {
            ...
            try
            {
                ...
                if (UpdateDynamicScheduleRequest.TryParse(JSONRequest,
                    ...
                    var logger = OnUpdateDynamicScheduleRequestReceived;
                    ...
                    await (parentNetworkingNode.OCPP.OUT as OCPPWebSocketAdapterOUT).SendOnUpdateDynamicScheduleResponseSent(
                              Timestamp.Now,
                              parentNetworkingNode,
                              WebSocketConnection,
                              request,
        ...
        #region Receive UpdateDynamicScheduleRequestError
...

        {
            ...
            var logger = OnUpdateDynamicScheduleResponseReceived;
            if (logger is not null)
            {
                try
                {
                    ...
                    await Task.WhenAll(logger.GetInvocationList().
                                                OfType<OnUpdateDynamicScheduleResponseReceivedDelegate>().
                                                Select(loggingDelegate => loggingDelegate.Invoke(
                                                                               Timestamp.Now,
                                                                               parentNetworkingNode,
                                                                               //    WebSocketConnection,
                ...
                {
                    DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnUpdateDynamicScheduleResponseReceived));
                }
            }
    ...
    public partial class OCPPWebSocketAdapterOUT : IOCPPWebSocketAdapterOUT
    {
        ...
        /// <summary>
        /// An event sent whenever a response to an UpdateDynamicSchedule was sent.
        /// </summary>
        ...
        public async Task SendOnUpdateDynamicScheduleResponseSent(DateTime              Timestamp,
                                                      IEventSender          Sender,
                                                      ...
                                                      TimeSpan              Runtime)
        {
            ...
            var logger = OnUpdateDynamicScheduleResponseSent;
            if (logger is not null)
            {
                try
                {
                ...
                catch (Exception e)
                {
                    await HandleErrors(
                              ...
                              nameof(OnUpdateDynamicScheduleResponseSent),
                              e
                          );
                }

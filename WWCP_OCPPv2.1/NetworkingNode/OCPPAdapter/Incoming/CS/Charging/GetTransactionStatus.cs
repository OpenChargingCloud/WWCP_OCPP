...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN : IOCPPWebSocketAdapterIN
    {
        ...
        #region Receive GetTransactionStatusRequest (wired via reflection!)
...

        {
            ...
            try
            {
                ...
                if (GetTransactionStatusRequest.TryParse(JSONRequest,
                    ...
                    var logger = OnGetTransactionStatusRequestReceived;
                    if (logger is not null)
                    {
                        ...
                        catch (Exception e)
                        {
                            await HandleErrors(
                                      ...
                                      nameof(OnGetTransactionStatusRequestReceived),
                                      e
                                  );
                        }
                    }
                    ...
                    await (parentNetworkingNode.OCPP.OUT as OCPPWebSocketAdapterOUT).SendOnGetTransactionStatusResponseSent(
                              Timestamp.Now,
                              parentNetworkingNode,
                              WebSocketConnection,
                              request,
        ...
        #region Receive GetTransactionStatusRequestError
...

        {
            ...
            var logger = OnGetTransactionStatusResponseReceived;
            if (logger is not null)
            {
                try
                {
                    ...
                    await Task.WhenAll(logger.GetInvocationList().
                                                OfType<OnGetTransactionStatusResponseReceivedDelegate>().
                                                Select(loggingDelegate => loggingDelegate.Invoke(
                                                                               Timestamp.Now,
                                                                               parentNetworkingNode,
                                                                               //    WebSocketConnection,
                ...
                {
                    DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnGetTransactionStatusResponseReceived));
                }
            }
    ...
    public partial class OCPPWebSocketAdapterOUT : IOCPPWebSocketAdapterOUT
    {
        ...
        /// <summary>
        /// An event sent whenever a response to a GetTransactionStatus was sent.
        /// </summary>
        ...
        public async Task SendOnGetTransactionStatusResponseSent(DateTime                      Timestamp,
                                                                 IEventSender                  Sender,
                                                                 ...
                                                                 TimeSpan                      Runtime)
        {
            ...
            var logger = OnGetTransactionStatusResponseSent;
            if (logger is not null)
            {
                try
                {
                ...
                catch (Exception e)
                {
                    await HandleErrors(
                              ...
                              nameof(OnGetTransactionStatusResponseSent),
                              e
                          );
                }

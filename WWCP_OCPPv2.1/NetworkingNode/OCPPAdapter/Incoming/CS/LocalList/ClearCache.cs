...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        #region Receive ClearCacheRequest (wired via reflection!)
...

        {
            ...
            try
            {
                ...
                if (ClearCacheRequest.TryParse(JSONRequest,
                    ...
                    await parentNetworkingNode.OCPP.OUT.SendOnClearCacheResponseSent(
                              Timestamp.Now,
                              parentNetworkingNode,
                              WebSocketConnection,
                              request,
        ...
        #region Receive ClearCacheRequestError
...

        {
            ...
            var logger = OnClearCacheResponseReceived;
            if (logger is not null)
            {
                try
                {
                    ...
                    await Task.WhenAll(logger.GetInvocationList().
                                                OfType<OnClearCacheResponseReceivedDelegate>().
                                                Select(loggingDelegate => loggingDelegate.Invoke(
                                                                               Timestamp.Now,
                                                                               parentNetworkingNode,
                                                                               //    WebSocketConnection,
                ...
                {
                    DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnClearCacheResponseReceived));
                }
            }

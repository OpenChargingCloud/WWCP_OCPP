...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        #region Receive ChangeAvailabilityRequest (wired via reflection!)
        ...
        #region Receive ChangeAvailabilityRequestError
...

        {
            ...
            var logger = OnChangeAvailabilityResponseReceived;
            if (logger is not null)
            {
                try
                {
                    ...
                    await Task.WhenAll(logger.GetInvocationList().
                                                OfType<OnChangeAvailabilityResponseReceivedDelegate>().
                                                Select(loggingDelegate => loggingDelegate.Invoke(
                                                                               Timestamp.Now,
                                                                               parentNetworkingNode,
                                                                               //    WebSocketConnection,
                ...
                {
                    DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnChangeAvailabilityResponseReceived));
                }
            }

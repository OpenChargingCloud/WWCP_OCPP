...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        #region Receive SetNetworkProfileRequest (wired via reflection!)
...

        {
            ...
            try
            {
                ...
                if (SetNetworkProfileRequest.TryParse(JSONRequest,
                    ...
                    await parentNetworkingNode.OCPP.OUT.SendOnSetNetworkProfileResponseSent(
                              Timestamp.Now,
                              parentNetworkingNode,
                              WebSocketConnection,
                              request,
        ...
        #region Receive SetNetworkProfileRequestError
...

        {
            ...
            var logger = OnSetNetworkProfileResponseReceived;
            if (logger is not null)
            {
                try
                {
                    ...
                    await Task.WhenAll(logger.GetInvocationList().
                                                OfType<OnSetNetworkProfileResponseReceivedDelegate>().
                                                Select(loggingDelegate => loggingDelegate.Invoke(
                                                                               Timestamp.Now,
                                                                               parentNetworkingNode,
                                                                               //    WebSocketConnection,
                ...
                {
                    DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnSetNetworkProfileResponseReceived));
                }
            }

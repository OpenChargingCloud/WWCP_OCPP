...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN : IOCPPWebSocketAdapterIN
    {
...

        {
            ...
            {
                DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnRemoveDefaultChargingTariffWSRequest));
            }
            ...
            try
            {
                ...
                if (RemoveDefaultChargingTariffRequest.TryParse(RequestJSON,
                    ...
                    try
                    {
                        ...
                        OnRemoveDefaultChargingTariffResponseSent?.Invoke(Timestamp.Now,
                                                                      parentNetworkingNode,
                                                                      WebSocketConnection,
                                                                      request,
                                                                      response,
                    ...
                    {
                        DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnRemoveDefaultChargingTariffResponseSent));
                    }
            ...
            {
                DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnRemoveDefaultChargingTariffWSResponse));
            }

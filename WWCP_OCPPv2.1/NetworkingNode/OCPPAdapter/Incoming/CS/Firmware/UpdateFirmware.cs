...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN : IOCPPWebSocketAdapterIN
    {
        ...
        #region Receive UpdateFirmwareRequest (wired via reflection!)
...

        {
            ...
            try
            {
                ...
                if (UpdateFirmwareRequest.TryParse(JSONRequest,
                    ...
                    var logger = OnUpdateFirmwareRequestReceived;
                    ...
                    await (parentNetworkingNode.OCPP.OUT as OCPPWebSocketAdapterOUT).SendOnUpdateFirmwareResponseSent(
                              Timestamp.Now,
                              parentNetworkingNode,
                              WebSocketConnection,
                              request,
        ...
        #region Receive UpdateFirmwareRequestError
...

        {
            ...
            var logger = OnUpdateFirmwareResponseReceived;
            if (logger is not null)
            {
                try
                {
                    ...
                    await Task.WhenAll(logger.GetInvocationList().
                                                OfType<OnUpdateFirmwareResponseReceivedDelegate>().
                                                Select(loggingDelegate => loggingDelegate.Invoke(
                                                                               Timestamp.Now,
                                                                               parentNetworkingNode,
                                                                               //    WebSocketConnection,
                ...
                {
                    DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnUpdateFirmwareResponseReceived));
                }
            }
    ...
    public partial class OCPPWebSocketAdapterOUT : IOCPPWebSocketAdapterOUT
    {
        ...
        /// <summary>
        /// An event sent whenever a response to an UpdateFirmware was sent.
        /// </summary>
        ...
        public async Task SendOnUpdateFirmwareResponseSent(DateTime                Timestamp,
                                                           IEventSender            Sender,
                                                           ...
                                                           TimeSpan                Runtime)
        {
            ...
            var logger = OnUpdateFirmwareResponseSent;
            if (logger is not null)
            {
                try
                {
                ...
                catch (Exception e)
                {
                    await HandleErrors(
                              ...
                              nameof(OnUpdateFirmwareResponseSent),
                              e
                          );
                }

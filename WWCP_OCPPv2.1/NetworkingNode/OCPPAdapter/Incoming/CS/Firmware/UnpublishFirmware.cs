...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        #region Receive UnpublishFirmwareRequest (wired via reflection!)
...

        {
            ...
            try
            {
                ...
                if (UnpublishFirmwareRequest.TryParse(JSONRequest,
                    ...
                    await parentNetworkingNode.OCPP.OUT.SendOnUnpublishFirmwareResponseSent(
                              Timestamp.Now,
                              parentNetworkingNode,
                              WebSocketConnection,
                              request,
        ...
        #region Receive UnpublishFirmwareRequestError
...

        {
            ...
            var logger = OnUnpublishFirmwareResponseReceived;
            if (logger is not null)
            {
                try
                {
                    ...
                    await Task.WhenAll(logger.GetInvocationList().
                                                OfType<OnUnpublishFirmwareResponseReceivedDelegate>().
                                                Select(loggingDelegate => loggingDelegate.Invoke(
                                                                               Timestamp.Now,
                                                                               parentNetworkingNode,
                                                                               //    WebSocketConnection,
                ...
                {
                    DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnUnpublishFirmwareResponseReceived));
                }
            }

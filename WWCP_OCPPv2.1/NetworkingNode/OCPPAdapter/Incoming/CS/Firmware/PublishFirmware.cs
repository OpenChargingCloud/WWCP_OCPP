...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN : IOCPPWebSocketAdapterIN
    {
        ...
        #region Receive PublishFirmwareRequest (wired via reflection!)
...

        {
            ...
            try
            {
                ...
                if (PublishFirmwareRequest.TryParse(JSONRequest,
                    ...
                    var logger = OnPublishFirmwareRequestReceived;
                    ...
                    await (parentNetworkingNode.OCPP.OUT as OCPPWebSocketAdapterOUT).SendOnPublishFirmwareResponseSent(
                              Timestamp.Now,
                              parentNetworkingNode,
                              WebSocketConnection,
                              request,
        ...
        #region Receive PublishFirmwareRequestError
...

        {
            ...
            var logger = OnPublishFirmwareResponseReceived;
            if (logger is not null)
            {
                try
                {
                    ...
                    await Task.WhenAll(logger.GetInvocationList().
                                                OfType<OnPublishFirmwareResponseReceivedDelegate>().
                                                Select(loggingDelegate => loggingDelegate.Invoke(
                                                                               Timestamp.Now,
                                                                               parentNetworkingNode,
                                                                               //    WebSocketConnection,
                ...
                {
                    DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnPublishFirmwareResponseReceived));
                }
            }
    ...
    public partial class OCPPWebSocketAdapterOUT : IOCPPWebSocketAdapterOUT
    {
        ...
        /// <summary>
        /// An event sent whenever a response to a PublishFirmware was sent.
        /// </summary>
        ...
        public async Task SendOnPublishFirmwareResponseSent(DateTime                 Timestamp,
                                                            IEventSender             Sender,
                                                            ...
                                                            TimeSpan                 Runtime)
        {
            ...
            var logger = OnPublishFirmwareResponseSent;
            if (logger is not null)
            {
                try
                {
                ...
                catch (Exception e)
                {
                    await HandleErrors(
                              ...
                              nameof(OnPublishFirmwareResponseSent),
                              e
                          );
                }

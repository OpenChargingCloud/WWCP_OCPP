...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
...

        {
            ...
            try
            {
                ...
                if (NotifyDisplayMessagesRequest.TryParse(JSONRequest,
                    ...
                    var logger = OnNotifyDisplayMessagesRequestReceived;
                    ...
                    await parentNetworkingNode.OCPP.OUT.SendOnNotifyDisplayMessagesResponseSent(
                              Timestamp.Now,
                              parentNetworkingNode,
                              WebSocketConnection,
                              request,
    ...
    public partial class OCPPWebSocketAdapterOUT
    {
        ...
        public async Task SendOnNotifyDisplayMessagesResponseSent(DateTime                       Timestamp,
                                                                  IEventSender                   Sender,
                                                                  ...
                                                                  TimeSpan                       Runtime)
        {
            ...
            var logger = OnNotifyDisplayMessagesResponseSent;
            if (logger is not null)
            {
                try
                {

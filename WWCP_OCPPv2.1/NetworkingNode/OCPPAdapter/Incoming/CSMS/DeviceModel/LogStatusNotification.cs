...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
...

        {
            ...
            try
            {
                ...
                if (LogStatusNotificationRequest.TryParse(JSONRequest,
                    ...
                    var logger = OnLogStatusNotificationRequestReceived;
                    ...
                    await (parentNetworkingNode.OCPP.OUT as OCPPWebSocketAdapterOUT).SendOnLogStatusNotificationResponseSent(
                              Timestamp.Now,
                              parentNetworkingNode,
                              WebSocketConnection,
                              request,
    ...
    public partial class OCPPWebSocketAdapterOUT : IOCPPWebSocketAdapterOUT
    {
        ...
        /// <summary>
        /// An event sent whenever a response to a LogStatusNotification was sent.
        /// </summary>
        ...
        public async Task SendOnLogStatusNotificationResponseSent(DateTime                       Timestamp,
                                                                  IEventSender                   Sender,
                                                                  ...
                                                                  TimeSpan                       Runtime)
        {
            ...
            var logger = OnLogStatusNotificationResponseSent;
            if (logger is not null)
            {
                try
                {

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
...

        {
            ...
            try
            {
                ...
                if (NotifyReportRequest.TryParse(JSONRequest,
                    ...
                    var logger = OnNotifyReportRequestReceived;
                    ...
                    await (parentNetworkingNode.OCPP.OUT as OCPPWebSocketAdapterOUT).SendOnNotifyReportResponseSent(
                              Timestamp.Now,
                              parentNetworkingNode,
                              WebSocketConnection,
                              request,
    ...
    public partial class OCPPWebSocketAdapterOUT : IOCPPWebSocketAdapterOUT
    {
        ...
        public async Task SendOnNotifyReportResponseSent(DateTime              Timestamp,
                                                         IEventSender          Sender,
                                                         ...
                                                         TimeSpan              Runtime)
        {
            ...
            var logger = OnNotifyReportResponseSent;
            if (logger is not null)
            {
                try
                {

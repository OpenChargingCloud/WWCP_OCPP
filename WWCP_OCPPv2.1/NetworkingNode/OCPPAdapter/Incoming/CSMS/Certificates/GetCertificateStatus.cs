...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN : IOCPPWebSocketAdapterIN
    {
        ...
        #region Receive GetCertificateStatusRequest (wired via reflection!)
...

        {
            ...
            try
            {
                ...
                if (GetCertificateStatusRequest.TryParse(JSONRequest,
                    ...
                    var logger = OnGetCertificateStatusRequestReceived;
                    ...
                    if (response is null)
                    {
                        try
                        {
                            ...
                            var responseTasks = OnGetCertificateStatus?.
                                                    GetInvocationList()?.
                                                    SafeSelect(subscriber => (subscriber as OnGetCertificateStatusDelegate)?.Invoke(
                                                                                  Timestamp.Now,
                                                                                  parentNetworkingNode,
                                                                                  WebSocketConnection,
                                                                                  request,
                            ...
                            response = responseTasks?.Length > 0
                                           ...
                                           : GetCertificateStatusResponse.Failed(request, $"Undefined {nameof(OnGetCertificateStatus)}!");

                        }
                        catch (Exception e)
                        {

                            response = GetCertificateStatusResponse.ExceptionOccured(request, e);

                            await HandleErrors(
                                      nameof(OCPPWebSocketAdapterIN),
                                      nameof(OnGetCertificateStatus),
                                      e
                                  );
                    ...
                    await (parentNetworkingNode.OCPP.OUT as OCPPWebSocketAdapterOUT).SendOnGetCertificateStatusResponseSent(
                              Timestamp.Now,
                              parentNetworkingNode,
                              WebSocketConnection,
                              request,
        ...
        #region Receive GetCertificateStatusRequestError
...

        {
            ...
            var logger = OnGetCertificateStatusResponseReceived;
            if (logger is not null)
            {
                try
                {
                    ...
                    await Task.WhenAll(logger.GetInvocationList().
                                                OfType<OnGetCertificateStatusResponseReceivedDelegate>().
                                                Select(loggingDelegate => loggingDelegate.Invoke(
                                                                               Timestamp.Now,
                                                                               parentNetworkingNode,
                                                                               //    WebSocketConnection,
                ...
                {
                    DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnGetCertificateStatusResponseReceived));
                }
            }
    ...
    public partial class OCPPWebSocketAdapterOUT : IOCPPWebSocketAdapterOUT
    {
        ...
        public async Task SendOnGetCertificateStatusResponseSent(DateTime                      Timestamp,
                                                                 IEventSender                  Sender,
                                                                 ...
                                                                 TimeSpan                      Runtime)
        {
            ...
            var logger = OnGetCertificateStatusResponseSent;
            if (logger is not null)
            {
                try
                {

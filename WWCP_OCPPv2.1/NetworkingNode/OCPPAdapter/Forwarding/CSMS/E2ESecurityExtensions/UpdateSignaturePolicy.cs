...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public event OnUpdateSignaturePolicyRequestFilterDelegate?      OnUpdateSignaturePolicyRequest;

        public event OnUpdateSignaturePolicyRequestFilteredDelegate?    OnUpdateSignaturePolicyRequestLogging;
...

        {
            ...
            if (logger is not null)
            {
                ...
                catch (Exception e)
                {
                    await HandleErrors(
                              "NetworkingNode",
                              nameof(OnUpdateSignaturePolicyRequestLogging),
                              e
                          );
                }

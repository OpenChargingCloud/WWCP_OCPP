...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    #region OnGetDefaultChargingTariff (-Request/-Response) Delegate

    /// <summary>
    /// A delegate called whenever a GetDefaultChargingTariff request will be sent to a charging station.
    /// </summary>
                                                  ...
                                                  INetworkingNodeChannel
    {
        ...
        public async Task<GetDefaultChargingTariffResponse> GetDefaultChargingTariff(GetDefaultChargingTariffRequest Request)
        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnGetDefaultChargingTariffRequest));
            }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnGetDefaultChargingTariffResponse));
            }

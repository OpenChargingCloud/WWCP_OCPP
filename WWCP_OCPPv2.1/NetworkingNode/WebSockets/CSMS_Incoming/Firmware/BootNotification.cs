...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
                                                  ...
                                                  INetworkingNodeChannel
    {
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnBootNotificationWSRequest));
            }
            ...
            try
            {
                ...
                if (BootNotificationRequest.TryParse(JSONRequest,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnBootNotificationRequest));
                    }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnBootNotificationWSResponse));
            }

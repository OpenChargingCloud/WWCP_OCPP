...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS
{
                                            ...
                                            IRequest
    {
        ...
        public SetNetworkProfileRequest(NetworkingNode_Id         NetworkingNodeId,
        ...
        #region (static) Parse   (JSON, RequestId, NetworkingNodeId, NetworkPath, CustomSetNetworkProfileRequestParser = null)
        ...
        #region (static) TryParse(JSON, RequestId, NetworkingNodeId, NetworkPath, out SetNetworkProfileRequest, out ErrorResponse, CustomBootNotificationResponseParser = null)

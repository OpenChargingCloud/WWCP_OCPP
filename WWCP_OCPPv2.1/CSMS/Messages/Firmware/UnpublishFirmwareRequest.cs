...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS
{
                                            ...
                                            IRequest
    {
        ...
        public UnpublishFirmwareRequest(NetworkingNode_Id        NetworkingNodeId,
                                        String                   MD5Checksum,
        ...
        #region (static) Parse   (JSON, RequestId, NetworkingNodeId, NetworkPath, CustomUnpublishFirmwareRequestParser = null)

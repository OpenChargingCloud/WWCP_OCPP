...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS
{
    ...
    /// <summary>
    /// A delegate called whenever a RequestStopTransaction request will be sent to a charging station.
    /// </summary>
    ...
    /// <summary>
    /// A delegate called whenever a response to a RequestStopTransaction request was received.
    /// </summary>
    /// <param name="Timestamp">The timestamp of the log request.</param>
    /// <param name="Sender">The sender of the request.</param>
    /// <param name="Request">The request.</param>

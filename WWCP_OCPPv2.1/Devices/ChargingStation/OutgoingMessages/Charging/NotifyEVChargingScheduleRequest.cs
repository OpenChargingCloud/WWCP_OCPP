...
namespace cloud.charging.open.protocols.OCPPv2_1.CS
{
                                                   ...
                                                   IRequest
    {
        ...
        public NotifyEVChargingScheduleRequest(NetworkingNode_Id        DestinationId,
                                               DateTime                 TimeBase,
                                               EVSE_Id                  EVSEId,
        ...
        #region (static) Parse   (JSON, RequestId, DestinationId, NetworkPath, CustomNotifyEVChargingScheduleRequestParser = null)
        ...
        #region (static) TryParse(JSON, RequestId, DestinationId, NetworkPath, out NotifyEVChargingScheduleRequest, out ErrorResponse, CustomNotifyEVChargingScheduleRequestParser = null)

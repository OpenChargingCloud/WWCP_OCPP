...
namespace cloud.charging.open.protocols.OCPPv2_1.CS
{
                                                     ...
                                                     IRequest
    {
        ...
        public FirmwareStatusNotificationRequest(NetworkingNode_Id        DestinationId,
        ...
        #region (static) Parse   (JSON, RequestId, DestinationId, NetworkPath, CustomFirmwareStatusNotificationRequestParser = null)
        ...
        #region (static) TryParse(JSON, RequestId, DestinationId, NetworkPath, out FirmwareStatusNotificationRequest, out ErrorResponse)

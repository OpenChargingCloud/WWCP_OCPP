...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    /// <summary>
    /// A received AddSignaturePolicy request.
    /// </summary>
    ...
    public delegate Task
        ...
        OnAddSignaturePolicyRequestReceivedDelegate(DateTime                    Timestamp,
                                                    IEventSender                Sender,
    ...
    /// <summary>
    /// Process a received AddSignaturePolicy request.
    /// </summary>
    /// <param name="Timestamp">The timestamp of the AddSignaturePolicy request.</param>
    /// <param name="Sender">The sender of the AddSignaturePolicy request.</param>
    /// <param name="Connection">The HTTP WebSocket server connection.</param>
    ...
    /// <summary>
    /// A sent AddSignaturePolicy response.
    /// </summary>
    /// <param name="Timestamp">The timestamp of the AddSignaturePolicy request.</param>
    /// <param name="Sender">The sender of the AddSignaturePolicy request.</param>
    /// <param name="Connection">The HTTP WebSocket server connection.</param>

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public delegate Task OnTransactionEventRequestReceivedDelegate(DateTimeOffset            Timestamp,
                                                                   IEventSender              Sender,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnTransactionEventResponseReceivedDelegate(DateTimeOffset             Timestamp,
                                                                    IEventSender               Sender,
                                                                    IWebSocketConnection?      Connection,
                                                                    TransactionEventRequest?   Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnTransactionEventRequestErrorReceivedDelegate(DateTimeOffset                 Timestamp,
                                                                        IEventSender                   Sender,
                                                                        IWebSocketConnection           Connection,
                                                                        TransactionEventRequest?       Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnTransactionEventResponseErrorReceivedDelegate(DateTimeOffset                  Timestamp,
                                                                         IEventSender                    Sender,
                                                                         IWebSocketConnection            Connection,
                                                                         TransactionEventRequest?        Request,
                                                                         TransactionEventResponse?       Response,
    ...
    public delegate Task<TransactionEventResponse>
        ...
        OnTransactionEventDelegate(DateTimeOffset            Timestamp,
                                   IEventSender              Sender,
                                   IWebSocketConnection      Connection,
                                   TransactionEventRequest   Request,
                                   CancellationToken         CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        public async Task<OCPP_Response>
            ...
            Receive_TransactionEvent(DateTimeOffset        RequestTimestamp,
            ...
            try
            {
                ...
                if (TransactionEventRequest.TryParse(JSONRequest,
                    ...
                    ocppResponse = OCPP_Response.JSONResponse(
                                       ...
                                       async sentMessageResult => await parentNetworkingNode.OCPP.OUT.SendOnTransactionEventResponseSent(
                                                                            Timestamp.Now,
                                                                            parentNetworkingNode,
...

        {
            ...
            catch (Exception e)
            {
                ...
                response = TransactionEventResponse.ExceptionOccurred(
                               Request,
                               e
                           );

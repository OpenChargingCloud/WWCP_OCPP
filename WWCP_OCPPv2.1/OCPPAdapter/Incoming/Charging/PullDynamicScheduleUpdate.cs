...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public delegate Task OnPullDynamicScheduleUpdateRequestReceivedDelegate(DateTime                           Timestamp,
                                                                            IEventSender                       Sender,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnPullDynamicScheduleUpdateResponseReceivedDelegate(DateTime                            Timestamp,
                                                                             IEventSender                        Sender,
                                                                             IWebSocketConnection                Connection,
                                                                             PullDynamicScheduleUpdateRequest?   Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnPullDynamicScheduleUpdateRequestErrorReceivedDelegate(DateTime                            Timestamp,
                                                                                 IEventSender                        Sender,
                                                                                 IWebSocketConnection                Connection,
                                                                                 PullDynamicScheduleUpdateRequest?   Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnPullDynamicScheduleUpdateResponseErrorReceivedDelegate(DateTime                             Timestamp,
                                                                                  IEventSender                         Sender,
                                                                                  IWebSocketConnection                 Connection,
                                                                                  PullDynamicScheduleUpdateRequest?    Request,
                                                                                  PullDynamicScheduleUpdateResponse?   Response,

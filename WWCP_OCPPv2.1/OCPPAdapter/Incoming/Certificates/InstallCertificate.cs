...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    /// <summary>
    /// A logging delegate called whenever an InstallCertificate request was received.
    /// </summary>
    ...
    public delegate Task OnInstallCertificateRequestReceivedDelegate(DateTimeOffset              Timestamp,
                                                                     IEventSender                Sender,
    ...
    /// <summary>
    /// A logging delegate called whenever an InstallCertificate response was received.
    /// </summary>
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnInstallCertificateResponseReceivedDelegate(DateTimeOffset               Timestamp,
                                                                      IEventSender                 Sender,
                                                                      IWebSocketConnection?        Connection,
                                                                      InstallCertificateRequest?   Request,
    ...
    /// <summary>
    /// A logging delegate called whenever an InstallCertificate request error was received.
    /// </summary>
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnInstallCertificateRequestErrorReceivedDelegate(DateTimeOffset                 Timestamp,
                                                                          IEventSender                   Sender,
                                                                          IWebSocketConnection           Connection,
                                                                          InstallCertificateRequest?     Request,
    ...
    /// <summary>
    /// A logging delegate called whenever an InstallCertificate response error was received.
    /// </summary>
    /// <param name="Timestamp">The logging timestamp.</param>
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnInstallCertificateResponseErrorReceivedDelegate(DateTimeOffset                  Timestamp,
                                                                           IEventSender                    Sender,
                                                                           IWebSocketConnection            Connection,
                                                                           InstallCertificateRequest?      Request,
                                                                           InstallCertificateResponse?     Response,
    ...
    /// <summary>
    /// A delegate called whenever an InstallCertificate response is expected
    ...
    public delegate Task<InstallCertificateResponse>
        ...
        OnInstallCertificateDelegate(DateTimeOffset              Timestamp,
                                     IEventSender                Sender,
                                     IWebSocketConnection        Connection,
                                     InstallCertificateRequest   Request,
                                     CancellationToken           CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        #region Receive InstallCertificate request
        ...
        public async Task<OCPP_Response>
            ...
            Receive_InstallCertificate(DateTimeOffset        RequestTimestamp,
        ...
        #region Receive InstallCertificate response

        /// <summary>
        /// An event fired whenever an InstallCertificate response was received.
        /// </summary>
        ...
        /// <summary>
        /// An event fired whenever an InstallCertificate request error was received.
        /// </summary>
        ...
        /// <summary>
        /// An event fired whenever an InstallCertificate response error was received.
        /// </summary>

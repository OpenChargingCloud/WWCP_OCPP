...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public delegate Task OnCostUpdatedRequestReceivedDelegate(DateTimeOffset         Timestamp,
                                                              IEventSender           Sender,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnCostUpdatedResponseReceivedDelegate(DateTimeOffset          Timestamp,
                                                               IEventSender            Sender,
                                                               IWebSocketConnection?   Connection,
                                                               CostUpdatedRequest?     Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnCostUpdatedRequestErrorReceivedDelegate(DateTimeOffset                 Timestamp,
                                                                   IEventSender                   Sender,
                                                                   IWebSocketConnection           Connection,
                                                                   CostUpdatedRequest?            Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnCostUpdatedResponseErrorReceivedDelegate(DateTimeOffset                  Timestamp,
                                                                    IEventSender                    Sender,
                                                                    IWebSocketConnection            Connection,
                                                                    CostUpdatedRequest?             Request,
                                                                    CostUpdatedResponse?            Response,
    ...
    public delegate Task<CostUpdatedResponse>
        ...
        OnCostUpdatedDelegate(DateTimeOffset         Timestamp,
                              IEventSender           Sender,
                              IWebSocketConnection   Connection,
                              CostUpdatedRequest     Request,
                              CancellationToken      CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        public async Task<OCPP_Response>
            ...
            Receive_CostUpdated(DateTimeOffset        RequestTimestamp,

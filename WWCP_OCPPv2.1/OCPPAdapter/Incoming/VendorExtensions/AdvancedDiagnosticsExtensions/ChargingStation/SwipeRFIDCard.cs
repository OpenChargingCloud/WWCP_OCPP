...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public delegate Task OnSwipeRFIDCardRequestReceivedDelegate(DateTime               Timestamp,
                                                                IEventSender           Sender,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnSwipeRFIDCardResponseReceivedDelegate(DateTime                Timestamp,
                                                                 IEventSender            Sender,
                                                                 IWebSocketConnection?   Connection,
                                                                 SwipeRFIDCardRequest?   Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnSwipeRFIDCardRequestErrorReceivedDelegate(DateTime                       Timestamp,
                                                                     IEventSender                   Sender,
                                                                     IWebSocketConnection           Connection,
                                                                     SwipeRFIDCardRequest?          Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnSwipeRFIDCardResponseErrorReceivedDelegate(DateTime                        Timestamp,
                                                                      IEventSender                    Sender,
                                                                      IWebSocketConnection            Connection,
                                                                      SwipeRFIDCardRequest?           Request,
                                                                      SwipeRFIDCardResponse?          Response,
    ...
    public delegate Task<SwipeRFIDCardResponse>
        ...
        OnSwipeRFIDCardDelegate(DateTime               Timestamp,
                                IEventSender           Sender,
                                IWebSocketConnection   Connection,
                                SwipeRFIDCardRequest   Request,
                                CancellationToken      CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        public async Task<OCPP_Response>
            ...
            Receive_SwipeRFIDCard(DateTime              RequestTimestamp,

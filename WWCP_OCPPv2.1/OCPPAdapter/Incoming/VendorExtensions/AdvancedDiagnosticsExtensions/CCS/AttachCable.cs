...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public delegate Task OnAttachCableRequestReceivedDelegate(DateTime               Timestamp,
                                                              IEventSender           Sender,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnAttachCableResponseReceivedDelegate(DateTime                Timestamp,
                                                               IEventSender            Sender,
                                                               IWebSocketConnection?   Connection,
                                                               AttachCableRequest?     Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnAttachCableRequestErrorReceivedDelegate(DateTime                       Timestamp,
                                                                   IEventSender                   Sender,
                                                                   IWebSocketConnection           Connection,
                                                                   AttachCableRequest?            Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnAttachCableResponseErrorReceivedDelegate(DateTime                        Timestamp,
                                                                    IEventSender                    Sender,
                                                                    IWebSocketConnection            Connection,
                                                                    AttachCableRequest?             Request,
                                                                    AttachCableResponse?            Response,
    ...
    public delegate Task<AttachCableResponse>
        ...
        OnAttachCableDelegate(DateTime               Timestamp,
                              IEventSender           Sender,
                              IWebSocketConnection   Connection,
                              AttachCableRequest     Request,
                              CancellationToken      CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        public async Task<OCPP_Response>
            ...
            Receive_AttachCable(DateTime              RequestTimestamp,

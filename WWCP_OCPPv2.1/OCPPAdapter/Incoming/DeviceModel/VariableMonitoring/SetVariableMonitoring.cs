...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public delegate Task OnSetVariableMonitoringRequestReceivedDelegate(DateTimeOffset                 Timestamp,
                                                                        IEventSender                   Sender,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnSetVariableMonitoringResponseReceivedDelegate(DateTimeOffset                  Timestamp,
                                                                         IEventSender                    Sender,
                                                                         IWebSocketConnection?           Connection,
                                                                         SetVariableMonitoringRequest?   Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnSetVariableMonitoringRequestErrorReceivedDelegate(DateTimeOffset                  Timestamp,
                                                                             IEventSender                    Sender,
                                                                             IWebSocketConnection            Connection,
                                                                             SetVariableMonitoringRequest?   Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnSetVariableMonitoringResponseErrorReceivedDelegate(DateTimeOffset                   Timestamp,
                                                                              IEventSender                     Sender,
                                                                              IWebSocketConnection             Connection,
                                                                              SetVariableMonitoringRequest?    Request,
                                                                              SetVariableMonitoringResponse?   Response,
    ...
    public delegate Task<SetVariableMonitoringResponse>
        ...
        OnSetVariableMonitoringDelegate(DateTimeOffset                 Timestamp,
                                        IEventSender                   Sender,
                                        IWebSocketConnection           Connection,
                                        SetVariableMonitoringRequest   Request,
                                        CancellationToken              CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        public async Task<OCPP_Response>
            ...
            Receive_SetVariableMonitoring(DateTimeOffset        RequestTimestamp,
            ...
            try
            {
                ...
                if (SetVariableMonitoringRequest.TryParse(JSONRequest,
                    ...
                    ocppResponse = OCPP_Response.JSONResponse(
                                       ...
                                       async sentMessageResult => await parentNetworkingNode.OCPP.OUT.SendOnSetVariableMonitoringResponseSent(
                                                                            Timestamp.Now,
                                                                            parentNetworkingNode,

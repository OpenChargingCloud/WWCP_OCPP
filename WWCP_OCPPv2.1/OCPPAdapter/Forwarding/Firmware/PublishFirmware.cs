...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public delegate Task
        ...
        OnPublishFirmwareRequestFilteredDelegate(DateTimeOffset                                                        Timestamp,
                                                 ...
                                                 IWebSocketConnection                                                  Connection,
                                                 PublishFirmwareRequest                                                Request,
                                                 RequestForwardingDecision<PublishFirmwareRequest, PublishFirmwareResponse>   ForwardingDecision,
                                                 CancellationToken                                                     CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
...

        {
            ...
            if (forwardingDecision is null && DefaultForwardingDecision == ForwardingDecisions.FORWARD)
                forwardingDecision = new RequestForwardingDecision<PublishFirmwareRequest, PublishFirmwareResponse>(
                                         request,

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public delegate Task<ForwardingDecision<QRCodeScannedRequest, QRCodeScannedResponse>>
    ...
    public delegate Task
        ...
        OnQRCodeScannedRequestFilteredDelegate(DateTime                                                          Timestamp,
                                               ...
                                               IWebSocketConnection                                              Connection,
                                               QRCodeScannedRequest                                              Request,
                                               ForwardingDecision<QRCodeScannedRequest, QRCodeScannedResponse>   ForwardingDecision,
                                               CancellationToken                                                 CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
...

        {
            ...
            ForwardingDecision<QRCodeScannedRequest, QRCodeScannedResponse>? forwardingDecision = null;
            ...
            if (forwardingDecision is null && DefaultForwardingResult == ForwardingResults.FORWARD)
                forwardingDecision = new ForwardingDecision<QRCodeScannedRequest, QRCodeScannedResponse>(
                                         request,

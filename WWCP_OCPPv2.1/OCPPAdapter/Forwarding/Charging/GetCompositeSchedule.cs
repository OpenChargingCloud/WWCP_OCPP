...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public delegate Task<RequestForwardingDecision<GetCompositeScheduleRequest, GetCompositeScheduleResponse>>

        OnGetCompositeScheduleRequestFilterDelegate(DateTimeOffset                Timestamp,
                                                    IEventSender                  Sender,
    ...
    public delegate Task
        ...
        OnGetCompositeScheduleRequestFilteredDelegate(DateTimeOffset                                                                  Timestamp,
                                                      IEventSender                                                                    Sender,
                                                      IWebSocketConnection                                                            Connection,
                                                      GetCompositeScheduleRequest                                                     Request,
                                                      RequestForwardingDecision<GetCompositeScheduleRequest, GetCompositeScheduleResponse>   ForwardingDecision,
                                                      CancellationToken                                                               CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
...

        {
            ...
            if (forwardingDecision is null && DefaultForwardingDecision == ForwardingDecisions.FORWARD)
                forwardingDecision = new RequestForwardingDecision<GetCompositeScheduleRequest, GetCompositeScheduleResponse>(
                                         request,

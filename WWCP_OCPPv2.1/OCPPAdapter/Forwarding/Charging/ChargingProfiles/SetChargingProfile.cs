...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public delegate Task<RequestForwardingDecision<SetChargingProfileRequest, SetChargingProfileResponse>>

        OnSetChargingProfileRequestFilterDelegate(DateTimeOffset              Timestamp,
                                                  IEventSender                Sender,
    ...
    public delegate Task
        ...
        OnSetChargingProfileRequestFilteredDelegate(DateTimeOffset                                                              Timestamp,
                                                    IEventSender                                                                Sender,
                                                    IWebSocketConnection                                                        Connection,
                                                    SetChargingProfileRequest                                                   Request,
                                                    RequestForwardingDecision<SetChargingProfileRequest, SetChargingProfileResponse>   ForwardingDecision,
                                                    CancellationToken                                                           CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
...

        {
            ...
            if (forwardingDecision is null && DefaultForwardingDecision == ForwardingDecisions.FORWARD)
                forwardingDecision = new RequestForwardingDecision<SetChargingProfileRequest, SetChargingProfileResponse>(
                                         request,

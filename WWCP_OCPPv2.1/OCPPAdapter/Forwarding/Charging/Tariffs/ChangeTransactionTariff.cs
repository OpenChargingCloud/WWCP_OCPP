...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public delegate Task<ForwardingDecision<ChangeTransactionTariffRequest, ChangeTransactionTariffResponse>>
    ...
    public delegate Task
        ...
        OnChangeTransactionTariffRequestFilteredDelegate(DateTime                                                                              Timestamp,
                                                         ...
                                                         IWebSocketConnection                                                                  Connection,
                                                         ChangeTransactionTariffRequest                                                        Request,
                                                         ForwardingDecision<ChangeTransactionTariffRequest, ChangeTransactionTariffResponse>   ForwardingDecision,
                                                         CancellationToken                                                                     CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
...

        {
            ...
            if (forwardingDecision is null && DefaultForwardingDecision == ForwardingDecisions.FORWARD)
                forwardingDecision = new ForwardingDecision<ChangeTransactionTariffRequest, ChangeTransactionTariffResponse>(
                                         request,

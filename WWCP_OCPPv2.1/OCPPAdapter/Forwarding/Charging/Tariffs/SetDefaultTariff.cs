...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public delegate Task<ForwardingDecision<SetDefaultTariffRequest, SetDefaultTariffResponse>>
    ...
    public delegate Task
        ...
        OnSetDefaultTariffRequestFilteredDelegate(DateTime                                                                Timestamp,
                                                  ...
                                                  IWebSocketConnection                                                    Connection,
                                                  SetDefaultTariffRequest                                                 Request,
                                                  ForwardingDecision<SetDefaultTariffRequest, SetDefaultTariffResponse>   ForwardingDecision,
                                                  CancellationToken                                                       CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
...

        {
            ...
            if (forwardingDecision is null && DefaultForwardingDecision == ForwardingDecisions.FORWARD)
                forwardingDecision = new ForwardingDecision<SetDefaultTariffRequest, SetDefaultTariffResponse>(
                                         request,

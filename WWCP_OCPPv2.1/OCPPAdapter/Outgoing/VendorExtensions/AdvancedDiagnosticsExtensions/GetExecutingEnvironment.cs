...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    /// <summary>
    /// A delegate called whenever a GetExecutingEnvironment request was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a GetExecutingEnvironment request error was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a GetExecutingEnvironment response error was sent.
    /// </summary>
    /// <param name="Timestamp">The logging timestamp.</param>
    ...
    public partial class OCPPWebSocketAdapterOUT
    {
        ...
        #region Send GetExecutingEnvironment request

        /// <summary>
        /// An event fired whenever a GetExecutingEnvironment request was sent.
        /// </summary>
        public event OnGetExecutingEnvironmentRequestSentDelegate?  OnGetExecutingEnvironmentRequestSent;


        /// <summary>
        /// Send a GetExecutingEnvironment request.
        /// </summary>
        /// <param name="Request">A GetExecutingEnvironment request.</param>
        public async Task<GetExecutingEnvironmentResponse>

            GetExecutingEnvironment(GetExecutingEnvironmentRequest Request)
            ...
            try
            {
                ...
                switch (Request.SerializationFormat)
                {
                            ...
                            else
                            {
                                ...
                                var sendRequestState = await SendJSONRequestAndWait(
                                                                 ...
                                                                 sentMessageResult => LogEvent(
                                                                     OnGetExecutingEnvironmentRequestSent,
                                ...
                                if (sendRequestState.IsValidJSONResponse(Request, out var jsonResponse))
                                    response = await parentNetworkingNode.OCPP.IN.Receive_GetExecutingEnvironmentResponse(
                                                         Request,
                                                         jsonResponse,
                                ...
                                if (sendRequestState.IsValidJSONRequestError(Request, out var jsonRequestError))
                                    response = await parentNetworkingNode.OCPP.IN.Receive_GetExecutingEnvironmentRequestError(
                                                         Request,
                                                         jsonRequestError,
                                                         sendRequestState.WebSocketConnectionReceived,
                                                         sendRequestState.DestinationReceived,
                                ...
                                response ??= new GetExecutingEnvironmentResponse(
                                                 Request,
                    ...
                    case SerializationFormats.JSON_UTF8_Binary: {
                        ...
                        //                         Timestamp.Now,
                        //                         GetExecutingEnvironmentResponse.DefaultInterval,
                        //                         Result: Result.FromSendRequestState(sendRequestState)
                        //                     );
                    ...
                    case SerializationFormats.BinaryCompact: {
                            ...
                            //        Request,
                            //        Request.ToBinary(
                            //            //parentNetworkingNode.OCPP.CustomBinaryGetExecutingEnvironmentRequestSerializer,
        ...
        #region Send OnGetExecutingEnvironmentResponseSent event

        /// <summary>
        /// An event sent whenever a GetExecutingEnvironment response was sent.
        /// </summary>
        ...
        public Task SendOnGetExecutingEnvironmentResponseSent(DateTimeOffset                   Timestamp,
            ...
            => LogEvent(
                   OnGetExecutingEnvironmentResponseSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,
        ...
        #region Send OnGetExecutingEnvironmentRequestErrorSent event

        /// <summary>
        /// An event sent whenever a GetExecutingEnvironment request error was sent.
        /// </summary>
        ...
        public Task SendOnGetExecutingEnvironmentRequestErrorSent(DateTimeOffset                   Timestamp,
            ...
            => LogEvent(
                   OnGetExecutingEnvironmentRequestErrorSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,
        ...
        #region Send OnGetExecutingEnvironmentResponseErrorSent event

        /// <summary>
        /// An event sent whenever a GetExecutingEnvironment response error was sent.
        /// </summary>
        ...
        public Task SendOnGetExecutingEnvironmentResponseErrorSent(DateTimeOffset                    Timestamp,
            ...
            => LogEvent(
                   OnGetExecutingEnvironmentResponseErrorSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,

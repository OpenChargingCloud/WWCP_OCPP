...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    /// <summary>
    /// A delegate called whenever a SetCEVoltage request was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a SetCEVoltage request error was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a SetCEVoltage response error was sent.
    /// </summary>
    /// <param name="Timestamp">The logging timestamp.</param>
    ...
    public partial class OCPPWebSocketAdapterOUT
    {
        ...
        #region Send SetCEVoltage request

        /// <summary>
        /// An event fired whenever a SetCEVoltage request was sent.
        /// </summary>
        public event OnSetCEVoltageRequestSentDelegate?  OnSetCEVoltageRequestSent;


        /// <summary>
        /// Send a SetCEVoltage request.
        /// </summary>
        /// <param name="Request">A SetCEVoltage request.</param>
        public async Task<SetCEVoltageResponse>

            SetCEVoltage(SetCEVoltageRequest Request)
            ...
            try
            {
                ...
                switch (Request.SerializationFormat)
                {
                    ...
                    case SerializationFormats.JSON: {
                            ...
                            else
                            {
                                ...
                                if (sendRequestState.IsValidJSONResponse(Request, out var jsonResponse))
                                    response = await parentNetworkingNode.OCPP.IN.Receive_SetCEVoltageResponse(
                                                         Request,
                                                         jsonResponse,
                                ...
                                if (sendRequestState.IsValidJSONRequestError(Request, out var jsonRequestError))
                                    response = await parentNetworkingNode.OCPP.IN.Receive_SetCEVoltageRequestError(
                                                         Request,
                                                         jsonRequestError,
                                                         sendRequestState.WebSocketConnectionReceived,
                                                         sendRequestState.DestinationReceived,
                                ...
                                response ??= new SetCEVoltageResponse(
                                                 Request,
                    ...
                    case SerializationFormats.JSON_UTF8_Binary: {
                        ...
                        //                         Timestamp.Now,
                        //                         SetCEVoltageResponse.DefaultInterval,
                        //                         Result: Result.FromSendRequestState(sendRequestState)
                        //                     );
                    ...
                    case SerializationFormats.BinaryCompact: {
                            ...
                            //        Request,
                            //        Request.ToBinary(
                            //            //parentNetworkingNode.OCPP.CustomBinarySetCEVoltageRequestSerializer,
        ...
        #region Send OnSetCEVoltageResponseSent event

        /// <summary>
        /// An event sent whenever a SetCEVoltage response was sent.
        /// </summary>
        ...
        #region Send OnSetCEVoltageRequestErrorSent event

        /// <summary>
        /// An event sent whenever a SetCEVoltage request error was sent.
        /// </summary>
        ...
        public Task SendOnSetCEVoltageRequestErrorSent(DateTimeOffset                Timestamp,
            ...
            => LogEvent(
                   OnSetCEVoltageRequestErrorSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,
        ...
        #region Send OnSetCEVoltageResponseErrorSent event

        /// <summary>
        /// An event sent whenever a SetCEVoltage response error was sent.
        /// </summary>
        ...
        public Task SendOnSetCEVoltageResponseErrorSent(DateTimeOffset                 Timestamp,
            ...
            => LogEvent(
                   OnSetCEVoltageResponseErrorSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    /// <summary>
    /// A delegate called whenever a GetCertificateStatus request was sent.
    /// </summary>
    ...
    /// <summary>
    /// A GetCertificateStatus response.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a GetCertificateStatus request error was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a GetCertificateStatus response error was sent.
    /// </summary>
    /// <param name="Timestamp">The logging timestamp.</param>
    ...
    public partial class OCPPWebSocketAdapterOUT
    {
        ...
        #region Send GetCertificateStatus request

        /// <summary>
        /// An event fired whenever a GetCertificateStatus request was sent.
        /// </summary>
...

        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (sendRequestState.IsValidJSONResponse(Request, out var jsonResponse))
                        response = await parentNetworkingNode.OCPP.IN.Receive_GetCertificateStatusResponse(
                                             Request,
                                             jsonResponse,
                    ...
                    if (sendRequestState.IsValidJSONRequestError(Request, out var jsonRequestError))
                        response = await parentNetworkingNode.OCPP.IN.Receive_GetCertificateStatusRequestError(
                                             Request,
                                             jsonRequestError,
                                             sendRequestState.WebSocketConnectionReceived,
                                             sendRequestState.DestinationIdReceived,
            ...
            catch (Exception e)
            {
                ...
                response = GetCertificateStatusResponse.ExceptionOccured(
                               Request,
                               e
                           );
        ...
        /// <summary>
        /// An event sent whenever a GetCertificateStatus response was sent.
        /// </summary>
        ...
        public Task SendOnGetCertificateStatusResponseSent(DateTime                      Timestamp,
            ...
            => LogEvent(
                   OnGetCertificateStatusResponseSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,
        ...
        #region Send OnGetCertificateStatusRequestErrorSent event

        /// <summary>
        /// An event sent whenever a GetCertificateStatus request error was sent.
        /// </summary>
        ...
        public Task SendOnGetCertificateStatusRequestErrorSent(DateTime                      Timestamp,
            ...
            => LogEvent(
                   OnGetCertificateStatusRequestErrorSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,
        ...
        #region Send OnGetCertificateStatusResponseErrorSent event

        /// <summary>
        /// An event sent whenever a GetCertificateStatus response error was sent.
        /// </summary>
        ...
        public Task SendOnGetCertificateStatusResponseErrorSent(DateTime                       Timestamp,
            ...
            => LogEvent(
                   OnGetCertificateStatusResponseErrorSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,

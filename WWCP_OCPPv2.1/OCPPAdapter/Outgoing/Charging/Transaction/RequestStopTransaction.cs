...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    /// <summary>
    /// A delegate called whenever a RequestStopTransaction request was sent.
    /// </summary>
    ...
    /// <summary>
    /// A RequestStopTransaction response.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a RequestStopTransaction request error was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a RequestStopTransaction response error was sent.
    /// </summary>
    /// <param name="Timestamp">The logging timestamp.</param>
    ...
    public partial class OCPPWebSocketAdapterOUT
    {
        ...
        #region Send RequestStopTransaction request

        /// <summary>
        /// An event fired whenever a RequestStopTransaction request was sent.
        /// </summary>
        public event OnRequestStopTransactionRequestSentDelegate?  OnRequestStopTransactionRequestSent;


        /// <summary>
        /// Send a RequestStopTransaction request.
        /// </summary>
        /// <param name="Request">A RequestStopTransaction request.</param>
        public async Task<RequestStopTransactionResponse>

            RequestStopTransaction(RequestStopTransactionRequest Request)

        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (sendRequestState.IsValidJSONResponse(Request, out var jsonResponse))
                        response = await parentNetworkingNode.OCPP.IN.Receive_RequestStopTransactionResponse(
                                             Request,
                                             jsonResponse,
                    ...
                    if (sendRequestState.IsValidJSONRequestError(Request, out var jsonRequestError))
                        response = await parentNetworkingNode.OCPP.IN.Receive_RequestStopTransactionRequestError(
                                             Request,
                                             jsonRequestError,
                                             sendRequestState.WebSocketConnectionReceived,
                                             sendRequestState.DestinationReceived,
            ...
            catch (Exception e)
            {
                ...
                response = RequestStopTransactionResponse.ExceptionOccurred(
                               Request,
                               e
                           );
        ...
        #region Send OnRequestStopTransactionResponseSent event

        /// <summary>
        /// An event sent whenever a RequestStopTransaction response was sent.
        /// </summary>
        ...
        public Task SendOnRequestStopTransactionResponseSent(DateTimeOffset                  Timestamp,
            ...
            => LogEvent(
                   OnRequestStopTransactionResponseSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,
        ...
        #region Send OnRequestStopTransactionRequestErrorSent event

        /// <summary>
        /// An event sent whenever a RequestStopTransaction request error was sent.
        /// </summary>
        ...
        public Task SendOnRequestStopTransactionRequestErrorSent(DateTimeOffset                  Timestamp,
            ...
            => LogEvent(
                   OnRequestStopTransactionRequestErrorSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,
        ...
        #region Send OnRequestStopTransactionResponseErrorSent event

        /// <summary>
        /// An event sent whenever a RequestStopTransaction response error was sent.
        /// </summary>
        ...
        public Task SendOnRequestStopTransactionResponseErrorSent(DateTimeOffset                   Timestamp,
            ...
            => LogEvent(
                   OnRequestStopTransactionResponseErrorSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    /// <summary>
    /// A delegate called whenever a NotifySettlement request was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a NotifySettlement request error was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a NotifySettlement response error was sent.
    /// </summary>
    /// <param name="Timestamp">The logging timestamp.</param>
    ...
    public partial class OCPPWebSocketAdapterOUT
    {
        ...
        #region Send NotifySettlement request

        /// <summary>
        /// An event fired whenever a NotifySettlement request was sent.
        /// </summary>
        public event OnNotifySettlementRequestSentDelegate?  OnNotifySettlementRequestSent;


        /// <summary>
        /// Send a NotifySettlement request.
        /// </summary>
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (sendRequestState.IsValidJSONResponse(Request, out var jsonResponse))
                        response = await parentNetworkingNode.OCPP.IN.Receive_NotifySettlementResponse(
                                             Request,
                                             jsonResponse,
                    ...
                    if (sendRequestState.IsValidJSONRequestError(Request, out var jsonRequestError))
                        response = await parentNetworkingNode.OCPP.IN.Receive_NotifySettlementRequestError(
                                             Request,
                                             jsonRequestError,
                                             sendRequestState.WebSocketConnectionReceived,
                                             sendRequestState.DestinationReceived,
        ...
        #region Send OnNotifySettlementResponseSent event

        /// <summary>
        /// An event sent whenever a NotifySettlement response was sent.
        /// </summary>
        ...
        public Task SendOnNotifySettlementResponseSent(DateTime                  Timestamp,
            ...
            => LogEvent(
                   OnNotifySettlementResponseSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,
        ...
        #region Send OnNotifySettlementRequestErrorSent event

        /// <summary>
        /// An event sent whenever a NotifySettlement request error was sent.
        /// </summary>
        ...
        public Task SendOnNotifySettlementRequestErrorSent(DateTime                      Timestamp,
            ...
            => LogEvent(
                   OnNotifySettlementRequestErrorSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,
        ...
        #region Send OnNotifySettlementResponseErrorSent event

        /// <summary>
        /// An event sent whenever a NotifySettlement response error was sent.
        /// </summary>
        ...
        public Task SendOnNotifySettlementResponseErrorSent(DateTime                       Timestamp,
            ...
            => LogEvent(
                   OnNotifySettlementResponseErrorSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,

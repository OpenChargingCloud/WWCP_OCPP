...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    /// <summary>
    /// A delegate called whenever a ClearVariableMonitoring request was sent.
    /// </summary>
    ...
    /// <summary>
    /// A ClearVariableMonitoring response.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a ClearVariableMonitoring request error was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a ClearVariableMonitoring response error was sent.
    /// </summary>
    /// <param name="Timestamp">The logging timestamp.</param>
    ...
    public partial class OCPPWebSocketAdapterOUT
    {
        ...
        #region Send ClearVariableMonitoring request

        /// <summary>
        /// An event fired whenever a ClearVariableMonitoring request was sent.
        /// </summary>
        public event OnClearVariableMonitoringRequestSentDelegate?  OnClearVariableMonitoringRequestSent;


        /// <summary>
        /// Send a ClearVariableMonitoring request.
        /// </summary>
...

        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (sendRequestState.IsValidJSONResponse(Request, out var jsonResponse))
                        response = await parentNetworkingNode.OCPP.IN.Receive_ClearVariableMonitoringResponse(
                                             Request,
                                             jsonResponse,
                    ...
                    if (sendRequestState.IsValidJSONRequestError(Request, out var jsonRequestError))
                        response = await parentNetworkingNode.OCPP.IN.Receive_ClearVariableMonitoringRequestError(
                                             Request,
                                             jsonRequestError,
                                             sendRequestState.WebSocketConnectionReceived,
                                             sendRequestState.DestinationReceived,
            ...
            catch (Exception e)
            {
                ...
                response = ClearVariableMonitoringResponse.ExceptionOccurred(
                               Request,
                               e
                           );
        ...
        #region Send OnClearVariableMonitoringResponseSent event

        /// <summary>
        /// An event sent whenever a ClearVariableMonitoring response was sent.
        /// </summary>
        ...
        public Task SendOnClearVariableMonitoringResponseSent(DateTime                         Timestamp,
            ...
            => LogEvent(
                   OnClearVariableMonitoringResponseSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,
        ...
        #region Send OnClearVariableMonitoringRequestErrorSent event

        /// <summary>
        /// An event sent whenever a ClearVariableMonitoring request error was sent.
        /// </summary>
        ...
        public Task SendOnClearVariableMonitoringRequestErrorSent(DateTime                         Timestamp,
            ...
            => LogEvent(
                   OnClearVariableMonitoringRequestErrorSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,
        ...
        #region Send OnClearVariableMonitoringResponseErrorSent event

        /// <summary>
        /// An event sent whenever a ClearVariableMonitoring response error was sent.
        /// </summary>
        ...
        public Task SendOnClearVariableMonitoringResponseErrorSent(DateTime                          Timestamp,
            ...
            => LogEvent(
                   OnClearVariableMonitoringResponseErrorSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,

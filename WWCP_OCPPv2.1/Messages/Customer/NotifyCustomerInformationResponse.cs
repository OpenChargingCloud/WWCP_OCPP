...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS
{
                                                     ...
                                                     IResponse<Result>
    {
        ...
        #region (static) TryParse(Request, JSON, Destination, NetworkPath, out NotifyCustomerInformationResponse, out ErrorResponse, ...)
        ...
        public JObject ToJSON(Boolean                                                              IncludeJSONLDContext                                = false,
                              CustomJObjectSerializerDelegate<NotifyCustomerInformationResponse>?  CustomNotifyCustomerInformationResponseSerializer   = null,
        ...
        public static NotifyCustomerInformationResponse ExceptionOccurred(NotifyCustomerInformationRequest  Request,
                                                                         Exception                         Exception)

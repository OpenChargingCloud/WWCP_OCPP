...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS
{
                                                 ...
                                                 IResponse<Result>
    {
        ...
        #region (static) TryParse(Request, JSON, Destination, NetworkPath, out NotifyDisplayMessagesResponse, out ErrorResponse, ...)
        ...
        public JObject ToJSON(Boolean                                                          IncludeJSONLDContext                            = false,
                              CustomJObjectSerializerDelegate<NotifyDisplayMessagesResponse>?  CustomNotifyDisplayMessagesResponseSerializer   = null,
        ...
        public static NotifyDisplayMessagesResponse ExceptionOccurred(NotifyDisplayMessagesRequest  Request,
                                                                     Exception                     Exception)

...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS
{
                                         ...
                                         IRequest
    {
        ...
        public DeleteUserRoleRequest(ChargingStation_Id       ChargingStationId,
        ...
        #region (static) Parse   (JSON, RequestId, ChargingStationId, CustomDeleteUserRoleRequestParser = null)
        ...
        #region (static) TryParse(JSON, RequestId, ChargingStationId, out DeleteUserRoleRequest, out ErrorResponse, CustomAuthorizeRequestParser = null)
        ...
        public static Boolean TryParse(JObject                       JSON,
                                       Request_Id                    RequestId,
                                       ChargingStation_Id            ChargingStationId,
                                       out DeleteUserRoleRequest?  DeleteUserRoleRequest,
                                       out String?                   ErrorResponse)

            => TryParse(JSON,
                        RequestId,
                        ChargingStationId,
                        out DeleteUserRoleRequest,
                        out ErrorResponse,
                        null);
        ...
        public override Boolean Equals(Object? Object)
            ...
            => Object is DeleteUserRoleRequest bootNotificationRequest &&
        ...
        public override Boolean Equals(DeleteUserRoleRequest? DeleteUserRoleRequest)
            ...
            => DeleteUserRoleRequest is not null &&
               ...
               ChargingStation.Equals(DeleteUserRoleRequest.ChargingStation) &&
               Reason.         Equals(DeleteUserRoleRequest.Reason)          &&

...
namespace cloud.charging.open.protocols.OCPPv2_1.CS
{
                                          ...
                                          IResponse
    {
        ...
        #region DeleteUserRoleResponse(Request, Status, CurrentTime, Interval, StatusInfo = null, CustomData = null)
        ...
        /// <param name="Interval">When the registration status is 'accepted', the interval defines the heartbeat interval in seconds. In all other cases, the value of the interval field indicates the minimum wait time before sending a next DeleteUserRole request.</param>
        ...
        public override Boolean Equals(Object? Object)
            ...
            => Object is DeleteUserRoleResponse bootNotificationResponse &&

...
namespace cloud.charging.open.protocols.OCPPv2_1.CS
{
                                             ...
                                             IResponse<Result>
    {
        ...
        #region (static) TryParse(Request, JSON, Destination, NetworkPath, out SetMonitoringBaseResponse, out ErrorResponse, ...)
        ...
        public JObject ToJSON(Boolean                                                      IncludeJSONLDContext                        = false,
                              CustomJObjectSerializerDelegate<SetMonitoringBaseResponse>?  CustomSetMonitoringBaseResponseSerializer   = null,
        ...
        public static SetMonitoringBaseResponse ExceptionOccurred(SetMonitoringBaseRequest  Request,
                                                                 Exception                 Exception)

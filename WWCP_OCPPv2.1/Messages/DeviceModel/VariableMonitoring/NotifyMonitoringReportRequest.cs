...
namespace cloud.charging.open.protocols.OCPPv2_1.CS
{
                                                 ...
                                                 IRequest
    {
        ...
        #region (static) TryParse(JSON, RequestId, Destination, NetworkPath, out NotifyMonitoringReportRequest, out ErrorResponse, ...)
        ...
        public JObject ToJSON(Boolean                                                          IncludeJSONLDContext                            = false,
                              CustomJObjectSerializerDelegate<NotifyMonitoringReportRequest>?  CustomNotifyMonitoringReportRequestSerializer   = null,

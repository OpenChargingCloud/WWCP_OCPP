...
namespace cloud.charging.open.protocols.OCPPv2_1.CS
{
                                              ...
                                              IResponse<Result>
    {
        ...
        #region (static) TryParse(Request, JSON, Destination, NetworkPath, out SetMonitoringLevelResponse, out ErrorResponse, ...)
        ...
        public JObject ToJSON(Boolean                                                       IncludeJSONLDContext                         = false,
                              CustomJObjectSerializerDelegate<SetMonitoringLevelResponse>?  CustomSetMonitoringLevelResponseSerializer   = null,

...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS
{
                                                  ...
                                                  IResponse<Result>
    {
        ...
        #region (static) TryParse(Request, JSON, Destination, NetworkPath, out NotifyMonitoringReportResponse, out ErrorResponse, ...)
        ...
        public JObject ToJSON(Boolean                                                           IncludeJSONLDContext                             = false,
                              CustomJObjectSerializerDelegate<NotifyMonitoringReportResponse>?  CustomNotifyMonitoringReportResponseSerializer   = null,
        ...
        public static NotifyMonitoringReportResponse ExceptionOccurred(NotifyMonitoringReportRequest  Request,
                                                                      Exception                      Exception)

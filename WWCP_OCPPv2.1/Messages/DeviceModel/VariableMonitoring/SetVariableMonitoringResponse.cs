...
namespace cloud.charging.open.protocols.OCPPv2_1.CS
{
                                                 ...
                                                 IResponse<Result>
    {
        ...
        #region (static) TryParse(Request, JSON, Destination, NetworkPath, out SetVariableMonitoringResponse, out ErrorResponse, ...)
        ...
        public static SetVariableMonitoringResponse ExceptionOccurred(SetVariableMonitoringRequest  Request,
                                                                     Exception                     Exception)

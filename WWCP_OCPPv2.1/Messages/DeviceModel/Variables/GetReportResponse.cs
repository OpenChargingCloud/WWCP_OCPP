...
namespace cloud.charging.open.protocols.OCPPv2_1.CS
{
                                     ...
                                     IResponse<Result>
    {
        ...
        #region (static) TryParse(Request, JSON, Destination, NetworkPath, out GetReportResponse, out ErrorResponse, ...)
        ...
        public JObject ToJSON(Boolean                                              IncludeJSONLDContext                = false,
                              CustomJObjectSerializerDelegate<GetReportResponse>?  CustomGetReportResponseSerializer   = null,
        ...
        public static GetReportResponse ExceptionOccurred(GetReportRequest  Request,
                                                         Exception         Exception)

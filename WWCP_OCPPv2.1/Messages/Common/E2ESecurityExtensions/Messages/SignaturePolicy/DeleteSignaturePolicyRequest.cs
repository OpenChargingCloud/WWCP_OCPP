...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
                                                ...
                                                IRequest
    {
        ...
        public DeleteSignaturePolicyRequest(SourceRouting            SourceRouting,
        ...
        #region (static) Parse   (JSON, RequestId, SourceRouting, NetworkPath, CustomDeleteSignaturePolicyRequestParser = null)
        ...
        #region (static) TryParse(JSON, RequestId, SourceRouting, NetworkPath, out DeleteSignaturePolicyRequest, out ErrorResponse, CustomAuthorizeRequestParser = null)

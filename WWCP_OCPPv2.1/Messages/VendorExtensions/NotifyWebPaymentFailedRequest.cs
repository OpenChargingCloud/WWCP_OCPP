...
namespace cloud.charging.open.protocols.OCPPv2_1.CS
{
    ...
    /// </summary>
    public class NotifyWebPaymentFailedRequest : DataTransferRequest,//<NotifyWebPaymentFailedRequest>,
                                                 IRequest
    {
        ...
        /// <summary>
        /// Notify the charging station that a web payment was cancelled or failed.
        /// </summary>
        ...
        public Boolean Equals(NotifyWebPaymentFailedRequest? NotifyWebPaymentFailedRequest)
            ...
            => NotifyWebPaymentFailedRequest is not null &&
               EVSEId.Equals(NotifyWebPaymentFailedRequest.EVSEId) &&

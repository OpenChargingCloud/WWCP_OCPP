...
namespace cloud.charging.open.protocols.OCPPv2_1.CS
{
                                       ...
                                       IResponse<Result>
    {
        ...
        #region ToJSON(CustomGetPWMValueResponseSerializer = null, CustomStatusInfoSerializer = null, ...)
        ...
        public override Boolean Equals(GetPWMValueResponse? GetPWMValueResponse)
            ...
            => GetPWMValueResponse is not null &&
             ...
             ((StatusInfo is     null && GetPWMValueResponse.StatusInfo is     null) ||
               StatusInfo is not null && GetPWMValueResponse.StatusInfo is not null && StatusInfo.Equals(GetPWMValueResponse.StatusInfo)) &&

               base.GenericEquals(GetPWMValueResponse);

...
namespace cloud.charging.open.protocols.OCPPv2_1.CS
{
                                        ...
                                        IResponse<Result>
    {
        ...
        #region ToJSON(CustomSetCPVoltageResponseSerializer = null, CustomStatusInfoSerializer = null, ...)
        ...
        public override Boolean Equals(SetCPVoltageResponse? SetCPVoltageResponse)
            ...
            => SetCPVoltageResponse is not null &&
             ...
             ((StatusInfo is     null && SetCPVoltageResponse.StatusInfo is     null) ||
               StatusInfo is not null && SetCPVoltageResponse.StatusInfo is not null && StatusInfo.Equals(SetCPVoltageResponse.StatusInfo)) &&

               base.GenericEquals(SetCPVoltageResponse);

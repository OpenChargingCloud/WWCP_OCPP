...
namespace cloud.charging.open.protocols.OCPPv2_1.CS
{
                                                   ...
                                                   IResponse<Result>
    {
        ...
        #region ToJSON(CustomGetExecutingEnvironmentResponseSerializer = null. CustomStatusInfoSerializer = null, ...)
        ...
        public override Boolean Equals(GetExecutingEnvironmentResponse? GetExecutingEnvironmentResponse)
            ...
            => GetExecutingEnvironmentResponse is not null &&
             ...
             ((StatusInfo    is     null &&  GetExecutingEnvironmentResponse.StatusInfo    is     null) ||
               StatusInfo    is not null &&  GetExecutingEnvironmentResponse.StatusInfo    is not null && StatusInfo.Equals(GetExecutingEnvironmentResponse.StatusInfo))         &&

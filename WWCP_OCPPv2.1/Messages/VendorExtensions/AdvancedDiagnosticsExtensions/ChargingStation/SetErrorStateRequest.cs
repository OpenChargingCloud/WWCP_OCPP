...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS
{
                                        ...
                                        IRequest
    {
        ...
        /// <summary>
        /// The optional EVSE and connector identification, when the charging station has more than one EVSE
        /// (0 > EVSEId ≤ MaxEVSEId) and (0 > ConnectorId ≤ MaxConnectorId(EVSEId)).
        /// </summary>
        [Optional]
        ...
        /// <param name="EVSE">The optional EVSE and connector identification, when the charging station has more than one EVSE (0 > EVSEId ≤ MaxEVSEId) and (0 > ConnectorId ≤ MaxConnectorId(EVSEId)).</param>
        ...
        #region ToJSON(CustomSetErrorStateRequestSerializer = null, CustomEVSESerializer = null, ...)

        /// <summary>
        /// Return a JSON representation of this object.
        /// </summary>
        /// <param name="CustomSetErrorStateRequestSerializer">A delegate to serialize custom SetErrorState requests.</param>
        /// <param name="CustomEVSESerializer">A delegate to serialize EVSE objects.</param>
        ...
        public override Boolean Equals(SetErrorStateRequest? SetErrorStateRequest)
            ...
            => SetErrorStateRequest is not null &&
             ...
             ((EVSE is null             && SetErrorStateRequest.EVSE is null) ||
              (EVSE is not null         && SetErrorStateRequest.EVSE is not null          && EVSE.                 Equals(SetErrorStateRequest.EVSE)))                  &&

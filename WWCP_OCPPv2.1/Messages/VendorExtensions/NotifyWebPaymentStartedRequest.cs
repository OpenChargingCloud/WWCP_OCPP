...
namespace cloud.charging.open.protocols.OCPPv2_0_1.CSMS
{
    ...
    /// </summary>
    public class NotifyWebPaymentStartedRequest : DataTransferRequest, //<NotifyWebPaymentStartedRequest>,
                                                  IRequest
    {
        ...
        ///// </summary>
        //public readonly static JSONLDContext DefaultJSONLDContext = JSONLDContext.Parse("https://open.charging.cloud/context/ocpp/v2.0.1/cs/notifyWebPaymentStartedRequest");
        ...
        /// </summary>
        [Mandatory]
        public OCPPv2_1.EVSE_Id   EVSEId     { get; }
        ...
        #region Operator == (NotifyWebPaymentStartedRequest1, NotifyWebPaymentStartedRequest)
        ...
        /// <param name="NotifyWebPaymentStartedRequest">Another NotifyWebPaymentStartedRequest request.</param>
        /// <returns>True if both match; False otherwise.</returns>
        public static Boolean operator == (NotifyWebPaymentStartedRequest? NotifyWebPaymentStartedRequest1,
                                           NotifyWebPaymentStartedRequest? NotifyWebPaymentStartedRequest)
        {

            // If both are null, or both are same instance, return true.
            if (ReferenceEquals(NotifyWebPaymentStartedRequest1, NotifyWebPaymentStartedRequest))
                return true;

            // If one is null, but not both, return false.
            if (NotifyWebPaymentStartedRequest1 is null || NotifyWebPaymentStartedRequest is null)
                return false;

            return NotifyWebPaymentStartedRequest1.Equals(NotifyWebPaymentStartedRequest);
        ...
        public static Boolean operator != (NotifyWebPaymentStartedRequest? NotifyWebPaymentStartedRequest1,
            ...
            => !(NotifyWebPaymentStartedRequest1 == NotifyWebPaymentStartedRequest);
        ...
        public override String ToString()
            ...
            => $"EVSE: {EVSEId}, for {(UInt32) Timeout.TotalSeconds} seconds";

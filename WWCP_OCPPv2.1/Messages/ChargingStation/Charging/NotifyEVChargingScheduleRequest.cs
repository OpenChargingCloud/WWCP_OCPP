...
namespace cloud.charging.open.protocols.OCPPv2_1.CS
{
                                                   ...
                                                   IRequest
    {
        ...
        /// </summary>
        public readonly static JSONLDContext DefaultJSONLDContext = JSONLDContext.Parse("https://open.charging.cloud/context/ocpp/cs/notifyEVChargingScheduleRequest");
        ...
        public NotifyEVChargingScheduleRequest(NetworkingNode_Id        NetworkingNodeId,
                                               DateTime                 TimeBase,
                                               EVSE_Id                  EVSEId,
        ...
        #region (static) Parse   (JSON, RequestId, NetworkingNodeId, NetworkPath, CustomNotifyEVChargingScheduleRequestParser = null)
        ...
        #region (static) TryParse(JSON, RequestId, NetworkingNodeId, NetworkPath, out NotifyEVChargingScheduleRequest, out ErrorResponse, CustomNotifyEVChargingScheduleRequestParser = null)
        ...
        public static Boolean TryParse(JObject                               JSON,
            ...
            => TryParse(JSON,
                        ...
                        NetworkingNodeId,
                        NetworkPath,
                        out NotifyEVChargingScheduleRequest,
                        out ErrorResponse,
                        null);

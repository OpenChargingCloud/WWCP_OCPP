...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS
{
                                                   ...
                                                   IResponse<Result>
    {
        ...
        #region (static) TryParse(Request, JSON, Destination, NetworkPath, out ReservationStatusUpdateResponse, out ErrorResponse, ...)
        ...
        public JObject ToJSON(Boolean                                                            IncludeJSONLDContext                              = false,
                              CustomJObjectSerializerDelegate<ReservationStatusUpdateResponse>?  CustomReservationStatusUpdateResponseSerializer   = null,
        ...
        public static ReservationStatusUpdateResponse ExceptionOccurred(ReservationStatusUpdateRequest  Request,
                                                                       Exception                       Exception)

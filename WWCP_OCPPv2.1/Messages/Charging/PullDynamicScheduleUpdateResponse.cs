...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS
{
    ...
    public class PullDynamicScheduleUpdateResponse(CS.PullDynamicScheduleUpdateRequest  Request,
            ...
            : AResponse<CS.PullDynamicScheduleUpdateRequest,
                        PullDynamicScheduleUpdateResponse>(Request,
                                                           Result ?? Result.OK(),
                                                           ResponseTimestamp,
...

    {
        ...
        /// </summary>
        [Optional]
        public ChargingRateValue?  Limit                  { get; } = Limit;

        /// <summary>
        /// Optional charging rate limit in chargingRateUnit on phase L2.
        /// </summary>
        [Optional]
        public ChargingRateValue?  Limit_L2               { get; } = Limit_L2;

        /// <summary>
        /// Optional charging rate limit in chargingRateUnit on phase L3.
        /// </summary>
        [Optional]
        public ChargingRateValue?  Limit_L3               { get; } = Limit_L3;
        ...
        /// </summary>
        [Optional]
        public ChargingRateValue?  DischargeLimit         { get; } = DischargeLimit;

        /// <summary>
        /// Optional discharging limit in chargingRateUnit on phase L2.
        /// </summary>
        [Optional]
        public ChargingRateValue?  DischargeLimit_L2      { get; } = DischargeLimit_L2;

        /// <summary>
        /// Optional discharging limit in chargingRateUnit on phase L3.
        /// </summary>
        [Optional]
        public ChargingRateValue?  DischargeLimit_L3      { get; } = DischargeLimit_L3;
        ...
        /// </summary>
        [Optional]
        public ChargingRateValue?  Setpoint               { get; } = Setpoint;

        /// <summary>
        /// Optional setpoint in chargingRateUnit on phase L2.
        /// </summary>
        [Optional]
        public ChargingRateValue?  Setpoint_L2            { get; } = Setpoint_L2;

        /// <summary>
        /// Optional setpoint in chargingRateUnit on phase L3.
        /// </summary>
        [Optional]
        public ChargingRateValue?  Setpoint_L3            { get; } = Setpoint_L3;
        ...
        /// </summary>
        [Optional]
        public ChargingRateValue?  SetpointReactive       { get; } = SetpointReactive;

        /// <summary>
        /// Optional setpoint for reactive power (or current) in chargingRateUnit on phase L2.
        /// </summary>
        [Optional]
        public ChargingRateValue?  SetpointReactive_L2    { get; } = SetpointReactive_L2;

        /// <summary>
        /// Optional setpoint for reactive power (or current) in chargingRateUnit on phase L3.
        /// </summary>
        [Optional]
        public ChargingRateValue?  SetpointReactive_L3    { get; } = SetpointReactive_L3;
        ...
        public static PullDynamicScheduleUpdateResponse FormationViolation(CS.PullDynamicScheduleUpdateRequest  Request,

...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS
{
...

    {
        ...
        #region (static) TryParse(Request, JSON, Destination, NetworkPath, out ClearedChargingLimitResponse, out ErrorResponse, ...)
        ...
        public JObject ToJSON(Boolean                                                         IncludeJSONLDContext                           = false,
                              CustomJObjectSerializerDelegate<ClearedChargingLimitResponse>?  CustomClearedChargingLimitResponseSerializer   = null,

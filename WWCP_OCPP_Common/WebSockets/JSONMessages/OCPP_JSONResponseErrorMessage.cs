...
namespace cloud.charging.open.protocols.OCPP.WebSockets
{
    ...
    /// <summary>
    /// A OCPP WebSocket JSON response error message (OCPP v2.1 draft!)
    /// </summary>
                                               ...
                                               CancellationToken  CancellationToken   = default)
    {
        ...
        public static OCPP_JSONResponseErrorMessage CouldNotParse(Request_Id  RequestId,
                                                                  String      Action,
        ...
        public static OCPP_JSONResponseErrorMessage CouldNotParse(EventTracking_Id  EventTrackingId,
                                                                  Request_Id        RequestId,
                                                                  String            Action,
                                                                  JObject           JSONObjectRequest,
                                                                  String?           ErrorResponse   = null)
        ...
        public static OCPP_JSONResponseErrorMessage FormationViolation(Request_Id  RequestId,
                                                                       String      Action,
                                                                       JObject     JSONObjectRequest,
                                                                       Exception   Exception)
        ...
        public static OCPP_JSONResponseErrorMessage FormationViolation(EventTracking_Id  EventTrackingId,
                                                                       Request_Id        RequestId,
                                                                       String            Action,
                                                                       JObject           JSONObjectRequest,
                                                                       Exception         Exception)
        ...
        public static OCPP_JSONResponseErrorMessage InternalError(String            Sender,
                                                                  EventTracking_Id  EventTrackingId,
                                       ...
                                       NetworkingNode_Id?                                      ImplicitSourceNodeId   = null)
        {
            ...
            try
            {
                ...
                ErrorMessage = new OCPP_JSONResponseErrorMessage(
                                   Timestamp.Now,
                                   EventTracking_Id.New,
                                   NetworkingMode.Standard,
                                   SourceRouting.Zero,

...
namespace cloud.charging.open.protocols.OCPP.WebSockets
{
    ...
    public class OCPP_BinaryRequestMessage(NetworkingMode     NetworkingMode,
                                           ...
                                           String?            ErrorMessage   = null)
    {
                                       ...
                                       out String?                     ErrorResponse)
        {
            ...
            try
            {
                ...
                if (!NetworkingNode_Id.TryParse(destinationNodeIdText, out var destinationNodeId))
                {
        ...
        public Byte[] ToByteArray()
        {
            ...
            {
                binaryStream.WriteByte(0);   // DestinationNodeId length
                binaryStream.WriteByte(0);   // NetworkPath       length
            }
            else if (NetworkingMode == NetworkingMode.NetworkingExtensions)
            {
                ...
                binaryStream.Write(destinationNodeIdBytes, 0, destinationNodeIdBytes. Length);
                ...
                if (NetworkPath is not null)
                {
                    foreach (var sourceNodeId in NetworkPath)
                    {
                        ...
                        binaryStream.Write(sourceNodeIdBytes, 0, sourceNodeIdBytes.Length);
                    }
                }

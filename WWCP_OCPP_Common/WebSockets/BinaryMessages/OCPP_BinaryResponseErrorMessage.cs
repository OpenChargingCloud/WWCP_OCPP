...
namespace cloud.charging.open.protocols.OCPP.WebSockets
{
    ...
    /// <summary>
    /// A OCPP WebSocket binary response error message (OCPP v2.1 draft!)
    /// </summary>
    ...
    public class OCPP_BinaryResponseErrorMessage(DateTimeOffset     ResponseTimestamp,
                                                 ...
                                                 CancellationToken  CancellationToken   = default)
    {
        ...
        public static OCPP_BinaryResponseErrorMessage CouldNotParse(Request_Id  RequestId,
                                                                    String      Action,
        ...
        public static OCPP_BinaryResponseErrorMessage CouldNotParse(EventTracking_Id  EventTrackingId,
                                                                    Request_Id        RequestId,
                                                                    String            Action,
                                                                    JObject           JSONObjectRequest,
                                                                    String?           ErrorResponse   = null)
        ...
        public static OCPP_BinaryResponseErrorMessage FormationViolation(Request_Id  RequestId,
                                                                         String      Action,
                                                                         JObject     JSONObjectRequest,
                                                                         Exception   Exception)
        ...
        public static OCPP_BinaryResponseErrorMessage FormationViolation(EventTracking_Id  EventTrackingId,
                                                                         Request_Id        RequestId,
                                                                         String            Action,
                                                                         JObject           JSONObjectRequest,
                                                                         Exception         Exception)
        ...
        public static OCPP_BinaryResponseErrorMessage InternalError(String            Sender,
                                                                    EventTracking_Id  EventTrackingId,
        ...
        public static Boolean TryParse(Byte[]                                                    JSONArray,
                                       [NotNullWhen(true)] out OCPP_BinaryResponseErrorMessage?  ErrorMessage,
                                       NetworkingNode_Id?                                        ImplicitSourceNodeId   = null)
        {
            ...
            try
            {
                ...
                //ErrorMessage = new OCPP_BinaryResponseErrorMessage(
                //                   Timestamp.Now,
                //                   EventTracking_Id.New,
                //                   NetworkingMode.Standard,

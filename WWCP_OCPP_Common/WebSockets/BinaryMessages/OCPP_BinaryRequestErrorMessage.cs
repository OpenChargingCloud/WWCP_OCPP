...
namespace cloud.charging.open.protocols.OCPP.WebSockets
{
    ...
    /// <summary>
    /// A OCPP WebSocket binary request error message.
    /// </summary>
    ...
    public class OCPP_BinaryRequestErrorMessage(DateTimeOffset     ResponseTimestamp,
                                                ...
                                                CancellationToken  CancellationToken   = default)
    {
        ...
        public static OCPP_BinaryRequestErrorMessage CouldNotParse(Request_Id  RequestId,
                                                                   String      Action,
        ...
        public static OCPP_BinaryRequestErrorMessage CouldNotParse(EventTracking_Id  EventTrackingId,
                                                                   Request_Id        RequestId,
                                                                   String            Action,
                                                                   JObject           JSONObjectRequest,
                                                                   String?           ErrorResponse   = null)
        ...
        public static OCPP_BinaryRequestErrorMessage FormationViolation(Request_Id  RequestId,
                                                                        String      Action,
                                                                        JObject     JSONObjectRequest,
                                                                        Exception   Exception)
        ...
        public static OCPP_BinaryRequestErrorMessage FormationViolation(EventTracking_Id  EventTrackingId,
                                                                        Request_Id        RequestId,
                                                                        String            Action,
                                                                        JObject           JSONObjectRequest,
                                                                        Exception         Exception)
        ...
        public static OCPP_BinaryRequestErrorMessage InternalError(String            Sender,
                                                                   EventTracking_Id  EventTrackingId,
        ...
        public static Boolean TryParse(Byte[]                                                   JSONArray,
                                       [NotNullWhen(true)] out OCPP_BinaryRequestErrorMessage?  ErrorMessage,
                                       NetworkingNode_Id?                                       ImplicitSourceNodeId   = null)
        {
            ...
            try
            {
                ...
                //ErrorMessage = new OCPP_BinaryRequestErrorMessage(
                //                   Timestamp.Now,
                //                   EventTracking_Id.New,
                //                   NetworkingMode.Standard,

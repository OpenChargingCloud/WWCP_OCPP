...
namespace cloud.charging.open.protocols.OCPP.CSMS
{
    ...
    public delegate Task
        ...
        OnIncomingNotifyNetworkTopologyRequestDelegate(DateTime                       Timestamp,
                                                       IEventSender                   Sender,
    ...
    /// <summary>
    /// A NotifyNetworkTopology request at the given charging station.
    /// </summary>
    /// <param name="Timestamp">The timestamp of the request.</param>
    /// <param name="Sender">The sender of the request.</param>
    /// <param name="Connection">The HTTP WebSocket server connection.</param>
    ...
    public delegate Task<NotifyNetworkTopologyResponse>
        ...
        OnIncomingNotifyNetworkTopologyDelegate(DateTime                       Timestamp,
                                                IEventSender                   Sender,
                                                WebSocketServerConnection      Connection,
                                                NotifyNetworkTopologyRequest   Request,
    ...
    public delegate Task
        ...
        OnIncomingNotifyNetworkTopologyResponseDelegate(DateTime                        Timestamp,
                                                        IEventSender                    Sender,
                                                        WebSocketServerConnection       Connection,
                                                        NotifyNetworkTopologyRequest    Request,

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN : IOCPPWebSocketAdapterIN
    {
        ...
        /// </summary>
        public event OCPPv2_1.CSMS.OnLogStatusNotificationRequestReceivedDelegate?     OnLogStatusNotificationRequestReceived;
...

        {
            ...
            try
            {
                ...
                if (LogStatusNotificationRequest.TryParse(JSONRequest,
                    ...
                    {
                        DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnLogStatusNotificationRequestReceived));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnLogStatusNotificationResponseSent));
                    }

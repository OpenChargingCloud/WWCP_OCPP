...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN : IOCPPWebSocketAdapterIN
    {
        ...
        /// </summary>
        public event OCPP.CS.OnAddSignaturePolicyResponseDelegate?    OnAddSignaturePolicyResponseSent;
...

        {
            ...
            try
            {
                ...
                if (AddSignaturePolicyRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnAddSignaturePolicyRequest));
                    }

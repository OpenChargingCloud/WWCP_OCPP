...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<AFRRSignalRequest, AFRRSignalResponse>>

            Forward_AFRRSignal(AFRRSignalRequest     Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.REJECT && response.RejectResponse is null
                                             ? new ForwardingDecision<AFRRSignalRequest, AFRRSignalResponse>(
                                                   response.Request,
            ...
            var resultLog = OnAFRRSignalRequestLogging;

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<SetMonitoringLevelRequest, SetMonitoringLevelResponse>>

            Forward_SetMonitoringLevel(SetMonitoringLevelRequest  Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.DROP && response.DropResponse is null
                                             ? new ForwardingDecision<SetMonitoringLevelRequest, SetMonitoringLevelResponse>(
                                                   response.Request,
            ...
            var resultLog = OnSetMonitoringLevelRequestLogging;

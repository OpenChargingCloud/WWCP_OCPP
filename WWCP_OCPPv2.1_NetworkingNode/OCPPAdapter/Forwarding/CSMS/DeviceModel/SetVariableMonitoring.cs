...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<SetVariableMonitoringRequest, SetVariableMonitoringResponse>>

            Forward_SetVariableMonitoring(SetVariableMonitoringRequest  Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.DROP && response.DropResponse is null
                                             ? new ForwardingDecision<SetVariableMonitoringRequest, SetVariableMonitoringResponse>(
                                                   response.Request,
            ...
            var resultLog = OnSetVariableMonitoringRequestLogging;

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<TriggerMessageRequest, TriggerMessageResponse>>

            Forward_TriggerMessage(TriggerMessageRequest  Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.DROP && response.DropResponse is null
                                             ? new ForwardingDecision<TriggerMessageRequest, TriggerMessageResponse>(
                                                   response.Request,
            ...
            var resultLog = OnTriggerMessageRequestLogging;

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<GetReportRequest, GetReportResponse>>

            Forward_GetReport(GetReportRequest      Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.DROP && response.DropResponse is null
                                             ? new ForwardingDecision<GetReportRequest, GetReportResponse>(
                                                   response.Request,
            ...
            var resultLog = OnGetReportRequestLogging;

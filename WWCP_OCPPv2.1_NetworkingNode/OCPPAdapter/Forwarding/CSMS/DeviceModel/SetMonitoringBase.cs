...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<SetMonitoringBaseRequest, SetMonitoringBaseResponse>>

            Forward_SetMonitoringBase(SetMonitoringBaseRequest  Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.REJECT && response.RejectResponse is null
                                             ? new ForwardingDecision<SetMonitoringBaseRequest, SetMonitoringBaseResponse>(
                                                   response.Request,
            ...
            var resultLog = OnSetMonitoringBaseRequestLogging;

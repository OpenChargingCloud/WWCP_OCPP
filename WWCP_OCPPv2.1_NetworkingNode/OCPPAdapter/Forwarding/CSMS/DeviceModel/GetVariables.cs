...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<GetVariablesRequest, GetVariablesResponse>>

            Forward_GetVariables(GetVariablesRequest   Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.DROP && response.DropResponse is null
                                             ? new ForwardingDecision<GetVariablesRequest, GetVariablesResponse>(
                                                   response.Request,
            ...
            var resultLog = OnGetVariablesRequestLogging;

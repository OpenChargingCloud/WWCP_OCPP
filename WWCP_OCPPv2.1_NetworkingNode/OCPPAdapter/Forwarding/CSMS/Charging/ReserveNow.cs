...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<ReserveNowRequest, ReserveNowResponse>>

            Forward_ReserveNow(ReserveNowRequest     Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.DROP && response.DropResponse is null
                                             ? new ForwardingDecision<ReserveNowRequest, ReserveNowResponse>(
                                                   response.Request,
            ...
            var resultLog = OnReserveNowRequestLogging;

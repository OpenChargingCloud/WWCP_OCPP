...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<GetCompositeScheduleRequest, GetCompositeScheduleResponse>>

            Forward_GetCompositeSchedule(GetCompositeScheduleRequest  Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.DROP && response.DropResponse is null
                                             ? new ForwardingDecision<GetCompositeScheduleRequest, GetCompositeScheduleResponse>(
                                                   response.Request,
            ...
            var resultLog = OnGetCompositeScheduleRequestLogging;

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<RequestStopTransactionRequest, RequestStopTransactionResponse>>

            Forward_RequestStopTransaction(RequestStopTransactionRequest  Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.DROP && response.DropResponse is null
                                             ? new ForwardingDecision<RequestStopTransactionRequest, RequestStopTransactionResponse>(
                                                   response.Request,
            ...
            var resultLog = OnRequestStopTransactionRequestLogging;

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<CertificateSignedRequest, CertificateSignedResponse>>

            Forward_CertificateSigned(CertificateSignedRequest  Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.DROP && response.DropResponse is null
                                             ? new ForwardingDecision<CertificateSignedRequest, CertificateSignedResponse>(
                                                   response.Request,
            ...
            var resultLog = OnCertificateSignedRequestLogging;

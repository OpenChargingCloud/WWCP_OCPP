...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<InstallCertificateRequest, InstallCertificateResponse>>

            Forward_InstallCertificate(InstallCertificateRequest  Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.REJECT && response.RejectResponse is null
                                             ? new ForwardingDecision<InstallCertificateRequest, InstallCertificateResponse>(
                                                   response.Request,
            ...
            var resultLog = OnInstallCertificateRequestLogging;

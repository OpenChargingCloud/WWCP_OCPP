...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<GetDisplayMessagesRequest, GetDisplayMessagesResponse>>

            Forward_GetDisplayMessages(GetDisplayMessagesRequest  Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.REJECT && response.RejectResponse is null
                                             ? new ForwardingDecision<GetDisplayMessagesRequest, GetDisplayMessagesResponse>(
                                                   response.Request,
            ...
            var resultLog = OnGetDisplayMessagesRequestLogging;

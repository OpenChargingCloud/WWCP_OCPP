...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<CostUpdatedRequest, CostUpdatedResponse>>

            Forward_CostUpdated(CostUpdatedRequest    Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.REJECT && response.RejectResponse is null
                                             ? new ForwardingDecision<CostUpdatedRequest, CostUpdatedResponse>(
                                                   response.Request,
            ...
            var resultLog = OnCostUpdatedRequestLogging;

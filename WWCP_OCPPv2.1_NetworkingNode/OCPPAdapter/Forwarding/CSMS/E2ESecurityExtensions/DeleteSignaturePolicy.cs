...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public event OnDeleteSignaturePolicyRequestFilterDelegate?      OnDeleteSignaturePolicyRequest;

        public event OnDeleteSignaturePolicyRequestFilteredDelegate?    OnDeleteSignaturePolicyRequestLogging;

        #endregion

        public async Task<ForwardingDecision<DeleteSignaturePolicyRequest, DeleteSignaturePolicyResponse>>

            Forward_DeleteSignaturePolicy(DeleteSignaturePolicyRequest  Request,
...

        {
            ...
            var requestFilter = OnDeleteSignaturePolicyRequest;
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.REJECT && response.RejectResponse is null
                                             ? new ForwardingDecision<DeleteSignaturePolicyRequest, DeleteSignaturePolicyResponse>(
                                                   response.Request,
            ...
            var resultLog = OnDeleteSignaturePolicyRequestLogging;
            if (resultLog is not null)
            {
                ...
                catch (Exception e)
                {
                    await HandleErrors(
                              nameof(TestNetworkingNode),
                              nameof(OnDeleteSignaturePolicyRequestLogging),
                              e
                          );
                }

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public event OnPublishFirmwareStatusNotificationRequestFilterDelegate?      OnPublishFirmwareStatusNotificationRequest;

        public event OnPublishFirmwareStatusNotificationRequestFilteredDelegate?    OnPublishFirmwareStatusNotificationRequestLogging;

        #endregion

        public async Task<ForwardingDecision<PublishFirmwareStatusNotificationRequest, PublishFirmwareStatusNotificationResponse>>

            Forward_PublishFirmwareStatusNotification(PublishFirmwareStatusNotificationRequest  Request,
...

        {
            ...
            var requestFilter = OnPublishFirmwareStatusNotificationRequest;
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.DROP && response.DropResponse is null
                                             ? new ForwardingDecision<PublishFirmwareStatusNotificationRequest, PublishFirmwareStatusNotificationResponse>(
                                                   response.Request,
            ...
            var resultLog = OnPublishFirmwareStatusNotificationRequestLogging;
            if (resultLog is not null)
            {
                ...
                catch (Exception e)
                {
                    await HandleErrors(
                              nameof(TestNetworkingNode),
                              nameof(OnPublishFirmwareStatusNotificationRequestLogging),
                              e
                          );
                }

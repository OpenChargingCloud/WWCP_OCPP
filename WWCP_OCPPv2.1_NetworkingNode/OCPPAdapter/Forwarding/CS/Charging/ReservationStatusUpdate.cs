...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public async Task<ForwardingDecision<ReservationStatusUpdateRequest, ReservationStatusUpdateResponse>>

            Forward_ReservationStatusUpdate(ReservationStatusUpdateRequest  Request,
...

        {
            ...
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.REJECT && response.RejectResponse is null
                                             ? new ForwardingDecision<ReservationStatusUpdateRequest, ReservationStatusUpdateResponse>(
                                                   response.Request,
            ...
            var resultLog = OnReservationStatusUpdateRequestLogging;

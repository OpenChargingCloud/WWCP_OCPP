...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterFORWARD
    {
        ...
        public event OnNotifyMonitoringReportRequestFilterDelegate?      OnNotifyMonitoringReportRequest;

        public event OnNotifyMonitoringReportRequestFilteredDelegate?    OnNotifyMonitoringReportRequestLogging;

        #endregion

        public async Task<ForwardingDecision<NotifyMonitoringReportRequest, NotifyMonitoringReportResponse>>

            Forward_NotifyMonitoringReport(NotifyMonitoringReportRequest  Request,
...

        {
            ...
            var requestFilter = OnNotifyMonitoringReportRequest;
            if (requestFilter is not null)
            {
                try
                {
                    ...
                    forwardingDecision = response.Result == ForwardingResult.DROP && response.DropResponse is null
                                             ? new ForwardingDecision<NotifyMonitoringReportRequest, NotifyMonitoringReportResponse>(
                                                   response.Request,
            ...
            var resultLog = OnNotifyMonitoringReportRequestLogging;
            if (resultLog is not null)
            {
                ...
                catch (Exception e)
                {
                    await HandleErrors(
                              nameof(TestNetworkingNode),
                              nameof(OnNotifyMonitoringReportRequestLogging),
                              e
                          );
                }

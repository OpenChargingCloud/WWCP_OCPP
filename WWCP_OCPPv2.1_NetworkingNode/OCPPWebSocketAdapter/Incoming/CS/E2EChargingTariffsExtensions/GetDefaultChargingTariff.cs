...

        {
            ...
            try
            {
                ...
                if (GetDefaultChargingTariffRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnGetDefaultChargingTariffRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnGetDefaultChargingTariffResponse));
                    }

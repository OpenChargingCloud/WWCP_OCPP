...

        {
            ...
            try
            {
                ...
                if (ClearDisplayMessageRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnClearDisplayMessageRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnClearDisplayMessageResponse));
                    }

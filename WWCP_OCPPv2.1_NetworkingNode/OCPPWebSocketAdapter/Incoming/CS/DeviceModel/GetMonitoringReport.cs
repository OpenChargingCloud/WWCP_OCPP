...

        {
            ...
            try
            {
                ...
                if (GetMonitoringReportRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnGetMonitoringReportRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnGetMonitoringReportResponse));
                    }

...

        {
            ...
            try
            {
                ...
                if (NotifyEVChargingNeedsRequest.TryParse(JSONRequest,
                    ...
                    {
                        DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnNotifyEVChargingNeedsRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnNotifyEVChargingNeedsResponse));
                    }

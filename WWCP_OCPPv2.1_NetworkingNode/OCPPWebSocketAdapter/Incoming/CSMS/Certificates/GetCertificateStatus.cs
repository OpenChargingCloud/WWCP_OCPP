...

        {
            ...
            try
            {
                ...
                if (GetCertificateStatusRequest.TryParse(JSONRequest,
                    ...
                    {
                        DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnGetCertificateStatusRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(OCPPWebSocketAdapterIN) + "." + nameof(OnGetCertificateStatusResponse));
                    }

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    /// </summary>
    public partial class OCPPWebSocketClient : AOCPPWebSocketClient
    {
        ...
        public OCPPWebSocketClient(NetworkingNode_Id                    NetworkingNodeIdentity,
                                   IOCPPWebSocketAdapterIN              OCPPWebSocketAdapterIN,
                                                             ...
                                                             CancellationToken          CancellationToken)
        {
            ...
            try
            {
                ...
                var textMessageResponse = await OCPPWebSocketAdapterIN.ProcessJSONMessage(RequestTimestamp,
                                                                                          ClientConnection,
                                                                                          jsonArray,
                                                                                          EventTrackingId,
                                                                                          CancellationToken);
                                                               ...
                                                               CancellationToken          CancellationToken)
        {
            ...
            try
            {
                ...
                var binaryMessageResponse = await OCPPWebSocketAdapterIN.ProcessBinaryMessage(RequestTimestamp,
                                                                                              ClientConnection,
                                                                                              BinaryMessage,
                                                                                              EventTrackingId,
                                                                                              CancellationToken);

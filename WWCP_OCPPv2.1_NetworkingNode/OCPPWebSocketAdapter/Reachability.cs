...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    public class Reachability
    {
        ...
        public OCPPWebSocketClient?  OCPPWebSocketClient    { get; }

        public OCPPWebSocketServer?  OCPPWebSocketServer    { get; }
        ...
        public Reachability(NetworkingNode_Id    NetworkingNodeId,
                            OCPPWebSocketClient  OCPPWebSocketClient,
                            Byte?                Priority    = 0,
        ...
        public Reachability(NetworkingNode_Id    NetworkingNodeId,
                            OCPPWebSocketServer  OCPPWebSocketServer,
                            Byte?                Priority    = 0,
                            DateTime?            Timestamp   = null,
                            DateTime?            Timeout     = null)
        {

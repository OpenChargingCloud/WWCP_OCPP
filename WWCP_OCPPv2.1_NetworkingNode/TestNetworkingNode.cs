...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
    ...
    /// </summary>
    public class TestNetworkingNode : INetworkingNodeService,
                                      IEventSender
    {
        ...
        private          readonly  HashSet<INetworkingNodeChannel>                                                     centralSystemServers        = new();

        private          readonly  ConcurrentDictionary<ChargingStation_Id, Tuple<INetworkingNodeChannel, DateTime>>   reachableChargingStations   = new();
        ...
        public NetworkingNodeUploadAPI  HTTPUploadAPI             { get; }
        ...
        /// <summary>
        /// An enumeration of networking node servers.
        /// </summary>
        public IEnumerable<INetworkingNodeServer> NetworkingNodeServers
            => centralSystemServers;


        public IEnumerable<INetworkingNodeChannel> NetworkingNodeChannels
            => centralSystemServers;
        ...
        #region NetworkingNode Response Messages
...

        {
            ...
            this.HTTPUploadAPI           = new NetworkingNodeUploadAPI(
                                               this,
                                               new HTTPServer(
                                                   this.HTTPUploadPort,
            ...
            //                                   TestAPI
            //                               );
            //this.WebAPI.AttachNetworkingNode(this);
            ...
            var implementingTypes  = Assembly.GetAssembly(interfaceType)?.
                                              ...
                                              Where(t => interfaceType.IsAssignableFrom(t) &&
                                                         !t.IsInterface &&
                                                          ...
                                                          t.FullName.StartsWith("cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.")).
                                              ToArray() ?? [];
        ...
        /// <summary>
        /// Create a new networking node for testing using HTTP/WebSocket.
        /// </summary>
        ...
        public NetworkingNodeWSServer CreateWebSocketService(String       HTTPServerName               = NetworkingNodeWSServer.DefaultHTTPServiceName,
                                                   ...
                                                   Boolean      AutoStart                    = false)
        {
            ...
            var centralSystemServer = new NetworkingNodeWSServer(
                                          HTTPServerName,
                                          IPAddress,
                                          TCPPort,
            ...
            AttachNetworkingNodeChannel(centralSystemServer);
        ...
        #region (private) AttachNetworkingNodeChannel(NetworkingNodeChannel)

        private void AttachNetworkingNodeChannel(INetworkingNodeChannel NetworkingNodeChannel)
        {
            ...
            if (NetworkingNodeChannel is NetworkingNodeWSServer centralSystemWSServer)
            {
                                                                      ...
                                                                      CancellationToken) =>
                {
                    ...
                    if (Connection.TryGetCustomDataAs(NetworkingNodeWSServer.chargingStationId_WebSocketKey, out ChargingStation_Id chargingStationId))
                    {
                        if (!reachableChargingStations.ContainsKey(chargingStationId))
                            reachableChargingStations.TryAdd(chargingStationId, new Tuple<INetworkingNodeChannel, DateTime>(NetworkingNode, Timestamp.Now));
                        else
                            reachableChargingStations[chargingStationId] = new Tuple<INetworkingNodeChannel, DateTime>(NetworkingNode, Timestamp.Now);
                    }
            ...
            NetworkingNodeChannel.OnNewWebSocketConnection += async (timestamp,
                                                           webSocketServer,
                                                           newWebSocketConnection,
                                                           eventTrackingId,
                                                           cancellationToken) => {
            ...
            NetworkingNodeChannel.OnCloseMessageReceived += async (timestamp,
                                                         server,
                                                         connection,
                                                         eventTrackingId,
                                                         statusCode,
            ...
            NetworkingNodeChannel.OnTCPConnectionClosed += async (timestamp,
                                                        server,
                                                        connection,
                                                        reason,
                                                        eventTrackingId) => {
            ...
            NetworkingNodeChannel.OnBootNotification += async (timestamp,
                ...
                if (!reachableChargingStations.ContainsKey(request.ChargingStationId))
                {
                    ...
                    if (sender is NetworkingNodeWSServer centralSystemWSServer)
                        reachableChargingStations.TryAdd(request.ChargingStationId, new Tuple<INetworkingNodeChannel, DateTime>(centralSystemWSServer, Timestamp.Now));
                ...
                else
                {
                    ...
                    if (sender is NetworkingNodeWSServer centralSystemWSServer)
                        reachableChargingStations[request.ChargingStationId] = new Tuple<INetworkingNodeChannel, DateTime>(centralSystemWSServer, Timestamp.Now);
            ...
            NetworkingNodeChannel.OnAuthorize += async (timestamp,
                ...
                if (!reachableChargingStations.ContainsKey(request.ChargingStationId))
                {
                    ...
                    //if (Sender is NetworkingNodeSOAPServer centralSystemSOAPServer)
                                             ...
                                             String        Password)
        {
            ...
            {
                if (centralSystemServer is NetworkingNodeWSServer centralSystemWSServer)
                {

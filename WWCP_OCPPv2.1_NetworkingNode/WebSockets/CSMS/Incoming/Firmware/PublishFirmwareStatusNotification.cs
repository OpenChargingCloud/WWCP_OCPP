...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CSMS
{
                                                  ...
                                                  INetworkingNodeChannel
    {
        ...
        /// </summary>
        public event CSMS.WebSocketJSONRequestLogHandler?                        OnPublishFirmwareStatusNotificationWSRequest;
        ...
        /// An event sent whenever a PublishFirmwareStatusNotification request was received.
        /// </summary>
        public event CSMS.OnPublishFirmwareStatusNotificationDelegate?           OnPublishFirmwareStatusNotification;
        ...
        /// </summary>
        public event CSMS.WebSocketJSONRequestJSONResponseLogHandler?            OnPublishFirmwareStatusNotificationWSResponse;
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnPublishFirmwareStatusNotificationWSRequest));
            }
            ...
            try
            {
                ...
                if (PublishFirmwareStatusNotificationRequest.TryParse(JSONRequest,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnPublishFirmwareStatusNotificationRequest));
                    }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnPublishFirmwareStatusNotificationWSResponse));
            }

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
                                                  ...
                                                  INetworkingNodeChannel
    {
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnNotifyDisplayMessagesWSRequest));
            }
            ...
            try
            {
                ...
                if (NotifyDisplayMessagesRequest.TryParse(JSONRequest,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnNotifyDisplayMessagesRequest));
                    }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnNotifyDisplayMessagesWSResponse));
            }

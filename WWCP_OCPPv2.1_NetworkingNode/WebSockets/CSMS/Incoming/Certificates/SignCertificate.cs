...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CSMS
{
                                                            ...
                                                            INetworkingNodeChannel
    {
        ...
        /// </summary>
        public event CSMS.WebSocketJSONRequestLogHandler?               OnSignCertificateWSRequest;
        ...
        /// An event sent whenever a SignCertificate request was received.
        /// </summary>
        public event CSMS.OnSignCertificateDelegate?                    OnSignCertificate;
        ...
        /// </summary>
        public event CSMS.WebSocketJSONRequestJSONResponseLogHandler?   OnSignCertificateWSResponse;
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnSignCertificateWSRequest));
            }
            ...
            try
            {
                ...
                if (SignCertificateRequest.TryParse(JSONRequest,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnSignCertificateRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnSignCertificateResponse));
                    }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnSignCertificateWSResponse));
            }

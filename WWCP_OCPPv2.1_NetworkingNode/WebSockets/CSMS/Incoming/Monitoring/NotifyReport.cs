...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CSMS
{
                                                  ...
                                                  INetworkingNodeChannel
    {
        ...
        /// </summary>
        public event CSMS.WebSocketJSONRequestLogHandler?               OnNotifyReportWSRequest;
        ...
        /// </summary>
        public event CSMS.OnNotifyReportDelegate?                       OnNotifyReport;
        ...
        /// </summary>
        public event CSMS.WebSocketJSONRequestJSONResponseLogHandler?   OnNotifyReportWSResponse;
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnNotifyReportWSRequest));
            }
            ...
            try
            {
                ...
                if (NotifyReportRequest.TryParse(JSONRequest,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnNotifyReportRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnNotifyReportResponse));
                    }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnNotifyReportWSResponse));
            }

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode
{
                                                  ...
                                                  INetworkingNodeChannel
    {
        ...
        /// </summary>
        public event CSMS.WebSocketJSONRequestLogHandler?               OnNotifyMonitoringReportWSRequest;
        ...
        /// </summary>
        public event CSMS.OnNotifyMonitoringReportDelegate?             OnNotifyMonitoringReport;
        ...
        /// </summary>
        public event CSMS.WebSocketJSONRequestJSONResponseLogHandler?   OnNotifyMonitoringReportWSResponse;
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnNotifyMonitoringReportWSRequest));
            }
            ...
            try
            {
                ...
                if (NotifyMonitoringReportRequest.TryParse(JSONRequest,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnNotifyMonitoringReportRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnNotifyMonitoringReportResponse));
                    }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSServer) + "." + nameof(OnNotifyMonitoringReportWSResponse));
            }

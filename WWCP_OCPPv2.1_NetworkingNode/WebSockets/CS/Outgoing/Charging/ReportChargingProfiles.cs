...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                   ...
                                                   INetworkingNodeClientEvents
    {
        ...
        /// </summary>
        public event CS.OnReportChargingProfilesRequestDelegate?     OnReportChargingProfilesRequest;
        ...
        /// An event fired whenever a response to a ReportChargingProfiles request was received.
        /// </summary>
        public event CS.OnReportChargingProfilesResponseDelegate?    OnReportChargingProfilesResponse;
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnReportChargingProfilesResponse));
            }

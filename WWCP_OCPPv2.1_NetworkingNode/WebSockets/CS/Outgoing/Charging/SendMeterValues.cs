...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                   ...
                                                   INetworkingNodeClientEvents
    {
        ...
        /// </summary>
        public event CS.OnMeterValuesRequestDelegate?     OnMeterValuesRequest;
        ...
        /// An event fired whenever a response to a meter values request was received.
        /// </summary>
        public event CS.OnMeterValuesResponseDelegate?    OnMeterValuesResponse;
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnMeterValuesRequest));
            }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnMeterValuesResponse));
            }

...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                   ...
                                                   INetworkingNodeClientEvents
    {
        ...
        /// </summary>
        public event CS.OnSecurityEventNotificationRequestDelegate?     OnSecurityEventNotificationRequest;
        ...
        /// An event fired whenever a response to a security event notification request was received.
        /// </summary>
        public event CS.OnSecurityEventNotificationResponseDelegate?    OnSecurityEventNotificationResponse;

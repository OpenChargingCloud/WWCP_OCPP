...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                  ...
                                                  INetworkingNodeOutgoingMessagesEvents
    {
        ...
        /// </summary>
        public event WebSocketJSONRequestLogHandler?                                OnNotifyAllowedEnergyTransferWSRequest;
        ...
        /// </summary>
        public event WebSocketJSONRequestJSONResponseLogHandler?                    OnNotifyAllowedEnergyTransferWSResponse;
...

        {
            ...
            try
            {
                ...
                OnNotifyAllowedEnergyTransferWSRequest?.Invoke(startTime,
                                                               WebSocketConnection,
                                                               DestinationNodeId,
                                                               NetworkPath,
                                                               EventTrackingId,
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnNotifyAllowedEnergyTransferWSRequest));
            }
            ...
            try
            {
                ...
                if (NotifyAllowedEnergyTransferRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnNotifyAllowedEnergyTransferRequest));
                    }
            ...
            try
            {
                ...
                OnNotifyAllowedEnergyTransferWSResponse?.Invoke(endTime,
                                                                WebSocketConnection,
                                                                DestinationNodeId,
                                                                NetworkPath,
                                                                EventTrackingId,
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnNotifyAllowedEnergyTransferWSResponse));
            }

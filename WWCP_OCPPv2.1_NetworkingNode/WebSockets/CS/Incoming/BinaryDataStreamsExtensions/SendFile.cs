...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                  ...
                                                  INetworkingNodeOutgoingMessagesEvents
    {
        ...
        /// </summary>
        public event WwebSocketBinaryRequestLogHandler?                OnSendFileWSRequest;
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnSendFileWSRequest));
            }
            ...
            try
            {
                ...
                if (SendFileRequest.TryParse(RequestBinary,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnSendFileRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnSendFileResponse));
                    }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnSendFileWSResponse));
            }

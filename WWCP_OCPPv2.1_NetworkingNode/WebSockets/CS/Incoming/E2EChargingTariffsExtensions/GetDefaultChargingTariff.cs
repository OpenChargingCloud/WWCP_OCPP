...
namespace cloud.charging.open.protocols.OCPPv2_1.NetworkingNode.CS
{
                                                   ...
                                                   INetworkingNodeClientEvents
    {
...

        {
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnGetDefaultChargingTariffWSRequest));
            }
            ...
            try
            {
                ...
                if (GetDefaultChargingTariffRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnGetDefaultChargingTariffRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnGetDefaultChargingTariffResponse));
                    }
            ...
            {
                DebugX.Log(e, nameof(NetworkingNodeWSClient) + "." + nameof(OnGetDefaultChargingTariffWSResponse));
            }

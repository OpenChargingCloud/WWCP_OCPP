...
//                //response  = parentNetworkingNode.CSClient is not null

//                //                ? await parentNetworkingNode.CSClient.DataTransfer(Request)
...
//                                ? await parentNetworkingNode.CSClient.NotifyNetworkTopology(Request)
...
//                                ? await parentNetworkingNode.CSClient.FirmwareStatusNotification(Request)
...
//                                ? await parentNetworkingNode.CSClient.PublishFirmwareStatusNotification(Request)
...
//                                ? await parentNetworkingNode.CSClient.Heartbeat(Request)
...
//                                ? await parentNetworkingNode.CSClient.NotifyEvent(Request)
...
//                                ? await parentNetworkingNode.CSClient.SecurityEventNotification(Request)
...
//                                ? await parentNetworkingNode.CSClient.NotifyReport(Request)
...
//                                ? await parentNetworkingNode.CSClient.NotifyMonitoringReport(Request)
...
//                                ? await parentNetworkingNode.CSClient.LogStatusNotification(Request)
...
//                                ? await parentNetworkingNode.CSClient.SignCertificate(Request)
...
//                                ? await parentNetworkingNode.CSClient.Get15118EVCertificate(Request)
...
//                                ? await parentNetworkingNode.CSClient.GetCertificateStatus(Request)
...
//                                ? await parentNetworkingNode.CSClient.GetCRL(Request)
...
//                                ? await parentNetworkingNode.CSClient.ReservationStatusUpdate(Request)
...
//                                ? await parentNetworkingNode.CSClient.Authorize(Request)
...
//                                ? await parentNetworkingNode.CSClient.NotifyEVChargingNeeds(Request)
...
//                                ? await parentNetworkingNode.CSClient.TransactionEvent(Request)
...
//                                ? await parentNetworkingNode.CSClient.StatusNotification(Request)
...
//                                ? await parentNetworkingNode.CSClient.MeterValues(Request)
...
//                                ? await parentNetworkingNode.CSClient.NotifyChargingLimit(Request)
...
//                                ? await parentNetworkingNode.CSClient.ClearedChargingLimit(Request)
...
//                                ? await parentNetworkingNode.CSClient.ReportChargingProfiles(Request)
...
//                                ? await parentNetworkingNode.CSClient.NotifyEVChargingSchedule(Request)
...
//                                ? await parentNetworkingNode.CSClient.NotifyPriorityCharging(Request)
...
//                                ? await parentNetworkingNode.CSClient.PullDynamicScheduleUpdate(Request)
...
//                                ? await parentNetworkingNode.CSClient.NotifyDisplayMessages(Request)
...
//                                ? await parentNetworkingNode.CSClient.NotifyCustomerInformation(Request)
...
//            {
//                //parentNetworkingNode.CSClient.DataTransfer
//            }

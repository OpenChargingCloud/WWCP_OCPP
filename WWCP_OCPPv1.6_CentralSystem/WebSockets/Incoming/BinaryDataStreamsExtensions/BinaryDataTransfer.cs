...

        {
            ...
            try
            {
                ...
                if (OCPP.CS.BinaryDataTransferRequest.TryParse(BinaryRequest,
                    ...
                    {
                        DebugX.Log(e, nameof(CentralSystemWSServer) + "." + nameof(OnIncomingBinaryDataTransferRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(CentralSystemWSServer) + "." + nameof(OnIncomingBinaryDataTransferResponse));
                    }

...
function StartOCPPEventMessages() {
    ...
    var StreamFilterPattern  = document.getElementById('patternFilterInput') as HTMLInputElement;
    ...
    if ((<any> window).EventSource != undefined) {
    ...
    LogEventsSource.addEventListener('OnHTTPRequest',  function (event) {
            ...
            try {
                ...
                CreateLogEntry(data.timestamp,
                               ...
                               "daily",
                               data.eventTrackingId,
                               data.body,
                               data.remoteIPAddress // ConnectionColorKey
                              );

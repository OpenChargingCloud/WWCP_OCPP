...

        {
            ...
            variableConfigs.Add(
                new VariableConfig(
                    ...
                    Description:      I18NString.Create("The charging station/EVSE should show QR-Codes using the TOTP algorithm.")
            ...
            variableConfigs.Add(
                new VariableConfig(
                    ...
                    Description:      I18NString.Create("The charging station/EVSE should broadcast the generated URL of the time-based one-time password (TOTP) algorithm via Bluetooth Low-Energy beacons.")
            ...
            variableConfigs.Add(
                new VariableConfig(
                    ...
                    Description:      I18NString.Create("The charging station/EVSE should provide the generated URL of the time-based one-time password (TOTP) algorithm via NFC.")

...
namespace cloud.charging.open.protocols.OCPPv2_0_1
{
                                 ...
                                 IEquatable<ChargingNeeds>
    {
        ...
        /// <param name="DepartureTime">The optional estimated departure time of the EV.</param>
                                       ...
                                       CustomJObjectParserDelegate<ChargingNeeds>?  CustomChargingNeedsParser)
        {
            ...
            try
            {
                ...
                if (JSON.ParseOptionalJSON("acChargingParameters",
                                           ...
                                           OCPPv2_0_1.ACChargingParameters.TryParse,
                ...
                if (JSON.ParseOptionalJSON("dcChargingParameters",
                                           ...
                                           OCPPv2_0_1.DCChargingParameters.TryParse,
        ...
        public override Int32 GetHashCode()
        {
            unchecked
            {
                ...
                return RequestedEnergyTransferMode.GetHashCode()       * 11 ^

...
namespace cloud.charging.open.protocols.OCPPv2_0_1.CSMS
{
    ...
    public class SetNetworkProfileRequest : ARequest<SetNetworkProfileRequest>
    {
        ...
        /// <param name="ChargeBoxId">The charge box identification.</param>
        /// <param name="CustomSetNetworkProfileRequestParser">An optional delegate to parse custom set network profile requests.</param>
                                       ...
                                       CustomJObjectParserDelegate<SetNetworkProfileRequest>?  CustomSetNetworkProfileRequestParser)
        {
            ...
            try
            {
                ...
                if (!JSON.ParseMandatoryJSON("connectionData",
                                             "connection data",
                                             OCPPv2_0_1.NetworkConnectionProfile.TryParse,

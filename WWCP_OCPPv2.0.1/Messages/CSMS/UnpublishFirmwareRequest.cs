...
namespace cloud.charging.open.protocols.OCPPv2_0_1.CSMS
{
    ...
    public class UnpublishFirmwareRequest : ARequest<UnpublishFirmwareRequest>
    {
        ...
        /// <param name="ChargeBoxId">The charge box identification.</param>
        /// <param name="CustomUnpublishFirmwareRequestParser">An optional delegate to parse custom unpublish firmware requests.</param>
                                       ...
                                       CustomJObjectParserDelegate<UnpublishFirmwareRequest>?  CustomUnpublishFirmwareRequestParser)
        {
            ...
            try
            {
                ...
                UnpublishFirmwareRequest = new UnpublishFirmwareRequest(ChargeBoxId,
                                                                        MD5Checksum,
                                                                        CustomData,
                                                                        RequestId);

...
namespace cloud.charging.open.protocols.OCPPv2_0_1.CSMS
{
    ...
    public class CustomerInformationRequest : ARequest<CustomerInformationRequest>
    {
        ...
        /// <param name="ChargeBoxId">The charge box identification.</param>
        /// <param name="CustomCustomerInformationRequestParser">An optional delegate to parse custom customer information requests.</param>
                                       ...
                                       CustomJObjectParserDelegate<CustomerInformationRequest>?  CustomCustomerInformationRequestParser)
        {
            ...
            try
            {
                ...
                if (JSON.ParseOptional("customerIdentifier",
                                       "customer identifier",
                                       OCPPv2_0_1.CustomerIdentifier.TryParse,

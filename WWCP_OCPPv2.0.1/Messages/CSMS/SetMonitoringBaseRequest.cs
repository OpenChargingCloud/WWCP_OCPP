...
namespace cloud.charging.open.protocols.OCPPv2_0_1.CSMS
{
    ...
    public class SetMonitoringBaseRequest : ARequest<SetMonitoringBaseRequest>
    {
        ...
        /// <param name="ChargeBoxId">The charge box identification.</param>
        /// <param name="CustomSetMonitoringBaseRequestParser">An optional delegate to parse custom set monitoring base requests.</param>
        ...
        #region ToJSON(CustomSetMonitoringBaseRequestSerializer = null, CustomCustomDataSerializer = null)

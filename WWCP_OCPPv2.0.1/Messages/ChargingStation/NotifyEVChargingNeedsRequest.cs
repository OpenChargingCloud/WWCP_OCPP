...
namespace cloud.charging.open.protocols.OCPPv2_0_1.CS
{
    ...
    public class NotifyEVChargingNeedsRequest : ARequest<NotifyEVChargingNeedsRequest>
    {
        ...
        /// <param name="ChargeBoxId">The charge box identification.</param>
        /// <param name="CustomNotifyEVChargingNeedsRequestParser">An optional delegate to parse custom notify EV charging needs requests.</param>
                                       ...
                                       CustomJObjectParserDelegate<NotifyEVChargingNeedsRequest>?  CustomNotifyEVChargingNeedsRequestParser)
        {
            ...
            try
            {
                ...
                if (!JSON.ParseMandatoryJSON("chargingNeeds",
                                             "charging needs",
                                             OCPPv2_0_1.ChargingNeeds.TryParse,

...
namespace cloud.charging.open.protocols.OCPPv2_0_1.CS
{
    ...
    public class NotifyMonitoringReportRequest : ARequest<NotifyMonitoringReportRequest>
    {
        ...
        /// <param name="ChargeBoxId">The charge box identification.</param>
        /// <param name="CustomNotifyMonitoringReportRequestParser">An optional delegate to parse custom notify monitoring report requests.</param>
                                       ...
                                       CustomJObjectParserDelegate<NotifyMonitoringReportRequest>?  CustomNotifyMonitoringReportRequestParser)
        {
            ...
            try
            {
                ...
                if (!JSON.ParseMandatoryHashSet("monitor",
                                                "monitoring data",
                                                OCPPv2_0_1.MonitoringData.TryParse,

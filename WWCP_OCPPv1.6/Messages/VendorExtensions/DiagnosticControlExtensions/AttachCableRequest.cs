...
namespace cloud.charging.open.protocols.OCPPv1_6.CP
{
                                      ...
                                      IRequest
    {
        ...
        /// <summary>
        /// The connector identification, when the charging station has more than one connector
        ...
        public override Boolean Equals(AttachCableRequest? AttachCableRequest)
            ...
            => AttachCableRequest is not null &&
               ...
               ConnectorId.  Equals(AttachCableRequest.ConnectorId)   &&
        ...
        public override String ToString()
            ...
            => $"Connector '{ConnectorId}': {ResistorValue} Ω";

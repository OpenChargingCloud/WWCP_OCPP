...
namespace cloud.charging.open.protocols.OCPPv1_6.CS
{
                                        ...
                                        IRequest
    {
        ...
        /// <summary>
        /// The identification tag of the RFID card to be swiped.
        /// </summary>
        [Mandatory]
        ...
        /// </summary>
        [Optional]
        public Connector_Id?         ReaderId           { get; }

        /// <summary>
        /// The optional simulation mode: Software | Hardware | ...
        /// </summary>
        [Optional]
        public IdTagSimulationMode?  SimulationMode     { get; }
...

        {
            ...
            unchecked
            {
                ...
                hashCode = this.IdTag.           GetHashCode()       * 11 ^
                                       ...
                                       CustomJObjectParserDelegate<CustomData>?            CustomCustomDataParser             = null)
        {
            ...
            try
            {
                ...
                if (JSON.ParseOptional("simulationMode",
                                       "simulation mode",
                                       IdTagSimulationMode.TryParse,
                                       out IdTagSimulationMode? simulationMode,
                                       out ErrorResponse))
                {
                    if (ErrorResponse is not null)
                        return false;
        ...
        #region ToJSON(CustomSwipeRFIDCardRequestSerializer = null, CustomSignatureSerializer = null, ...)
        ...
        public override Boolean Equals(SwipeRFIDCardRequest? SwipeRFIDCardRequest)
            ...
            => SwipeRFIDCardRequest is not null &&
               ...
               IdTag.Equals(SwipeRFIDCardRequest.IdTag) &&

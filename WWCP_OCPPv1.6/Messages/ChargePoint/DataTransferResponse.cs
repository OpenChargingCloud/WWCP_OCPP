                                                     ...
                                                     DataTransferResponse>
    {
                                       ...
                                       OnExceptionDelegate       OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, DataTransferResponseXML, e);
                                       ...
                                       OnExceptionDelegate       OnException  = null)
        {
            ...
            try
            {
                ...
                var Data = DataTransferResponseJSON.GetString("data")?.Trim();
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, DataTransferResponseJSON, e);
                                       ...
                                       OnExceptionDelegate       OnException  = null)
        {
            ...
            {
                OnException?.Invoke(org.GraphDefined.Vanaheimr.Illias.Timestamp.Now, DataTransferResponseText, e);
            }
        ...
        public override Boolean Equals(Object Object)
        {
            ...
            if (!(Object is DataTransferResponse DataTransferResponse))
                return false;

            return Equals(DataTransferResponse);
        ...
        public override Boolean Equals(DataTransferResponse DataTransferResponse)
        {
            ...
            if (DataTransferResponse is null)
                return false;

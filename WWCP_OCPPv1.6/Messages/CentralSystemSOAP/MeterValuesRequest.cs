...
namespace org.GraphDefined.WWCP.OCPPv1_6
{
    ...
    public class MeterValuesRequest
    {
        ...
        /// </summary>
        /// <param name="MeterValuesRequestXML">The XML to parse.</param>
        ...
        /// </summary>
        /// <param name="MeterValuesRequestText">The text to parse.</param>
        /// <param name="OnException">An optional delegate called whenever an exception occured.</param>
                                       ...
                                       OnExceptionDelegate     OnException  = null)
        {
            ...
            try
            {
                ...
                if (TryParse(XDocument.Parse(MeterValuesRequestText).Root.Element(SOAPNS.SOAPEnvelope_v1_2 + "Body"),
        ...
        public static Boolean operator == (MeterValuesRequest MeterValuesRequest1, MeterValuesRequest MeterValuesRequest2)
        {
            ...
            if (Object.ReferenceEquals(MeterValuesRequest1, MeterValuesRequest2))
                return true;

    ...
    public class StartTransactionResponse : AResponse<StartTransactionResponse>
    {
                                       ...
                                       OnExceptionDelegate           OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(DateTime.Now, StartTransactionResponseXML, e);
                                       ...
                                       OnExceptionDelegate           OnException  = null)
        {
            ...
            {
                OnException?.Invoke(DateTime.Now, StartTransactionResponseText, e);
            }
        ...
        public static Boolean operator == (StartTransactionResponse StartTransactionResponse1, StartTransactionResponse StartTransactionResponse2)
        {
            ...
            if (Object.ReferenceEquals(StartTransactionResponse1, StartTransactionResponse2))
                return true;

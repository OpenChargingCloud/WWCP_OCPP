...
namespace org.GraphDefined.WWCP.OCPPv1_6.CP
{
    ...
    public class RemoteStartTransactionResponse : AResponse<RemoteStartTransactionResponse>
    {
        ...
        /// </summary>
        /// <param name="RemoteStartTransactionResponseXML">The XML to parse.</param>
        ...
        /// </summary>
        /// <param name="RemoteStartTransactionResponseText">The text to parse.</param>
        /// <param name="OnException">An optional delegate called whenever an exception occured.</param>
                                       ...
                                       OnExceptionDelegate                 OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(DateTime.Now, RemoteStartTransactionResponseXML, e);
                                       ...
                                       OnExceptionDelegate                 OnException  = null)
        {
            ...
            {
                OnException?.Invoke(DateTime.Now, RemoteStartTransactionResponseText, e);
            }
        ...
        public static Boolean operator == (RemoteStartTransactionResponse RemoteStartTransactionResponse1, RemoteStartTransactionResponse RemoteStartTransactionResponse2)
        {
            ...
            if (Object.ReferenceEquals(RemoteStartTransactionResponse1, RemoteStartTransactionResponse2))
                return true;

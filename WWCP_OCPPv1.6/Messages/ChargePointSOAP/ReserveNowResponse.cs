    ...
    public class ReserveNowResponse : AResponse<ReserveNowResponse>
    {
                                       ...
                                       OnExceptionDelegate     OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(DateTime.Now, ReserveNowResponseXML, e);
                                       ...
                                       OnExceptionDelegate     OnException  = null)
        {
            ...
            {
                OnException?.Invoke(DateTime.Now, ReserveNowResponseText, e);
            }
        ...
        public static Boolean operator == (ReserveNowResponse ReserveNowResponse1, ReserveNowResponse ReserveNowResponse2)
        {
            ...
            if (Object.ReferenceEquals(ReserveNowResponse1, ReserveNowResponse2))
                return true;

...
namespace org.GraphDefined.WWCP.OCPPv1_6.CP
{
    ...
    public class UnlockConnectorResponse : AResponse
    {
        ...
        /// </summary>
        /// <param name="UnlockConnectorResponseXML">The XML to parse.</param>
        ...
        /// </summary>
        /// <param name="UnlockConnectorResponseText">The text to parse.</param>
        /// <param name="OnException">An optional delegate called whenever an exception occured.</param>
                                       ...
                                       OnExceptionDelegate          OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(DateTime.Now, UnlockConnectorResponseXML, e);
                                       ...
                                       OnExceptionDelegate          OnException  = null)
        {
            ...
            {
                OnException?.Invoke(DateTime.Now, UnlockConnectorResponseText, e);
            }
        ...
        public static Boolean operator == (UnlockConnectorResponse UnlockConnectorResponse1, UnlockConnectorResponse UnlockConnectorResponse2)
        {
            ...
            if (Object.ReferenceEquals(UnlockConnectorResponse1, UnlockConnectorResponse2))
                return true;

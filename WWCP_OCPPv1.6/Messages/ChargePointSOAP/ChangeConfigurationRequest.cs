    ...
    public class ChangeConfigurationRequest
    {
                                       ...
                                       OnExceptionDelegate             OnException  = null)
        {
            ...
            try
            {
                ...
                if (TryParse(XDocument.Parse(ChangeConfigurationRequestText).Root.Element(SOAPNS.SOAPEnvelope_v1_2 + "Body"),
        ...
        public static Boolean operator == (ChangeConfigurationRequest ChangeConfigurationRequest1, ChangeConfigurationRequest ChangeConfigurationRequest2)
        {
            ...
            if (Object.ReferenceEquals(ChangeConfigurationRequest1, ChangeConfigurationRequest2))
                return true;

...
namespace org.GraphDefined.WWCP.OCPPv1_6.CP
{
    ...
    public class ChangeAvailabilityResponse : AResponse<ChangeAvailabilityResponse>
    {
        ...
        /// </summary>
        /// <param name="ChangeAvailabilityResponseXML">The XML to parse.</param>
        ...
        /// </summary>
        /// <param name="ChangeAvailabilityResponseText">The text to parse.</param>
        /// <param name="OnException">An optional delegate called whenever an exception occured.</param>
                                       ...
                                       OnExceptionDelegate             OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(DateTime.Now, ChangeAvailabilityResponseXML, e);
                                       ...
                                       OnExceptionDelegate             OnException  = null)
        {
            ...
            {
                OnException?.Invoke(DateTime.Now, ChangeAvailabilityResponseText, e);
            }
        ...
        public static Boolean operator == (ChangeAvailabilityResponse ChangeAvailabilityResponse1, ChangeAvailabilityResponse ChangeAvailabilityResponse2)
        {
            ...
            if (Object.ReferenceEquals(ChangeAvailabilityResponse1, ChangeAvailabilityResponse2))
                return true;

    ...
    public class SetChargingProfileResponse : AResponse<SetChargingProfileResponse>
    {
                                       ...
                                       OnExceptionDelegate             OnException  = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(DateTime.Now, SetChargingProfileResponseXML, e);
                                       ...
                                       OnExceptionDelegate             OnException  = null)
        {
            ...
            {
                OnException?.Invoke(DateTime.Now, SetChargingProfileResponseText, e);
            }
        ...
        public static Boolean operator == (SetChargingProfileResponse SetChargingProfileResponse1, SetChargingProfileResponse SetChargingProfileResponse2)
        {
            ...
            if (Object.ReferenceEquals(SetChargingProfileResponse1, SetChargingProfileResponse2))
                return true;

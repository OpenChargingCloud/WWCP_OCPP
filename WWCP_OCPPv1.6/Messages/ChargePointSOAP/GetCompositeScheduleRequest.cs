    ...
    public class GetCompositeScheduleRequest
    {
                                       ...
                                       OnExceptionDelegate              OnException  = null)
        {
            ...
            try
            {
                ...
                if (TryParse(XDocument.Parse(GetCompositeScheduleRequestText).Root.Element(SOAPNS.SOAPEnvelope_v1_2 + "Body"),
        ...
        /// <returns>True if both match; False otherwise.</returns>
        public Boolean Equals(GetCompositeScheduleRequest GetCompositeScheduleRequest)
        {

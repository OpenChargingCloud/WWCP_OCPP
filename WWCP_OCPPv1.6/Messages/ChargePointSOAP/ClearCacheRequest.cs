    ...
    public class ClearCacheRequest : ARequest<ClearCacheRequest>
    {
                                       ...
                                       OnExceptionDelegate    OnException  = null)
        {
            ...
            try
            {
                ...
                if (TryParse(XDocument.Parse(ClearCacheRequestText).Root.Element(SOAPNS.SOAPEnvelope_v1_2 + "Body"),
        ...
        public static Boolean operator == (ClearCacheRequest ClearCacheRequest1, ClearCacheRequest ClearCacheRequest2)
        {
            ...
            if (Object.ReferenceEquals(ClearCacheRequest1, ClearCacheRequest2))
                return true;

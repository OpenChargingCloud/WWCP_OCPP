    ...
    public class GetConfigurationRequest
    {
                                       ...
                                       OnExceptionDelegate          OnException  = null)
        {
            ...
            try
            {
                ...
                if (TryParse(XDocument.Parse(GetConfigurationRequestText).Root.Element(SOAPNS.SOAPEnvelope_v1_2 + "Body"),
            ...
            {
                OnException?.Invoke(DateTime.Now, GetConfigurationRequestText, e);
            }
        ...
        public static Boolean operator == (GetConfigurationRequest GetConfigurationRequest1, GetConfigurationRequest GetConfigurationRequest2)
        {
            ...
            if (Object.ReferenceEquals(GetConfigurationRequest1, GetConfigurationRequest2))
                return true;

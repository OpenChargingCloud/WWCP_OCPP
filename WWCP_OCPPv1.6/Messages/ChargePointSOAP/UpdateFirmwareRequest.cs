...
namespace org.GraphDefined.WWCP.OCPPv1_6.CS
{
    ...
    public class UpdateFirmwareRequest : ARequest<UpdateFirmwareRequest>
    {
        ...
        /// </summary>
        /// <param name="UpdateFirmwareRequestXML">The XML to parse.</param>
        ...
        /// </summary>
        /// <param name="UpdateFirmwareRequestText">The text to parse.</param>
        /// <param name="OnException">An optional delegate called whenever an exception occured.</param>
                                       ...
                                       OnExceptionDelegate        OnException  = null)
        {
            ...
            try
            {
                ...
                if (TryParse(XDocument.Parse(UpdateFirmwareRequestText).Root.Element(SOAPNS.SOAPEnvelope_v1_2 + "Body"),
        ...
        public static Boolean operator == (UpdateFirmwareRequest UpdateFirmwareRequest1, UpdateFirmwareRequest UpdateFirmwareRequest2)
        {
            ...
            if (Object.ReferenceEquals(UpdateFirmwareRequest1, UpdateFirmwareRequest2))
                return true;

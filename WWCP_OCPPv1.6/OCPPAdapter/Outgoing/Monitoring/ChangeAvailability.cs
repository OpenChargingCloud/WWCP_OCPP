...
namespace cloud.charging.open.protocols.OCPPv1_6.NetworkingNode
{
    ...
    /// <summary>
    /// A delegate called whenever a ChangeAvailability request was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a ChangeAvailability request error was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a ChangeAvailability response error was sent.
    /// </summary>
    /// <param name="Timestamp">The logging timestamp.</param>
    ...
    public partial class OCPPWebSocketAdapterOUT
    {
        ...
        #region Send ChangeAvailability request

        /// <summary>
        /// An event fired whenever a ChangeAvailability request was sent.
        /// </summary>
...

        {
            ...
            try
            {
                ...
                switch (Request.SerializationFormat)
                {
                    ...
                    case SerializationFormats.JSON: {
                            ...
                            else
                            {
                                ...
                                if (sendRequestState.IsValidJSONResponse(Request, out var jsonResponse))
                                    response = await parentNetworkingNode.OCPP.IN.Receive_ChangeAvailabilityResponse(
                                                         Request,
                                                         jsonResponse,
                                ...
                                if (sendRequestState.IsValidJSONRequestError(Request, out var jsonRequestError))
                                    response = await parentNetworkingNode.OCPP.IN.Receive_ChangeAvailabilityRequestError(
                                                         Request,
                                                         jsonRequestError,
                                                         sendRequestState.WebSocketConnectionReceived,
                                                         sendRequestState.DestinationReceived,
                    ...
                    case SerializationFormats.JSON_UTF8_Binary: {
                        ...
                        //                         Timestamp.Now,
                        //                         ChangeAvailabilityResponse.DefaultInterval,
                        //                         Result: Result.FromSendRequestState(sendRequestState)
                        //                     );
                    ...
                    case SerializationFormats.BinaryCompact: {
                            ...
                            //        Request,
                            //        Request.ToBinary(
                            //            //parentNetworkingNode.OCPP.CustomBinaryChangeAvailabilityRequestSerializer,
            ...
            catch (Exception e)
            {
                ...
                response = ChangeAvailabilityResponse.ExceptionOccurred(
                               Request,
                               e
                           );
        ...
        #region Send OnChangeAvailabilityResponseSent event

        /// <summary>
        /// An event sent whenever a ChangeAvailability response was sent.
        /// </summary>
        ...
        public Task SendOnChangeAvailabilityResponseSent(DateTimeOffset             Timestamp,
            ...
            => LogEvent(
                   OnChangeAvailabilityResponseSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,
        ...
        #region Send OnChangeAvailabilityRequestErrorSent event

        /// <summary>
        /// An event sent whenever a ChangeAvailability request error was sent.
        /// </summary>
        ...
        public Task SendOnChangeAvailabilityRequestErrorSent(DateTimeOffset                Timestamp,
            ...
            => LogEvent(
                   OnChangeAvailabilityRequestErrorSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,
        ...
        #region Send OnChangeAvailabilityResponseErrorSent event

        /// <summary>
        /// An event sent whenever a ChangeAvailability response error was sent.
        /// </summary>
        ...
        public Task SendOnChangeAvailabilityResponseErrorSent(DateTimeOffset                 Timestamp,
            ...
            => LogEvent(
                   OnChangeAvailabilityResponseErrorSent,
                   loggingDelegate => loggingDelegate.Invoke(
                       Timestamp,
                       Sender,
                       Connection,

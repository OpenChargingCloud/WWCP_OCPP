...
namespace cloud.charging.open.protocols.OCPPv1_6.NetworkingNode
{
    ...
    /// <summary>
    /// A delegate called whenever a UnlockConnector request was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a UnlockConnector request error was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a UnlockConnector response error was sent.
    /// </summary>
    /// <param name="Timestamp">The logging timestamp.</param>
    ...
    public partial class OCPPWebSocketAdapterOUT
    {
        ...
        /// <summary>
        /// An event fired whenever a UnlockConnector request was sent.
        /// </summary>
        public event OnUnlockConnectorRequestSentDelegate?  OnUnlockConnectorRequestSent;


        /// <summary>
        /// Send a UnlockConnector request.
        /// </summary>
            ...
            try
            {
                ...
                switch (Request.SerializationFormat)
                {
                    ...
                    case SerializationFormats.JSON_UTF8_Binary: {
                        ...
                        //                         Timestamp.Now,
                        //                         UnlockConnectorResponse.DefaultInterval,
                        //                         Result: Result.FromSendRequestState(sendRequestState)
                        //                     );
                    ...
                    case SerializationFormats.BinaryCompact: {
                            ...
                            //        Request,
                            //        Request.ToBinary(
                            //            //parentNetworkingNode.OCPP.CustomBinaryUnlockConnectorRequestSerializer,
        ...
        /// <summary>
        /// An event sent whenever a UnlockConnector response was sent.
        /// </summary>
        ...
        /// <summary>
        /// An event sent whenever a UnlockConnector request error was sent.
        /// </summary>
        ...
        /// <summary>
        /// An event sent whenever a UnlockConnector response error was sent.
        /// </summary>

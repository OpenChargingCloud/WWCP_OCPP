...
namespace cloud.charging.open.protocols.OCPPv1_6.NetworkingNode
{
    ...
    /// <summary>
    /// A delegate called whenever a Authorize request was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a Authorize request error was sent.
    /// </summary>
    ...
    /// <summary>
    /// A logging delegate called whenever a Authorize response error was sent.
    /// </summary>
    /// <param name="Timestamp">The logging timestamp.</param>
    ...
    public partial class OCPPWebSocketAdapterOUT
    {
        ...
        /// <summary>
        /// An event fired whenever a Authorize request was sent.
        /// </summary>
        ...
        /// </summary>
        /// <param name="Request">A Authorize request.</param>
            ...
            try
            {
                ...
                switch (Request.SerializationFormat)
                {
                    ...
                    case SerializationFormats.JSON_UTF8_Binary: {
                        ...
                        //                         Timestamp.Now,
                        //                         AuthorizeResponse.DefaultInterval,
                        //                         Result: Result.FromSendRequestState(sendRequestState)
                        //                     );
                    ...
                    case SerializationFormats.BinaryCompact: {
                            ...
                            //        Request,
                            //        Request.ToBinary(
                            //            //parentNetworkingNode.OCPP.CustomBinaryAuthorizeRequestSerializer,
        ...
        /// <summary>
        /// An event sent whenever a Authorize response was sent.
        /// </summary>
        ...
        /// <summary>
        /// An event sent whenever a Authorize request error was sent.
        /// </summary>
        ...
        /// <summary>
        /// An event sent whenever a Authorize response error was sent.
        /// </summary>

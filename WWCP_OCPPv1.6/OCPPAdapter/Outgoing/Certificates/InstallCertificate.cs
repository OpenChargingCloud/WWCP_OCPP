...
namespace cloud.charging.open.protocols.OCPPv1_6.NetworkingNode
{
    ...
    /// <summary>
    /// A delegate called whenever a InstallCertificate request was sent.
    /// </summary>
    ...
    public delegate Task OnInstallCertificateRequestSentDelegate(DateTimeOffset              Timestamp,
                                                                 IEventSender                Sender,
    ...
    public delegate Task
        ...
        OnInstallCertificateResponseSentDelegate(DateTimeOffset               Timestamp,
                                                 IEventSender                 Sender,
                                                 IWebSocketConnection?        Connection,
                                                 InstallCertificateRequest    Request,
    ...
    /// <summary>
    /// A logging delegate called whenever a InstallCertificate request error was sent.
    /// </summary>
    ...
    public delegate Task
        ...
        OnInstallCertificateRequestErrorSentDelegate(DateTimeOffset                 Timestamp,
                                                     IEventSender                   Sender,
                                                     IWebSocketConnection?          Connection,
                                                     InstallCertificateRequest?     Request,
    ...
    /// <summary>
    /// A logging delegate called whenever a InstallCertificate response error was sent.
    /// </summary>
    /// <param name="Timestamp">The logging timestamp.</param>
    ...
    public delegate Task
        ...
        OnInstallCertificateResponseErrorSentDelegate(DateTimeOffset                  Timestamp,
                                                      IEventSender                    Sender,
                                                      IWebSocketConnection?           Connection,
                                                      InstallCertificateRequest?      Request,
                                                      InstallCertificateResponse?     Response,
    ...
    public partial class OCPPWebSocketAdapterOUT
    {
        ...
        /// <summary>
        /// An event fired whenever a InstallCertificate request was sent.
        /// </summary>
        public event OnInstallCertificateRequestSentDelegate?  OnInstallCertificateRequestSent;


        /// <summary>
        /// Send a InstallCertificate request.
        /// </summary>
            ...
            try
            {
                ...
                switch (Request.SerializationFormat)
                {
                    ...
                    case SerializationFormats.JSON_UTF8_Binary: {
                        ...
                        //                         Timestamp.Now,
                        //                         InstallCertificateResponse.DefaultInterval,
                        //                         Result: Result.FromSendRequestState(sendRequestState)
                        //                     );
                    ...
                    case SerializationFormats.BinaryCompact: {
                            ...
                            //        Request,
                            //        Request.ToBinary(
                            //            //parentNetworkingNode.OCPP.CustomBinaryInstallCertificateRequestSerializer,
        ...
        /// <summary>
        /// An event sent whenever a InstallCertificate response was sent.
        /// </summary>
        public event OnInstallCertificateResponseSentDelegate?  OnInstallCertificateResponseSent;

        public Task SendOnInstallCertificateResponseSent(DateTimeOffset              Timestamp,
                                                         IEventSender                Sender,
                                                         IWebSocketConnection?       Connection,
                                                         InstallCertificateRequest   Request,
                                                         InstallCertificateResponse  Response,
        ...
        /// <summary>
        /// An event sent whenever a InstallCertificate request error was sent.
        /// </summary>
        public event OnInstallCertificateRequestErrorSentDelegate? OnInstallCertificateRequestErrorSent;


        public Task SendOnInstallCertificateRequestErrorSent(DateTimeOffset                Timestamp,
                                                             IEventSender                  Sender,
                                                             IWebSocketConnection?         Connection,
                                                             InstallCertificateRequest?    Request,
                                                             OCPP_JSONRequestErrorMessage  RequestErrorMessage,
        ...
        /// <summary>
        /// An event sent whenever a InstallCertificate response error was sent.
        /// </summary>
        public event OnInstallCertificateResponseErrorSentDelegate? OnInstallCertificateResponseErrorSent;


        public Task SendOnInstallCertificateResponseErrorSent(DateTimeOffset                 Timestamp,
                                                              IEventSender                   Sender,
                                                              IWebSocketConnection?          Connection,
                                                              InstallCertificateRequest?     Request,
                                                              InstallCertificateResponse?    Response,

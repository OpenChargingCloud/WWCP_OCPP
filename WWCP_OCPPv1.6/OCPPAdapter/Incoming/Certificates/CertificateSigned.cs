...
namespace cloud.charging.open.protocols.OCPPv1_6.NetworkingNode
{
    ...
    public delegate Task OnCertificateSignedRequestReceivedDelegate(DateTimeOffset            Timestamp,
                                                                   IEventSender              Sender,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnCertificateSignedResponseReceivedDelegate(DateTimeOffset             Timestamp,
                                                                    IEventSender               Sender,
                                                                    IWebSocketConnection?      Connection,
                                                                    CertificateSignedRequest?   Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnCertificateSignedRequestErrorReceivedDelegate(DateTimeOffset                 Timestamp,
                                                                        IEventSender                   Sender,
                                                                        IWebSocketConnection           Connection,
                                                                        CertificateSignedRequest?       Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnCertificateSignedResponseErrorReceivedDelegate(DateTimeOffset                  Timestamp,
                                                                         IEventSender                    Sender,
                                                                         IWebSocketConnection            Connection,
                                                                         CertificateSignedRequest?        Request,
                                                                         CertificateSignedResponse?       Response,
    ...
    public delegate Task<CertificateSignedResponse>
        ...
        OnCertificateSignedDelegate(DateTimeOffset            Timestamp,
                                   IEventSender              Sender,
                                   IWebSocketConnection      Connection,
                                   CertificateSignedRequest   Request,
                                   CancellationToken         CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        #region Receive CertificateSigned request (JSON)
        ...
        public async Task<OCPP_Response>
            ...
            Receive_CertificateSigned(DateTimeOffset        RequestTimestamp,
        ...
        #region Receive CertificateSigned request (binary)
...

        {
            ...
            //    if (CertificateSignedRequest.TryParse(BinaryRequest,
            //                                         RequestId,
            //                                         Destination,
            //                                         NetworkPath,
            //                                         out var request,
        ...
        #region Receive CertificateSigned response (JSON)
...

        {
            ...
            catch (Exception e)
            {
                ...
                response = CertificateSignedResponse.ExceptionOccurred(
                               Request,
                               e
                           );
        ...
        #region Receive CertificateSigned response (binary)

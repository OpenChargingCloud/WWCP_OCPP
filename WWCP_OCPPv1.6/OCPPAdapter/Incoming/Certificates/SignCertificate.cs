...
namespace cloud.charging.open.protocols.OCPPv1_6.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        #region Receive SignCertificate request (JSON)
        ...
        #region Receive SignCertificate request (binary)
...

        {
            ...
            //    if (SignCertificateRequest.TryParse(BinaryRequest,
            //                                         RequestId,
            //                                         Destination,
            //                                         NetworkPath,
            //                                         out var request,
        ...
        #region Receive SignCertificate response (JSON)
        ...
        #region Receive SignCertificate response (binary)

...
namespace cloud.charging.open.protocols.OCPPv1_6.NetworkingNode
{
    ...
    public delegate Task OnGetCompositeScheduleRequestReceivedDelegate(DateTimeOffset            Timestamp,
                                                                   IEventSender              Sender,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnGetCompositeScheduleResponseReceivedDelegate(DateTimeOffset             Timestamp,
                                                                    IEventSender               Sender,
                                                                    IWebSocketConnection?      Connection,
                                                                    GetCompositeScheduleRequest?   Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnGetCompositeScheduleRequestErrorReceivedDelegate(DateTimeOffset                 Timestamp,
                                                                        IEventSender                   Sender,
                                                                        IWebSocketConnection           Connection,
                                                                        GetCompositeScheduleRequest?       Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnGetCompositeScheduleResponseErrorReceivedDelegate(DateTimeOffset                  Timestamp,
                                                                         IEventSender                    Sender,
                                                                         IWebSocketConnection            Connection,
                                                                         GetCompositeScheduleRequest?        Request,
                                                                         GetCompositeScheduleResponse?       Response,
    ...
    public delegate Task<GetCompositeScheduleResponse>
        ...
        OnGetCompositeScheduleDelegate(DateTimeOffset            Timestamp,
                                   IEventSender              Sender,
                                   IWebSocketConnection      Connection,
                                   GetCompositeScheduleRequest   Request,
                                   CancellationToken         CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        #region Receive GetCompositeSchedule request (JSON)
        ...
        public async Task<OCPP_Response>
            ...
            Receive_GetCompositeSchedule(DateTimeOffset        RequestTimestamp,
        ...
        #region Receive GetCompositeSchedule request (binary)
...

        {
            ...
            //    if (GetCompositeScheduleRequest.TryParse(BinaryRequest,
            //                                         RequestId,
            //                                         Destination,
            //                                         NetworkPath,
            //                                         out var request,
        ...
        #region Receive GetCompositeSchedule response (JSON)
        ...
        #region Receive GetCompositeSchedule response (binary)

...
namespace cloud.charging.open.protocols.OCPPv1_6.NetworkingNode
{
    ...
    public delegate Task OnDiagnosticsStatusNotificationRequestReceivedDelegate(DateTimeOffset                         Timestamp,
                                                                                IEventSender                           Sender,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnDiagnosticsStatusNotificationResponseReceivedDelegate(DateTimeOffset                          Timestamp,
                                                                                 IEventSender                            Sender,
                                                                                 IWebSocketConnection?                   Connection,
                                                                                 DiagnosticsStatusNotificationRequest?   Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnDiagnosticsStatusNotificationRequestErrorReceivedDelegate(DateTimeOffset                          Timestamp,
                                                                                     IEventSender                            Sender,
                                                                                     IWebSocketConnection                    Connection,
                                                                                     DiagnosticsStatusNotificationRequest?   Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnDiagnosticsStatusNotificationResponseErrorReceivedDelegate(DateTimeOffset                           Timestamp,
                                                                                      IEventSender                             Sender,
                                                                                      IWebSocketConnection                     Connection,
                                                                                      DiagnosticsStatusNotificationRequest?    Request,
                                                                                      DiagnosticsStatusNotificationResponse?   Response,
    ...
    public delegate Task<DiagnosticsStatusNotificationResponse>
        ...
        OnDiagnosticsStatusNotificationDelegate(DateTimeOffset                         Timestamp,
                                                IEventSender                           Sender,
                                                IWebSocketConnection                   Connection,
                                                DiagnosticsStatusNotificationRequest   Request,
                                                CancellationToken                      CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        public async Task<OCPP_Response>
            ...
            Receive_DiagnosticsStatusNotification(DateTimeOffset        RequestTimestamp,

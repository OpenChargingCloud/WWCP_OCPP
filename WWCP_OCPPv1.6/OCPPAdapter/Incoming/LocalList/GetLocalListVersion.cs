...
namespace cloud.charging.open.protocols.OCPPv1_6.NetworkingNode
{
    ...
    public delegate Task OnGetLocalListVersionRequestReceivedDelegate(DateTimeOffset            Timestamp,
                                                                   IEventSender              Sender,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnGetLocalListVersionResponseReceivedDelegate(DateTimeOffset             Timestamp,
                                                                    IEventSender               Sender,
                                                                    IWebSocketConnection?      Connection,
                                                                    GetLocalListVersionRequest?   Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnGetLocalListVersionRequestErrorReceivedDelegate(DateTimeOffset                 Timestamp,
                                                                        IEventSender                   Sender,
                                                                        IWebSocketConnection           Connection,
                                                                        GetLocalListVersionRequest?       Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnGetLocalListVersionResponseErrorReceivedDelegate(DateTimeOffset                  Timestamp,
                                                                         IEventSender                    Sender,
                                                                         IWebSocketConnection            Connection,
                                                                         GetLocalListVersionRequest?        Request,
                                                                         GetLocalListVersionResponse?       Response,
    ...
    public delegate Task<GetLocalListVersionResponse>
        ...
        OnGetLocalListVersionDelegate(DateTimeOffset            Timestamp,
                                   IEventSender              Sender,
                                   IWebSocketConnection      Connection,
                                   GetLocalListVersionRequest   Request,
                                   CancellationToken         CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        #region Receive GetLocalListVersion request (JSON)
        ...
        public async Task<OCPP_Response>
            ...
            Receive_GetLocalListVersion(DateTimeOffset        RequestTimestamp,
        ...
        #region Receive GetLocalListVersion request (binary)
...

        {
            ...
            //    if (GetLocalListVersionRequest.TryParse(BinaryRequest,
            //                                         RequestId,
            //                                         Destination,
            //                                         NetworkPath,
            //                                         out var request,
        ...
        #region Receive GetLocalListVersion response (JSON)
...

        {
            ...
            catch (Exception e)
            {
                ...
                response = GetLocalListVersionResponse.ExceptionOccurred(
                               Request,
                               e
                           );
        ...
        #region Receive GetLocalListVersion response (binary)

...
namespace cloud.charging.open.protocols.OCPPv1_6.NetworkingNode
{
    ...
    public delegate Task OnHeartbeatRequestReceivedDelegate(DateTimeOffset         Timestamp,
                                                            IEventSender           Sender,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnHeartbeatResponseReceivedDelegate(DateTimeOffset          Timestamp,
                                                             IEventSender            Sender,
                                                             IWebSocketConnection?   Connection,
                                                             HeartbeatRequest?       Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnHeartbeatRequestErrorReceivedDelegate(DateTimeOffset                 Timestamp,
                                                                 IEventSender                   Sender,
                                                                 IWebSocketConnection           Connection,
                                                                 HeartbeatRequest?              Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnHeartbeatResponseErrorReceivedDelegate(DateTimeOffset                  Timestamp,
                                                                  IEventSender                    Sender,
                                                                  IWebSocketConnection            Connection,
                                                                  HeartbeatRequest?               Request,
                                                                  HeartbeatResponse?              Response,
    ...
    public delegate Task<HeartbeatResponse>
        ...
        OnHeartbeatDelegate(DateTimeOffset         Timestamp,
                            IEventSender           Sender,
                            IWebSocketConnection   Connection,
                            HeartbeatRequest       Request,
                            CancellationToken      CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        #region Receive Heartbeat request (JSON)
        ...
        public async Task<OCPP_Response>
            ...
            Receive_Heartbeat(DateTimeOffset        RequestTimestamp,
        ...
        #region Receive Heartbeat request (binary)
...

        {
            ...
            //    if (HeartbeatRequest.TryParse(BinaryRequest,
            //                                         RequestId,
            //                                         Destination,
            //                                         NetworkPath,
            //                                         out var request,
        ...
        #region Receive Heartbeat response (JSON)
        ...
        #region Receive Heartbeat response (binary)

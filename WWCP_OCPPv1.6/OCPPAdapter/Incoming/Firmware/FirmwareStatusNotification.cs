...
namespace cloud.charging.open.protocols.OCPPv1_6.NetworkingNode
{
    ...
    public delegate Task OnFirmwareStatusNotificationRequestReceivedDelegate(DateTimeOffset            Timestamp,
                                                                   IEventSender              Sender,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnFirmwareStatusNotificationResponseReceivedDelegate(DateTimeOffset             Timestamp,
                                                                    IEventSender               Sender,
                                                                    IWebSocketConnection?      Connection,
                                                                    FirmwareStatusNotificationRequest?   Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnFirmwareStatusNotificationRequestErrorReceivedDelegate(DateTimeOffset                 Timestamp,
                                                                        IEventSender                   Sender,
                                                                        IWebSocketConnection           Connection,
                                                                        FirmwareStatusNotificationRequest?       Request,
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnFirmwareStatusNotificationResponseErrorReceivedDelegate(DateTimeOffset                  Timestamp,
                                                                         IEventSender                    Sender,
                                                                         IWebSocketConnection            Connection,
                                                                         FirmwareStatusNotificationRequest?        Request,
                                                                         FirmwareStatusNotificationResponse?       Response,
    ...
    public delegate Task<FirmwareStatusNotificationResponse>
        ...
        OnFirmwareStatusNotificationDelegate(DateTimeOffset            Timestamp,
                                   IEventSender              Sender,
                                   IWebSocketConnection      Connection,
                                   FirmwareStatusNotificationRequest   Request,
                                   CancellationToken         CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        #region Receive FirmwareStatusNotification request (JSON)
        ...
        public async Task<OCPP_Response>
            ...
            Receive_FirmwareStatusNotification(DateTimeOffset        RequestTimestamp,
        ...
        #region Receive FirmwareStatusNotification request (binary)
...

        {
            ...
            //    if (FirmwareStatusNotificationRequest.TryParse(BinaryRequest,
            //                                         RequestId,
            //                                         Destination,
            //                                         NetworkPath,
            //                                         out var request,
        ...
        #region Receive FirmwareStatusNotification response (JSON)
        ...
        #region Receive FirmwareStatusNotification response (binary)

...
namespace cloud.charging.open.protocols.OCPPv1_6.NetworkingNode
{
    ...
    /// <summary>
    /// A logging delegate called whenever a UpdateFirmware request was received.
    /// </summary>
    ...
    public delegate Task OnUpdateFirmwareRequestReceivedDelegate(DateTimeOffset            Timestamp,
                                                                   IEventSender              Sender,
    ...
    /// <summary>
    /// A logging delegate called whenever a UpdateFirmware response was received.
    /// </summary>
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnUpdateFirmwareResponseReceivedDelegate(DateTimeOffset             Timestamp,
                                                                    IEventSender               Sender,
                                                                    IWebSocketConnection?      Connection,
                                                                    UpdateFirmwareRequest?   Request,
    ...
    /// <summary>
    /// A logging delegate called whenever a UpdateFirmware request error was received.
    /// </summary>
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnUpdateFirmwareRequestErrorReceivedDelegate(DateTimeOffset                 Timestamp,
                                                                        IEventSender                   Sender,
                                                                        IWebSocketConnection           Connection,
                                                                        UpdateFirmwareRequest?       Request,
    ...
    /// <summary>
    /// A logging delegate called whenever a UpdateFirmware response error was received.
    /// </summary>
    /// <param name="Timestamp">The logging timestamp.</param>
    ...
    /// <param name="CancellationToken">An optional cancellation token.</param>
    public delegate Task OnUpdateFirmwareResponseErrorReceivedDelegate(DateTimeOffset                  Timestamp,
                                                                         IEventSender                    Sender,
                                                                         IWebSocketConnection            Connection,
                                                                         UpdateFirmwareRequest?        Request,
                                                                         UpdateFirmwareResponse?       Response,
    ...
    /// <summary>
    /// A delegate called whenever a UpdateFirmware response is expected
    ...
    public delegate Task<UpdateFirmwareResponse>
        ...
        OnUpdateFirmwareDelegate(DateTimeOffset            Timestamp,
                                   IEventSender              Sender,
                                   IWebSocketConnection      Connection,
                                   UpdateFirmwareRequest   Request,
                                   CancellationToken         CancellationToken);
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        #region Receive UpdateFirmware request (JSON)

        /// <summary>
        /// An event sent whenever a UpdateFirmware request was received.
        /// </summary>
        public event OnUpdateFirmwareRequestReceivedDelegate?  OnUpdateFirmwareRequestReceived;

        /// <summary>
        /// An event sent whenever a UpdateFirmware request was received for processing.
        /// </summary>
        ...
        public async Task<OCPP_Response>
            ...
            Receive_UpdateFirmware(DateTimeOffset        RequestTimestamp,
            ...
            try
            {
                ...
                if (UpdateFirmwareRequest.TryParse(JSONRequest,
                    ...
                    ocppResponse = OCPP_Response.JSONResponse(
                                       ...
                                       async sentMessageResult => await parentNetworkingNode.OCPP.OUT.SendOnUpdateFirmwareResponseSent(
                                                                            Timestamp.Now,
                                                                            parentNetworkingNode,
        ...
        #region Receive UpdateFirmware request (binary)
...

        {
            ...
            //    if (UpdateFirmwareRequest.TryParse(BinaryRequest,
            //                                         RequestId,
            //                                         Destination,
            //                                         NetworkPath,
            //                                         out var request,
        ...
        #region Receive UpdateFirmware response (JSON)

        /// <summary>
        /// An event fired whenever a UpdateFirmware response was received.
        /// </summary>
        ...
        #region Receive UpdateFirmware response (binary)
        ...
        /// <summary>
        /// An event fired whenever a UpdateFirmware request error was received.
        /// </summary>
        ...
        /// <summary>
        /// An event fired whenever a UpdateFirmware response error was received.
        /// </summary>

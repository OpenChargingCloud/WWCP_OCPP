...
namespace cloud.charging.open.protocols.OCPPv1_6.NetworkingNode
{
    ...
    public partial class OCPPWebSocketAdapterIN
    {
        ...
        #region Receive Reset request (JSON)
        ...
        #region Receive Reset request (binary)
...

        {
            ...
            //    if (ResetRequest.TryParse(BinaryRequest,
            //                                         RequestId,
            //                                         Destination,
            //                                         NetworkPath,
            //                                         out var request,
        ...
        #region Receive Reset response (JSON)
        ...
        #region Receive Reset response (binary)

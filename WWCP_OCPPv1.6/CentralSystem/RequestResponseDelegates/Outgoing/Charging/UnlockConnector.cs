...
namespace cloud.charging.open.protocols.OCPPv1_6.CS
{
    ...
    /// <summary>
    /// A delegate called whenever an UnlockConnector request will be sent to a charging station.
    /// </summary>
    ...
    /// <summary>
    /// A delegate called whenever an response to an UnlockConnector request was received.
    /// </summary>
    /// <param name="Timestamp">The timestamp of the log request.</param>
    /// <param name="Sender">The sender of the request.</param>
    /// <param name="Request">The request.</param>

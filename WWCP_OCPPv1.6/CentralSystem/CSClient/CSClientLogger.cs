...
namespace org.GraphDefined.WWCP.OCPPv1_6.CS
{
    ...
    public partial class CSClient : ASOAPClient
    {
        ...
        /// </summary>
        public class CSClientLogger : HTTPLogger
        {
            ...
            /// <summary>
            /// Create a new OCPP CS client logger using the given logging delegates.
            /// </summary>
            /// <param name="CSClient">A OCPP CS client.</param>
            /// <param name="Context">A context of this API.</param>
            /// 
...

            {
                ...
                if (CSClient == null)
                    throw new ArgumentNullException(nameof(CSClient), "The given EMP client must not be null!");

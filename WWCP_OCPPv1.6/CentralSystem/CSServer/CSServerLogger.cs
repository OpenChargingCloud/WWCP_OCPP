...
namespace org.GraphDefined.WWCP.OCPPv1_6.CS
{
    ...
    public class CSServerLogger : HTTPLogger
    {
        ...
        /// <summary>
        /// Create a new OCPP CS server logger using the default logging delegates.
        /// </summary>
        /// <param name="CSServer">A OCPP CS server.</param>
        ...
        /// <summary>
        /// Create a new OCPP CS server logger using the given logging delegates.
        /// </summary>
        /// <param name="CSServer">A OCPP CS server.</param>
        /// <param name="Context">A context of this API.</param>
        /// 

...
namespace cloud.charging.open.protocols.OCPPv1_6.CS
{
                                     ...
                                     IRequest
    {
        ...
        #region (static) Parse   (JSON, RequestId, NetworkingNodeId, NetworkPath, CustomClearCacheRequestParser = null)
        ...
        #region (static) TryParse(XML,  RequestId, NetworkingNodeId, NetworkPath, out ClearCacheRequest, out ErrorResponse)

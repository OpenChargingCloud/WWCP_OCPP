...
namespace cloud.charging.open.protocols.OCPPv1_6
{
    ...
    public static class GetInstalledCertificateStatusExtentions
    {
        ...
        public static GetInstalledCertificateStatus Parse(String Text)
            ...
            => Text.Trim() switch {
                   "Accepted"  => GetInstalledCertificateStatus.Accepted,
                   "NotFound"  => GetInstalledCertificateStatus.NotFound,
                   _           => GetInstalledCertificateStatus.Unknown
               };
    ...
    /// <summary>
    /// The status in a response to a get installed certificate ids request.
    /// </summary>

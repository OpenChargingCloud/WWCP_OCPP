...
namespace cloud.charging.open.protocols.OCPPv1_6
{
                               ...
                               IComparable
    {
        ...
        private readonly List<ChargeBox_Id> networkingNodeIds = [];
        ...
        public NetworkPath(IEnumerable<ChargeBox_Id>? NetworkingNodeIds = null)
        {
                                       ...
                                       CustomJArrayParserDelegate<NetworkPath>?  CustomNetworkPathParser)
        {
            ...
            try
            {
                ...
                var networkingNodeIds = new List<ChargeBox_Id>();

                foreach (var id in JSONArray)
                {

                    if (id.Type == JTokenType.String &&
                        ChargeBox_Id.TryParse(id?.Value<String>() ?? "", out var networkingNodeId))
                    {
        ...
        public NetworkPath Append(ChargeBox_Id NetworkingNodeId)
        {

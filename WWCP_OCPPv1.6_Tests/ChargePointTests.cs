...
namespace cloud.charging.open.protocols.OCPPv1_6.tests
{
    ...
    /// <summary>
    /// Unit tests for charge points.
    /// </summary>
    [TestFixture]
    public class ChargePointTests : AChargePointTests
    {

        #region ChargePoints_Init_Test()

        /// <summary>
        /// A test for creating charge points.
        /// </summary>
        [Test]
        public void ChargePoints_Init_Test()
        {
        ...
        #region ChargePoints_SendBootNotifications_Test()

        /// <summary>
        /// A test for sending boot notifications to the central system.
        /// </summary>
        [Test]
        public async Task ChargingPool_SendBootNotifications_Test()
        {
        ...
        #region ChargePoints_SendSendHeartbeats_Test()

        /// <summary>
        /// A test for sending heartbeats to the central system.
        /// </summary>
        [Test]
        public async Task ChargingPool_SendSendHeartbeats_Test()
        {
        ...
        #region ChargePoints_Authorize_Test()

        /// <summary>
        /// A test for authorizing id tokens against the central system.
        /// </summary>
        [Test]
        public async Task ChargingPool_Authorize_Test()
        {

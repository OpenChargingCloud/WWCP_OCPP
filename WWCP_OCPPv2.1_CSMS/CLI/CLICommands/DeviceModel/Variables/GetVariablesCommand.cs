...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS.CommandLine
{
    ...
    public class GetVariablesCommand(ICSMSCLI CLI) : ACLICommand<ICSMSCLI>(CLI),
                                                     ICLICommand
    {

        #region Data

        public static readonly String CommandName = nameof(GetVariablesCommand)[..^7].ToLowerFirstChar();
                                                     ...
                                                     CancellationToken  CancellationToken)
        {
            ...
            if (Arguments.Length >= 3)
            {
                ...
                var response = await cli.OCPP.OUT.GetVariables(
            ...
            return [ $"Usage: {CommandName} <ComponentName> <VariableName>" ];
        ...
        public override String Help()
            => $"{CommandName} <ComponentName> <VariableName> - Get a variable";

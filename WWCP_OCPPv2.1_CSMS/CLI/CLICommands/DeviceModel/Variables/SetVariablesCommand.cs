...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS.CommandLine
{
    ...
    public class SetVariablesCommand(ICSMSCLI CLI) : ACLICommand<ICSMSCLI>(CLI),
                                                     ICLICommand
    {

        #region Data

        public static readonly String CommandName = nameof(SetVariablesCommand)[..^7].ToLowerFirstChar();
                                                     ...
                                                     CancellationToken  CancellationToken)
        {
            ...
            if (Arguments.Length >= 4)
            {
                ...
                var response = await cli.OCPP.OUT.SetVariables(
                                         new SetVariablesRequest(
                                             ...
                                             VariableData:           [
                                                                         new SetVariableData(
                                                                             ...
                                                                             AttributeValue:      Arguments[3],
                                                                             OldAttributeValue:   null,
                                                                             AttributeType:       null
                                                                         )
                                                                     ],
                                             DataConsistencyModel:   null
                                         )
                                     );
            ...
            return [ $"Usage: {CommandName} <ComponentName> <VariableName> <AttributeValue>" ];
        ...
        public override String Help()
            => $"{CommandName} <ComponentName> <VariableName> <AttributeValue> - Set a variable";

...
namespace cloud.charging.open.protocols.OCPPv2_1.CSMS
{
                                        ...
                                        ICSMSChannel
    {
...

        {
            ...
            {
                DebugX.Log(e, nameof(CSMSWSServer) + "." + nameof(OnIncomingNotifyNetworkTopologyWSRequest));
            }
            ...
            try
            {
                ...
                if (NotifyNetworkTopologyRequest.TryParse(JSONRequest,
                    ...
                    {
                        DebugX.Log(e, nameof(CSMSWSServer) + "." + nameof(OnIncomingNotifyNetworkTopologyRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(CSMSWSServer) + "." + nameof(OnIncomingNotifyNetworkTopologyResponse));
                    }
            ...
            {
                DebugX.Log(e, nameof(CSMSWSServer) + "." + nameof(OnIncomingNotifyNetworkTopologyWSResponse));
            }

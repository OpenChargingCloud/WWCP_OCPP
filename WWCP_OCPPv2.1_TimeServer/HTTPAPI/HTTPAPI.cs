...
namespace cloud.charging.open.protocols.OCPPv2_1.TimeServer
{
    ...
    public class HTTPAPI : NetworkingNode.HTTPAPI
    {
        ...
        /// </summary>
        public const    String                     DefaultHTTPServerName     = $"Open Charging Cloud OCPP {Version.String} TimeServer HTTP API";

        /// <summary>
        /// The default HTTP realm, if HTTP Basic Authentication is used.
        /// </summary>
        public const String                        DefaultHTTPRealm          = "Open Charging Cloud OCPP TimeServer HTTP API";
        ...
        protected readonly ATimeServerNode timeServer;
        ...
        /// <summary>
        /// Attach the given time server WebAPI to the given HTTP API.
        /// </summary>
        /// <param name="HTTPExtAPI">A HTTP API.</param>
        /// <param name="URLPathPrefix">An optional prefix for the HTTP URLs.</param>
        /// <param name="HTTPRealm">The HTTP realm, if HTTP Basic Authentication is used.</param>
        /// <param name="HTTPLogins">An enumeration of logins for an optional HTTP Basic Authentication.</param>
        public HTTPAPI(ATimeServerNode                             TimeServer,
        ...
        #region AttachTimeServer(TimeServer)

        public void AttachTimeServer(ATimeServerNode TimeServer)
        {
            ...
            //TimeServer.OnJSONMessageRequestReceived += (timestamp,
            //                                         webSocketServer,
            //                                         webSocketConnection,
            //                                         networkingNodeId,
            //                                         networkPath,
            ...
            //    EventLog.SubmitEvent(nameof(TimeServer.OnJSONMessageRequestReceived),
            //                         JSONObject.Create(
            ...
            //TimeServer.OnJSONMessageResponseSent += (timestamp,
            //                                      webSocketServer,
            //                                      webSocketConnection,
            //                                      networkingNodeId,
            //                                      networkPath,
            ...
            //    EventLog.SubmitEvent(nameof(TimeServer.OnJSONMessageResponseSent),
            //                         JSONObject.Create(
            //                             new JProperty("timestamp",    timestamp.          ToISO8601()),
            //                             new JProperty("connection",   webSocketConnection.ToJSON()),
            ...
            ////TimeServer.OnJSONErrorResponseSent += (timestamp,
            ////                                    webSocketServer,
            ////                                    webSocketConnection,
            ////                                    eventTrackingId,
            ////                                    requestTimestamp,
            ...
            ////    EventLog.SubmitEvent(nameof(TimeServer.OnJSONErrorResponseSent),
            ////                         JSONObject.Create(
            ////                             new JProperty("timestamp",    timestamp.          ToISO8601()),
            ////                             new JProperty("connection",   webSocketConnection.ToJSON()),
            ////                             new JProperty("message",      responseMessage)
            ...
            //TimeServer.OnJSONMessageRequestSent += (timestamp,
            //                                     webSocketServer,
            //                                     webSocketConnection,
            //                                     networkingNodeId,
            //                                     networkPath,
            ...
            //    EventLog.SubmitEvent(nameof(TimeServer.OnJSONMessageRequestSent),
            //                         JSONObject.Create(
            //                             new JProperty("timestamp",    timestamp.          ToISO8601()),
            //                             new JProperty("connection",   webSocketConnection.ToJSON()),
            //                             new JProperty("message",      requestMessage)
            ...
            //TimeServer.OnJSONMessageResponseReceived += (timestamp,
            //                                          webSocketServer,
            //                                          webSocketConnection,
            //                                          networkingNodeId,
            //                                          networkPath,
            ...
            //    EventLog.SubmitEvent(nameof(TimeServer.OnJSONMessageResponseReceived),
            //                         JSONObject.Create(
            //                             new JProperty("timestamp",    timestamp.          ToISO8601()),
            //                             new JProperty("connection",   webSocketConnection.ToJSON()),
            //                             new JProperty("message",      responseMessage)
            ...
            ////TimeServer.OnJSONErrorResponseReceived += (timestamp,
            ////                                        webSocketServer,
            ////                                        webSocketConnection,
            ////                                        eventTrackingId,
            ////                                        requestTimestamp,
            ...
            ////    EventLog.SubmitEvent(nameof(TimeServer.OnJSONErrorResponseReceived),
            ////                         JSONObject.Create(
            ////                             new JProperty("timestamp",    timestamp.          ToISO8601()),
            ////                             new JProperty("connection",   webSocketConnection.ToJSON()),
            ////                             new JProperty("message",      responseMessage)
            ...
            //TimeServer.OnBinaryMessageRequestReceived += (timestamp,
            //                                           webSocketServer,
            //                                           webSocketConnection,
            //                                           networkingNodeId,
            //                                           networkPath,
            ...
            //    EventLog.SubmitEvent(nameof(TimeServer.OnBinaryMessageRequestReceived),
            //                         JSONObject.Create(
            //                             new JProperty("timestamp",    timestamp.          ToISO8601()),
            //                             new JProperty("connection",   webSocketConnection.ToJSON()),
            ...
            //TimeServer.OnBinaryMessageResponseSent += (timestamp,
            //                                        webSocketServer,
            //                                        webSocketConnection,
            //                                        networkingNodeId,
            //                                        networkPath,
            ...
            //    EventLog.SubmitEvent(nameof(TimeServer.OnBinaryMessageResponseSent),
            //                         JSONObject.Create(
            //                             new JProperty("timestamp",    timestamp.          ToISO8601()),
            //                             new JProperty("connection",   webSocketConnection.ToJSON()),
            ...
            //TimeServer.OnBinaryMessageRequestSent += (timestamp,
            //                                       webSocketServer,
            //                                       webSocketConnection,
            //                                       networkingNodeId,
            //                                       networkPath,
            ...
            //    EventLog.SubmitEvent(nameof(TimeServer.OnBinaryMessageRequestSent),
            //                         JSONObject.Create(
            //                             new JProperty("timestamp",    timestamp.          ToISO8601()),
            //                             new JProperty("connection",   webSocketConnection.ToJSON()),
            //                             new JProperty("message",      requestMessage)  // BASE64 encoded string!
            ...
            //TimeServer.OnBinaryMessageResponseReceived += (timestamp,
            //                                            webSocketServer,
            //                                            webSocketConnection,
            //                                            networkingNodeId,
            //                                            networkPath,
            ...
            //    EventLog.SubmitEvent(nameof(TimeServer.OnBinaryMessageResponseReceived),
            //                         JSONObject.Create(
            //                             new JProperty("timestamp",    timestamp.          ToISO8601()),
            //                             new JProperty("connection",   webSocketConnection.ToJSON()),
            //                             new JProperty("message",      responseMessage)  // BASE64 encoded string!

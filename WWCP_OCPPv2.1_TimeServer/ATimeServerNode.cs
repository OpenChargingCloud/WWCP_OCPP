...
namespace cloud.charging.open.protocols.OCPPv2_1.TimeServer
{
    ...
    /// <summary>
    /// An abstract time server node.
    /// </summary>
    public abstract class ATimeServerNode : AOCPPNetworkingNode,
                                            GW.ITimeServerNode
    {
      ...
      //  private readonly HTTPExtAPI  HTTPAPI;
        ...
        /// <summary>
        /// The time server vendor identification.
        /// </summary>
        [Mandatory]
        public String                      VendorName                 { get; }      = "";

        /// <summary>
        ///  The time server model identification.
        /// </summary>
        [Mandatory]
        public String                      Model                      { get; }      = "";

        /// <summary>
        /// The optional serial number of the time server.
        /// </summary>
        [Optional]
        public String?                     SerialNumber               { get; }

        /// <summary>
        /// The optional firmware version of the time server.
        /// </summary>
        [Optional]
        ...
        /// <summary>
        /// Create a new abstract time server node.
        /// </summary>
        /// <param name="Id">The unique identification of this time server node.</param>
        public ATimeServerNode(NetworkingNode_Id  Id,
                            String             VendorName,
                            String             Model,

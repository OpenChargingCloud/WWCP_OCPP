    ...
    public class CS_Messages_Tests : AChargingStationTests
    {
        ...
        public async Task SendBootNotifications_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                Assert.Multiple(() => {
                    ...
                    Assert.That(bootNotificationRequests.First().DestinationNodeId,   Is.EqualTo(chargingStation1.Id));
        ...
        public async Task SendFirmwareStatusNotification_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnFirmwareStatusNotificationRequest += (timestamp, sender, connection, firmwareStatusNotificationRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,   firmwareStatusNotificationRequests.First().DestinationNodeId);
        ...
        public async Task SendPublishFirmwareStatusNotification_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnPublishFirmwareStatusNotificationRequest += (timestamp, sender, connection, publishFirmwareStatusNotificationRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,   publishFirmwareStatusNotificationRequests.First().DestinationNodeId);
        ...
        public async Task SendHeartbeats_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnHeartbeatRequest += (timestamp, sender, connection, heartbeatRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,   heartbeatRequests.First().DestinationNodeId);
        ...
        public async Task NotifyEvent_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnNotifyEventRequest += (timestamp, sender, connection, notifyEventRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,   notifyEventRequests.First().DestinationNodeId);
        ...
        public async Task SendSecurityEventNotification_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnSecurityEventNotificationRequest += (timestamp, sender, connection, securityEventNotificationRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,   securityEventNotificationRequests.First().DestinationNodeId);
        ...
        public async Task NotifyReport_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnNotifyReportRequest += (timestamp, sender, connection, notifyReportRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,   notifyReportRequests.First().DestinationNodeId);
        ...
        public async Task NotifyMonitoringReport_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnNotifyMonitoringReportRequest += (timestamp, sender, connection, notifyMonitoringReportRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,   notifyMonitoringReportRequests.First().DestinationNodeId);
        ...
        public async Task SendLogStatusNotification_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnLogStatusNotificationRequest += (timestamp, sender, connection, securityEventNotificationRequest) => {
                    securityEventNotificationRequests.TryAdd(securityEventNotificationRequest);
                    return Task.CompletedTask;
                };
        ...
        public async Task SendCertificateSigningRequest_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnSignCertificateRequest += (timestamp, sender, connection, notifyReportRequest) => {
                    notifyReportRequests.TryAdd(notifyReportRequest);
                    return Task.CompletedTask;
                };
        ...
        public async Task GetCertificateStatus_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnGetCertificateStatusRequest += (timestamp, sender, connection, notifyReportRequest) => {
                    notifyReportRequests.TryAdd(notifyReportRequest);
                    return Task.CompletedTask;
                };
                ...
                Assert.Multiple(() => {
                    ...
                    Assert.That(notifyReportRequests.First().DestinationNodeId,   Is.EqualTo(chargingStation1.Id));
        ...
        public async Task GetCRLRequest_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnGetCRLRequest += (timestamp, sender, connection, getCRLRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,   getCRLRequests.First().DestinationNodeId);
        ...
        public async Task SendReservationStatusUpdate_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnReservationStatusUpdateRequest += (timestamp, sender, connection, securityEventNotificationRequest) => {
                    securityEventNotificationRequests.TryAdd(securityEventNotificationRequest);
                    return Task.CompletedTask;
                };
        ...
        public async Task Authorize_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnAuthorizeRequest += (timestamp, sender, connection, authorizeRequest) => {
                ...
                ClassicAssert.AreEqual(ResultCode.OK,                  response.Result.ResultCode);
                ClassicAssert.AreEqual(AuthorizationStatus.Accepted,   response.IdTokenInfo.Status);

                ClassicAssert.AreEqual(1,                              authorizeRequests.Count);
                ClassicAssert.AreEqual(chargingStation1.Id,            authorizeRequests.First().DestinationNodeId);
        ...
        public async Task NotifyEVChargingNeeds_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnNotifyEVChargingNeedsRequest += (timestamp, sender, connection, notifyEVChargingNeedsRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,   notifyEVChargingNeedsRequests.First().DestinationNodeId);
        ...
        public async Task SendTransactionEvent_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnTransactionEventRequest += (timestamp, sender, connection, transactionEventRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,            transactionEventRequests.First().DestinationNodeId);
        ...
        public async Task SendStatusNotification_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnStatusNotificationRequest += (timestamp, sender, connection, statusNotificationRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,           statusNotificationRequests.First().DestinationNodeId);
        ...
        public async Task SendMeterValues_Test()
        {
...

            {
                ...
                testCSMS01.OnMeterValuesRequest += (timestamp, sender, connection, meterValuesRequest) => {
                ...
                ClassicAssert.AreEqual (chargingStation1.Id,                                             meterValuesRequests.First().DestinationNodeId);
        ...
        public async Task NotifyChargingLimit_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnNotifyChargingLimitRequest += (timestamp, sender, connection, notifyChargingLimitRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,   notifyChargingLimitRequests.First().DestinationNodeId);
        ...
        public async Task SendClearedChargingLimit_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnClearedChargingLimitRequest += (timestamp, sender, connection, transactionEventRequest) => {
                    transactionEventRequests.TryAdd(transactionEventRequest);
                    return Task.CompletedTask;
                };
        ...
        public async Task ReportChargingProfiles_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnReportChargingProfilesRequest += (timestamp, sender, connection, transactionEventRequest) => {
                    transactionEventRequests.TryAdd(transactionEventRequest);
                    return Task.CompletedTask;
                };
        ...
        public async Task NotifyEVChargingSchedule_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnNotifyEVChargingScheduleRequest += (timestamp, sender, connection, notifyEVChargingScheduleRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,      notifyEVChargingScheduleRequests.First().DestinationNodeId);
        ...
        public async Task NotifyPriorityCharging_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnNotifyPriorityChargingRequest += (timestamp, sender, connection, notifyPriorityChargingRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,   notifyPriorityChargingRequests.First().DestinationNodeId);
        ...
        public async Task PullDynamicScheduleUpdate_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                testCSMS01.OnPullDynamicScheduleUpdateRequest += (timestamp, sender, connection, pullDynamicScheduleUpdateRequest) => {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,   pullDynamicScheduleUpdateRequests.First().DestinationNodeId);
        ...
        public async Task NotifyDisplayMessages_Test()
        {
                ...
                chargingStation3        is not null)
            {
                ...
                ClassicAssert.AreEqual(chargingStation1.Id,   notifyDisplayMessagesRequests.First().DestinationNodeId);

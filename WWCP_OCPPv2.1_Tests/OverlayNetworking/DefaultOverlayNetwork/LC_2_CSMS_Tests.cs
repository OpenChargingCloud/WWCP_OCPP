...
namespace cloud.charging.open.protocols.OCPPv2_1.tests.OverlayNetworking.OverlayNetwork.Default
{
    ...
    [TestFixture]
    [NonParallelizable]
    public class LC_2_CSMS_Tests : ADefaultOverlayNetwork
    {

        // Networking Node -> CSMS

        #region LC_2_CSMS_SendBootNotifications_Test()

        /// <summary>
        /// A test for sending signed boot notifications from a networking node to the CSMS.
        /// </summary>
        [Test]
        public async Task LC_2_CSMS_SendBootNotifications_Test()
        {
                ...
                csmsWSServer           is not null)
            {
                ...
                localController.OCPP.OUT.OnBootNotificationRequestSent      += (timestamp, sender, connection, bootNotificationRequest, sentMessageResult, ct) => {
                ...
                localController.OCPP.IN. OnBootNotificationResponseReceived += (timestamp, sender, connection, bootNotificationRequest, bootNotificationResponse, runtime, ct) => {
        ...
        #region LC_2_CSMS_Get15118EVCertificate_Test()

        /// <summary>
        /// A test for getting an ISO 15118 ev certificate from the CSMS.
        /// </summary>
        [Test]
        public async Task LC_2_CSMS_Get15118EVCertificate_Test()
        {

        ...
        public async Task CS_2_LC_SendBootNotifications_Test()
        {
                ...
                chargingStation        is not null)
            {
                ...
                Assert.Multiple(() => {
                    ...
                    Assert.That(nnJSONMessageRequest.Destination.Next,                       Is.EqualTo(NetworkingNode_Id.CSMS));
        ...
        public async Task CS_2_LC_TransferBinaryData_Test()
        {
                ...
                chargingStation        is not null)
            {
                ...
                Assert.Multiple(() => {
                    ...
                    Assert.That(nnBinaryMessageRequest.Destination.Next,                     Is.EqualTo(NetworkingNode_Id.CSMS));

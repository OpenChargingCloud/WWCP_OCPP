...
namespace cloud.charging.open.protocols.OCPPv2_1.tests.OverlayNetworking.OverlayNetwork.Default
{
    ...
    [TestFixture]
    [NonParallelizable]
    public class LC_2_CS_Tests : ADefaultOverlayNetwork
    {

        // Networking Node -> Charging Station

        #region LC_2_CS_SendReset_Test()

        /// <summary>
        /// A test for resetting a charging station.
        /// </summary>
        [Test]
        public async Task LC_2_CS_SendReset_Test()
        {
        ...
        public async Task LC_2_CS_TransferData_Test()
        {
                ...
                chargingStation        is not null)
            {
                ...
                Assert.Multiple(() => {
                    ...
                    //Assert.That(csDataTransferRequest.DestinationNodeId,       Is.EqualTo(chargingStation.Id));   // Because of "standard" networking mode!

...
namespace cloud.charging.open.protocols.OCPPv2_1.tests.NetworkingNode
{
    ...
    /// </summary>
    public abstract class ANetworkingNodeTests : ACSMSTests
    {

        #region Data

        protected TestNetworkingNode?           networkingNode1;
            ...
            if (InitNetworkingNode1)
            {
                ...
                if (testBackendWebSockets01 is not null)
                {
                    ...
                    if (networkingNode1WebSocketClient is not null)
                    {
                        ...
                        networkingNode1WebSocketClient.OnTextMessageReceived         += async (timestamp, webSocketServer, webSocketConnection, webSocketFrame, eventTrackingId, message) => {
                        ...
                        networkingNode1WebSocketClient.OnTextMessageSent             += async (timestamp, webSocketServer, webSocketConnection, webSocketFrame, eventTrackingId, message) => {
        ...
        public override void ShutdownEachTest()
        {
            ...
            networkingNode1 = null;
            networkingNode2 = null;
            networkingNode3 = null;

...
namespace cloud.charging.open.protocols.OCPPv2_1.CMS
{
    ...
    public class DownloadAPI : org.GraphDefined.Vanaheimr.Hermod.HTTP.HTTPAPI
    {
        ...
        /// </summary>
        public ACommissioningServiceNode                                  CSMSNode          { get; }
        ...
        /// </summary>
        /// <param name="CommissioningServiceNode">A networking node.</param>
        ...
        public DownloadAPI(ACommissioningServiceNode                   CommissioningServiceNode,
...

        {
            ...
            this.CSMSNode        = CommissioningServiceNode;

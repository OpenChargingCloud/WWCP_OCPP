...
namespace cloud.charging.open.protocols.OCPPv1_6.CP
{
                                               ...
                                               IChargePointClientEvents
    {
...

        {
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnUpdateSignaturePolicyWSRequest));
            }
            ...
            try
            {
                ...
                if (UpdateSignaturePolicyRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnUpdateSignaturePolicyRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnUpdateSignaturePolicyResponse));
                    }
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnUpdateSignaturePolicyWSResponse));
            }

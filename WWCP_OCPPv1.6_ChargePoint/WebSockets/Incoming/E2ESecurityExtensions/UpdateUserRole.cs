...
namespace cloud.charging.open.protocols.OCPPv1_6.CP
{
                                               ...
                                               ICPOutgoingMessagesEvents
    {
...

        {
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnUpdateUserRoleWSRequest));
            }
            ...
            try
            {
                ...
                if (UpdateUserRoleRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnUpdateUserRoleRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnUpdateUserRoleResponse));
                    }
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnUpdateUserRoleWSResponse));
            }

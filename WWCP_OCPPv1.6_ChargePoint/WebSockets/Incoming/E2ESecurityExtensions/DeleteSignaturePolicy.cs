...
namespace cloud.charging.open.protocols.OCPPv1_6.CP
{
                                               ...
                                               IChargePointClientEvents
    {
...

        {
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnDeleteSignaturePolicyWSRequest));
            }
            ...
            try
            {
                ...
                if (DeleteSignaturePolicyRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnDeleteSignaturePolicyRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnDeleteSignaturePolicyResponse));
                    }
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnDeleteSignaturePolicyWSResponse));
            }

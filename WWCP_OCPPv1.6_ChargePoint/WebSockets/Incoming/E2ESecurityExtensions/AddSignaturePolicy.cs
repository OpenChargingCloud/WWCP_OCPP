...
namespace cloud.charging.open.protocols.OCPPv1_6.CP
{
                                               ...
                                               ICPOutgoingMessagesEvents
    {
...

        {
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnAddSignaturePolicyWSRequest));
            }
            ...
            try
            {
                ...
                if (AddSignaturePolicyRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnAddSignaturePolicyRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnAddSignaturePolicyResponse));
                    }
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnAddSignaturePolicyWSResponse));
            }

...
namespace cloud.charging.open.protocols.OCPPv1_6.CP
{
                                               ...
                                               ICPOutgoingMessagesEvents
    {
        ...
        /// <summary>
        /// An event sent whenever a DeleteCertificate websocket request was received.
        /// </summary>
...

        {
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnDeleteCertificateWSRequest));
            }
            ...
            try
            {
                ...
                if (DeleteCertificateRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnDeleteCertificateRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnDeleteCertificateResponse));
                    }
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnDeleteCertificateWSResponse));
            }

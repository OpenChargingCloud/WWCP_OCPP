...
namespace cloud.charging.open.protocols.OCPPv1_6.CP
{
                                               ...
                                               ICPOutgoingMessagesEvents
    {
...

        {
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnGetInstalledCertificateIdsWSRequest));
            }
            ...
            try
            {
                ...
                if (GetInstalledCertificateIdsRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnGetInstalledCertificateIdsRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnGetInstalledCertificateIdsResponse));
                    }
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnGetInstalledCertificateIdsWSResponse));
            }

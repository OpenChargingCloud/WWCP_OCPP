...
namespace cloud.charging.open.protocols.OCPPv1_6.CP
{
                                               ...
                                               ICPOutgoingMessagesEvents
    {
...

        {
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnGetFileWSRequest));
            }
            ...
            try
            {
                ...
                if (GetFileRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnGetFileRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnGetFileResponse));
                    }
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnGetFileWSResponse));
            }

...
namespace cloud.charging.open.protocols.OCPPv1_6.CP
{
                                               ...
                                               IChargePointClientEvents
    {
...

        {
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnListDirectoryWSRequest));
            }
            ...
            try
            {
                ...
                if (ListDirectoryRequest.TryParse(RequestJSON,
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnListDirectoryRequest));
                    }
                    ...
                    {
                        DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnListDirectoryResponse));
                    }
            ...
            {
                DebugX.Log(e, nameof(ChargePointWSClient) + "." + nameof(OnListDirectoryWSResponse));
            }

...
namespace cloud.charging.open.protocols.OCPPv2_1.Gateway
{
                           ...
                           IHTTPAPIExtension<HTTPExtAPI>
    {
        ...
        protected readonly  List<AGateway>                                             gateways   = [];
        ...
        /// </summary>
        public IEnumerable<AGateway>                      Gateways
            => gateways;
        ...
        /// <param name="HTTPRealm">The HTTP realm, if HTTP Basic Authentication is used.</param>
        /// <param name="HTTPLogins">An enumeration of logins for an optional HTTP Basic Authentication.</param>
        public HTTPAPI(AGateway                                    Gateway,
                       HTTPExtAPI                                  HTTPAPI,
                       String?                                     HTTPServerName   = null,
                       HTTPPath?                                   URLPathPrefix    = null,
                       HTTPPath?                                   BasePath         = null,
        ...
        public void AttachGateway(AGateway Gateway)
        {

...
namespace cloud.charging.open.protocols.OCPPv2_1.Gateway
{
    ...
    public class WebAPI
    {
        ...
        /// </summary>
        public const    String    DefaultHTTPServerName  = $"Open Charging Cloud OCPP {Version.String} Gateway WebAPI";

        /// <summary>
        /// The default HTTP server name.
        /// </summary>
        public const    String    DefaultHTTPRealm       = $"OCPP Gateway WebAPI";

        /// <summary>
        /// The HTTP root for embedded ressources.
        /// </summary>
        public const    String    HTTPRoot               = "cloud.charging.open.protocols.OCPPv2_1.Gateway.WebAPI.HTTPRoot.";

...
namespace cloud.charging.open.protocols.OCPPv2_1.BSS
{
    ...
    public class WebAPI
    {
        ...
        /// </summary>
        public const    String    DefaultHTTPServerName  = $"Open Charging Cloud OCPP {Version.String} Charging Station WebAPI";

        /// <summary>
        /// The default HTTP server name.
        /// </summary>
        public const    String    DefaultHTTPRealm       = $"Charging Station WebAPI";
        ...
        public WebAPI(ABatterySwapStationNode                        ChargingStation,

...
namespace cloud.charging.open.protocols.OCPPv2_1
{
    ...
    /// exchange and storage of battery swap station device model data.
    /// </summary>
    public class DeviceDataCtrlr : ALogicalComponentConfig
    {
        ...
        public DeviceDataCtrlr(BytesPerMessageClass  BytesPerMessage,
            ...
            : base(nameof(DeviceDataCtrlr),
                   Instance,
                   I18NString.Create("Logical Component responsible for configuration relating to the exchange and storage of battery swap station device model data."),
                   CustomData)

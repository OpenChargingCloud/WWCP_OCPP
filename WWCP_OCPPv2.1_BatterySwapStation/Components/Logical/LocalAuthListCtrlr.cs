...
namespace cloud.charging.open.protocols.OCPPv2_1.BSS
{
    ...
    /// <summary>
    /// Logical Component responsible for configuration relating to the use of Local Authorization Lists for battery swap station use.
    /// </summary>
    public class LocalAuthListCtrlr : ALogicalComponentConfig
    {
        ...
        public LocalAuthListCtrlr(Boolean?     Enabled                = null,
            ...
            : base(nameof(LocalAuthListCtrlr),
                   Instance,
                   I18NString.Create("Logical Component responsible for configuration relating to the use of Local Authorization Lists for battery swap station use."),
                   CustomData)

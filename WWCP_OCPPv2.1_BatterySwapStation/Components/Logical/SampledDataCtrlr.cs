...
namespace cloud.charging.open.protocols.OCPPv2_1.BSS
{
    ...
    public class SampledDataCtrlr : ALogicalComponentConfig
    {
        ...
        /// <summary>
        /// If set to true, the battery swap station includes signed meter values in the MeterValuesRequest to the CSMS.
        ...
        ///  The battery swap station reports the list of supported Measurands in VariableCharacteristicsType.valuesList of this variable.
        ///  This way the CSMS knows which Measurands it can put in the SampledDataTxStartedMeasurands.
        ///  If the battery swap station has a meter, recommended to use as default: \"Energy.Active.Import.Register\"
        /// </summary>
        [Mandatory]
        ...
        /// <param name="SignReadings">If set to true, the battery swap station includes signed meter values in the MeterValuesRequest to the CSMS.</param>
...

        {
            ...
            variableConfigs.Add(
                new VariableConfig(
                    ...
                    Description:      I18NString.Create("If set to true, the battery swap station includes signed meter values in the MeterValuesRequest to the CSMS. When a battery swap station does not support signed meter values it SHALL NOT report this variable.")
            ...
            variableConfigs.Add(
                new VariableConfig(
                    ...
                    Description:      I18NString.Create(
                                          ...
                                          "transaction (eventType = Started). The battery swap station reports the list of supported " +
            ...
            variableConfigs.Add(
                new VariableConfig(
                    ...
                    Description:      I18NString.Create(
                                          ...
                                          "The battery swap station reports the list of supported Measurands in VariableCharacteristicsType.valuesList " +

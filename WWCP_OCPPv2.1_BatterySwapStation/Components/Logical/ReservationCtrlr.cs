...
namespace cloud.charging.open.protocols.OCPPv2_1.BSS
{
    ...
    public class ReservationCtrlr : ALogicalComponentConfig
    {
        ...
        /// The battery swap station supports reservation without a specified EVSE Id.
        /// </summary>
        ...
        /// <param name="NonEvseSpecific">When this configuration variable is present and set to true: The battery swap station supports reservation without a specified EVSE Id.</param>
        /// 

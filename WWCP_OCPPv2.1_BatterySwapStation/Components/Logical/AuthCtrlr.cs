...
namespace cloud.charging.open.protocols.OCPPv2_1.BSS
{
    ...
    /// <summary>
    /// Logical Component responsible for configuration relating to the use of authorization for battery swap station use.
    /// </summary>
    public class AuthCtrlr : ALogicalComponentConfig
    {
        ...
        /// <summary>
        /// If this key exists, the battery swap station supports Unknown Offline Authorization.
        ...
        /// <param name="OfflineTxForUnknownIdEnabled">If this key exists, the battery swap station supports Unknown Offline Authorization. If this key reports a value of true, Unknown Offline Authorization is enabled.</param>
        /// 
...

        {
            ...
            variableConfigs.Add(
                new VariableConfig(
                    ...
                    Description:      I18NString.Create("If this key exists, the battery swap station supports Unknown Offline Authorization. If this key reports a value of true, Unknown Offline Authorization is enabled.")

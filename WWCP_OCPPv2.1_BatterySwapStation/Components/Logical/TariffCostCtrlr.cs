...
namespace cloud.charging.open.protocols.OCPPv2_1
{
    ...
    public class TariffCostCtrlr : ALogicalComponentConfig
    {
        ...
        /// <summary>
        /// Message to be shown to an EV Driver when the battery swap station cannot retrieve the cost for a transaction at the end of the transaction.
        /// </summary>
        public I18NString  TotalCostFallbackMessage    { get; set; }

        /// <summary>
        /// Currency used by this battery swap station in a ISO 4217 [ISO4217] formatted currency code.
        /// </summary>
        ...
        /// <param name="TotalCostFallbackMessage">Message to be shown to an EV Driver when the battery swap station cannot retrieve the cost for a transaction at the end of the transaction.</param>
        /// <param name="Currency">Currency used by this battery swap station in a ISO 4217 [ISO4217] formatted currency code.</param>
        /// 
...

        {
            ...
            variableConfigs.Add(
                new VariableConfig(
                    ...
                    Description:      I18NString.Create("Message to be shown to an EV Driver when the battery swap station cannot retrieve the cost for a transaction at the end of the transaction.")
            ...
            variableConfigs.Add(
                new VariableConfig(
                    ...
                    Description:      I18NString.Create("Currency used by this battery swap station in a ISO 4217 [ISO4217] formatted currency code.")

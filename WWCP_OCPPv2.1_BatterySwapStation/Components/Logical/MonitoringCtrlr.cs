...
namespace cloud.charging.open.protocols.OCPPv2_1
{
    ...
    public class MonitoringCtrlr : ALogicalComponentConfig
    {
        ...
        /// <summary>
        /// When set and the battery swap station is offline, the battery swap station shall queue any notifyEventRequest messages triggered by a monitor with a severity number equal to or lower than the severity configured here.
        ...
        /// <param name="OfflineQueuingSeverity">When set and the battery swap station is offline, the battery swap station shall queue any notifyEventRequest messages triggered by a monitor with a severity number equal to or lower than the severity configured here. Value ranging from 0 (Emergency) to 9 (Debug).</param>
        /// 
...

        {
            ...
            variableConfigs.Add(
                new VariableConfig(
                    ...
                    Description:      I18NString.Create("When set and the battery swap station is offline, the battery swap station shall queue any notifyEventRequest messages triggered by a monitor with a severity number equal to or lower than the severity configured here. Value ranging from 0 (Emergency) to 9 (Debug).")

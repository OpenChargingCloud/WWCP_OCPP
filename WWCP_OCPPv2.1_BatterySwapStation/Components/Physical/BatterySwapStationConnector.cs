...
namespace cloud.charging.open.protocols.OCPPv2_1.BSS
{
    ...
    /// <summary>
    /// A connector at a battery swap station.
    /// </summary>
    public class BatterySwapStationConnector
    {

        #region Data

        private readonly BatterySwapStationEVSE                                  parentEVSE;
        ...
        public BatterySwapStationConnector(BatterySwapStationEVSE  ParentEVSE,
                                        Connector_Id         Id,

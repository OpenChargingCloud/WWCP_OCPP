...
namespace cloud.charging.open.protocols.OCPPv2_1.BSS
{
    ...
    /// <summary>
    /// A battery swap station node for testing.
    /// </summary>
    public partial class TestBatterySwapStationNode : ABatterySwapStationNode,
                                                      IBatterySwapStationNode
    {
        ...
        public TestBatterySwapStationNode(NetworkingNode_Id       Id,
                                          String                  VendorName,
                                          String                  Model,
...

        {
            ...
            OCPP.IN.OnChangeAvailability += (timestamp,
                ...
                // Operational status of the entire battery swap station
            ...
            OCPP.IN.OnReset += async (timestamp,
                ...
                // Reset entire battery swap station
                if (!request.EVSEId.HasValue)
                {

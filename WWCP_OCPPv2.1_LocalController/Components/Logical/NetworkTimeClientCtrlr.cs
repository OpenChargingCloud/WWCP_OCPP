...
//    /// </summary>
//    public class NetworkTimeClientCtrlr : ALogicalComponentConfig
//    {
...
//        public NetworkTimeClientCtrlr(DateTime                 DateTime,
...
//            : base(nameof(NetworkTimeClientCtrlr),
//                   Instance,
//                   I18NString.Create("A Network Time Synchronization controller for Network Time Protocol (NTPv4) and Network Time Security (NTS)."),
//                   CustomData)
